...
public final class j {
    ...
    private static final int[] f27986e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* renamed from: f, reason: collision with root package name */
    private static final j[] f27987f = b();
    ...
    public static final class b {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final a[] f27995b;

        b(int i10, a... aVarArr) {
            this.f27994a = i10;
            this.f27995b = aVarArr;
        }
    ...
    public static j g(int i10) throws r6.f {
        if (i10 % 4 != 1) {
            throw r6.f.a();
        }
        try {
    ...
    public static j i(int i10) {
        ...
        return f27987f[i10 - 1];
    }

    s6.a a() {
        int iE = e();
        s6.a aVar = new s6.a(iE);
        aVar.m(0, 0, 9, 9);
        int i10 = iE - 8;
        aVar.m(i10, 0, 8, 9);
        aVar.m(0, i10, 9, 8);
        int length = this.f27989b.length;
        for (int i11 = 0; i11 < length; i11++) {
            int i12 = this.f27989b[i11] - 2;
            for (int i13 = 0; i13 < length; i13++) {
                if ((i11 != 0 || (i13 != 0 && i13 != length - 1)) && (i11 != length - 1 || i13 != 0)) {
                    aVar.m(this.f27989b[i13] - 2, i12, 5, 5);
                }
            }
        }
        int i14 = iE - 17;
    ...
    public int e() {
        return (this.f27988a * 4) + 17;
    }

    public b f(f fVar) {
        return this.f27990c[fVar.ordinal()];
    }
    ...
    public String toString() {
        return String.valueOf(this.f27988a);
    }
}
