...
class p implements Application.ActivityLifecycleCallbacks {
    ...
    private final Set f21555m = Collections.newSetFromMap(new WeakHashMap());
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        if (intent == null || !this.f21555m.add(intent)) {
            return;
        }
    ...
    public void onActivityPaused(Activity activity) {
        if (activity.isFinishing()) {
            this.f21555m.remove(activity.getIntent());
        }
    }
