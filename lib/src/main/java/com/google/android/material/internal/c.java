...
public abstract class c {
    ...
    private static final ThreadLocal f21063a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f21064b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f21063a;
        ...
        ThreadLocal threadLocal2 = f21064b;
