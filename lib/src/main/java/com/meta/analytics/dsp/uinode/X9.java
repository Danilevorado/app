...
public final class X9 implements InterfaceC0537Cy {
    ...
    public X9(String str) {
        C0653Hy c0653Hy = new C0653Hy(new byte[128]);
        this.A09 = c0653Hy;
        this.A0A = new C0654Hz(c0653Hy.A00);
        this.A02 = 0;
        this.A0B = str;
    }
    ...
    */
    ...
    private boolean A01(C0654Hz c0654Hz) {
        while (true) {
            if (c0654Hz.A04() <= 0) {
                return false;
            }
            if (!this.A08) {
                this.A08 = c0654Hz.A0E() == 11;
            } else {
    ...
    private boolean A02(C0654Hz c0654Hz, byte[] bArr, int i10) {
        ...
        while (true) {
            ...
            if (iA04 > 0) {
                switch (this.A02) {
                    ...
                    case 1:
                        if (!A02(c0654Hz, this.A0A.A00, 128)) {
                            break;
                        } else {
                            A00();
                            this.A0A.A0Y(0);
    ...
    public final void A4p(InterfaceC0513Bu interfaceC0513Bu, DC dc2) {
        dc2.A05();
        this.A07 = dc2.A04();
        this.A06 = interfaceC0513Bu.AGi(dc2.A03(), 1);
    }
