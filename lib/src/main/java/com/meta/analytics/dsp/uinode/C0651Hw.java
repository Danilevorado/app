...
public class C0651Hw implements InterfaceC0891Rj {
    ...
    public final EnumC0892Rk A03;
    public final List<InterfaceC0893Rl> A04 = new ArrayList();
    ...
    public C0651Hw(EnumC0892Rk enumC0892Rk) {
        this.A03 = enumC0892Rk;
    }
    ...
    private boolean A02(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        boolean zA02 = AbstractC0890Ri.A02(jSONObject, jSONObject2);
        String[] strArr = A06;
    ...
    public final synchronized boolean A03(JSONObject jSONObject, JSONObject jSONObject2) {
        if (jSONObject != null) {
            ...
            if (jSONObject2 == null || this.A03.A04()) {
                ...
                this.A02 = true;
                Iterator<InterfaceC0893Rl> it = this.A04.iterator();
                while (it.hasNext()) {
                    it.next().A45();
                }
                try {
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0891Rj
    public final synchronized void A3R(InterfaceC0893Rl interfaceC0893Rl) {
        this.A04.add(interfaceC0893Rl);
    }
