...
public abstract class AbstractC02491b {
    ...
    public static C02541g A01(JSONObject jSONObject) {
        return new C02531f().A06(A0A(jSONObject)).A07(A0B(jSONObject)).A05(A05(jSONObject)).A04(A04(jSONObject)).A08();
    }
    ...
    public static String A04(JSONObject jSONObject) {
        ...
        return jSONObjectOptJSONObject == null ? strA02 : jSONObjectOptJSONObject.optString(A02(181, 14, 18), strA02);
    }

    public static String A05(JSONObject jSONObject) {
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A02(279, 12, 72));
        String strA02 = A02(138, 13, 77);
        return jSONObjectOptJSONObject == null ? strA02 : jSONObjectOptJSONObject.optString(A02(195, 17, 121), strA02);
    }
