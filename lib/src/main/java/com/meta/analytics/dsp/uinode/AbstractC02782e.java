...
public abstract class AbstractC02782e extends FrameLayout {
    public static final float A08;
    public static final int A09;
    public static final InterfaceC02802g A0A;
    public int A00;
    public int A01;
    public boolean A02;
    public boolean A03;
    ...
    public final InterfaceC02792f A06;
    ...
    public AbstractC02782e(Context context) {
        this(context, null);
    }

    public AbstractC02782e(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public AbstractC02782e(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        Rect rect = new Rect();
        this.A04 = rect;
        this.A05 = new Rect();
        C1120aB c1120aB = new C1120aB(this);
        this.A06 = c1120aB;
        ...
        this.A01 = 0;
        this.A00 = 0;
        A0A.A8s(c1120aB, context, colorStateListValueOf, 10.0f, 10.0f, themeColorBackground);
    }
        ...
        if (!(A0A instanceof C1118a9)) {
            ...
            switch (mode) {
                ...
                case 1073741824:
                    ...
                    if (A07[1].charAt(21) == 'T') {
                        ...
                        i10 = View.MeasureSpec.makeMeasureSpec(Math.max((int) dCeil, minHeight), mode);
                        break;
                    } else {
            ...
            switch (mode2) {
                ...
                case 1073741824:
                    ...
                    i11 = View.MeasureSpec.makeMeasureSpec(Math.max(iCeil, minHeight2), mode2);
                    break;
            }
