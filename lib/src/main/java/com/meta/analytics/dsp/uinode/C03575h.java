...
public final class C03575h implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0817On A0B = new EW(this);
    public final AbstractC0758Mg A0E = new EV(this);
    public final AbstractC0850Pu A09 = new EU(this);
    public final MV A0F = new ET(this);
    public final AbstractC0848Ps A0A = new ES(this);
    public C03505a A02 = new C03505a();
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1073Yn c1073YnA11 = ((V2) nativeAd.getInternalNativeAd()).A11();
        C1073Yn adObjectContext = this.A03;
        adObjectContext.A0K(c1073YnA11);
        C03585i c03585i = (C03585i) nativeAd.getNativeAdApi();
        this.A05.setClientToken(V2.A0L(nativeAd.getInternalNativeAd()).A1B());
        this.A05.setVideoMPD(c03585i.A01());
        this.A05.setVideoURI(c03585i.A02());
        C1191bK c1191bKA0y = V2.A0L(nativeAd.getInternalNativeAd()).A0y();
        if (c1191bKA0y != null) {
            this.A05.setVideoProgressReportIntervalMs(c1191bKA0y.A0B());
        }
        this.A05.setVideoCTA(nativeAd.getAdCallToAction());
        this.A05.setNativeAd(nativeAd);
        this.A01 = c03585i.getVideoAutoplayBehavior();
        JM jm = this.A04;
        if (jm != null) {
            jm.AG8(nativeAd);
        }
    ...
    public final void disengageSeek(VideoStartReason videoStartReason) {
        ...
        this.A06 = false;
        if (this.A07) {
            this.A05.A0b(AbstractC0736Lk.A00(videoStartReason), 3);
        }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1073Yn) {
            c1073YnA03 = (C1073Yn) context;
        } else {
            c1073YnA03 = C03525c.A03(context);
        }
        this.A03 = c1073YnA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C0493Ba(c1073YnA03);
                break;
            case 1:
                this.A05 = new C0493Ba(c1073YnA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C0493Ba(c1073YnA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C0493Ba(c1073YnA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
    ...
    public final void play(VideoStartReason videoStartReason) {
        this.A05.A0b(AbstractC0736Lk.A00(videoStartReason), 2);
    }
    ...
    public final void setVolume(float f5) {
        this.A05.setVolume(f5);
    }

    @Override // com.facebook.ads.internal.api.MediaViewVideoRendererApi
    public final boolean shouldAutoplay() {
        C0493Ba c0493Ba = this.A05;
        if (c0493Ba == null || c0493Ba.getState() == RB.A06) {
            return false;
        }
