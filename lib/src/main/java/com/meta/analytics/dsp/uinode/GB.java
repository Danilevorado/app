...
public final class GB {
     ...
     */
    private void A08(long j10, Map<String, GH> map, Map<String, SpannableStringBuilder> map2) {
        if (A0C(j10)) {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 26 out of bounds for length 23
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public final List<C0592Fn> A0D(long j10, Map<String, GH> map, Map<String, GC> map2) {
        ...
        while (true) {
            ...
            arrayList.add(new C0592Fn(A01((SpannableStringBuilder) entry.getValue()), (Layout.Alignment) null, gc.A00, gc.A05, gc.A04, gc.A01, Integer.MIN_VALUE, gc.A03, gc.A06, gc.A02));
        }
    }
    ...
    public GB(String str, String str2, long j10, long j11, GH gh, String[] strArr, String str3) {
        this.A05 = str;
        this.A06 = str2;
        this.A03 = gh;
        this.A0A = strArr;
        ...
        this.A02 = j10;
        this.A01 = j11;
        this.A04 = (String) AbstractC0629Ha.A01(str3);
    ...
    */
    ...
    public static GB A05(String str, long j10, long j11, GH gh, String[] strArr, String str2) {
        return new GB(str, null, j10, j11, gh, strArr, str2);
    }
    ...
    private void A09(long j10, boolean z10, String str, Map<String, SpannableStringBuilder> regionOutputs) {
        ...
        if (strA06.equals(resolvedRegionId2) && z10) {
        ...
        for (int i10 = 0; i10 < A00(); i10++) {
            A03(i10).A09(j10, z10 || zEquals, str2, regionOutputs);
        }
        if (zEquals) {
    ...
    private void A0A(Map<String, GH> map, SpannableStringBuilder spannableStringBuilder, int i10, int i11) {
        GH resolvedStyle = GD.A00(this.A03, this.A0A, map);
        if (resolvedStyle != null) {
            GD.A05(spannableStringBuilder, i10, i11, resolvedStyle);
        }
    }
    ...
    private void A0B(TreeSet<Long> out, boolean z10) {
        ...
        while (true) {
            ...
            if (i10 < list.size()) {
                GB gb2 = this.A00.get(i10);
                boolean isPNode = z10 || zEquals;
                gb2.A0B(out, isPNode);
                i10++;
            } else {
                return;
