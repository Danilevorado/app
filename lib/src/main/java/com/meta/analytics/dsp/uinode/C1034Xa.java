...
public final class C1034Xa implements CA {
    ...
    private double A00(InterfaceC0512Bt interfaceC0512Bt, int i10) throws InterruptedException, IOException {
        long jA02 = A02(interfaceC0512Bt, i10);
        if (i10 == 4) {
    ...
    private long A01(InterfaceC0512Bt interfaceC0512Bt) throws InterruptedException, IOException {
        interfaceC0512Bt.AFM();
        while (true) {
            interfaceC0512Bt.ADv(this.A06, 0, 4);
            int iA00 = CH.A00(this.A06[0]);
            if (iA00 != -1 && iA00 <= 4) {
                int iA01 = (int) CH.A01(this.A06, iA00, false);
                if (this.A03.A96(iA01)) {
                    interfaceC0512Bt.AGP(iA00);
                    return iA01;
                }
            }
    ...
    private long A02(InterfaceC0512Bt interfaceC0512Bt, int i10) throws InterruptedException, IOException {
        interfaceC0512Bt.readFully(this.A06, 0, i10);
        long j10 = 0;
    ...
    private String A04(InterfaceC0512Bt interfaceC0512Bt, int i10) throws InterruptedException, IOException {
        if (i10 == 0) {
            return A03(0, 0, 103);
        }
        byte[] bArr = new byte[i10];
        interfaceC0512Bt.readFully(bArr, 0, i10);
    ...
    @Override // com.meta.analytics.dsp.uinode.CA
    public final boolean AEJ(InterfaceC0512Bt interfaceC0512Bt) throws InterruptedException, IOException {
        ...
        while (true) {
            ...
            if (this.A01 == 0) {
                long jA05 = this.A04.A05(interfaceC0512Bt, true, false, 4);
                if (jA05 == -2) {
                    jA05 = A01(interfaceC0512Bt);
                }
                if (jA05 == -1) {
                    return false;
                }
            ...
            if (this.A01 == 1) {
                this.A02 = this.A04.A05(interfaceC0512Bt, false, true, 8);
                this.A01 = 2;
            }
            ...
            switch (iA6s) {
                ...
                case 2:
                    long j10 = this.A02;
                    if (j10 <= 8) {
                        this.A03.A8t(this.A00, A02(interfaceC0512Bt, (int) j10));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C04629v(A03(41, 22, 116) + this.A02);
                case 3:
                    long j11 = this.A02;
                    if (j11 <= 2147483647L) {
                        this.A03.AGc(this.A00, A04(interfaceC0512Bt, (int) j11));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C04629v(A03(63, 21, 6) + this.A02);
                case 4:
                    this.A03.A42(this.A00, (int) this.A02, interfaceC0512Bt);
                    if (A08[7].charAt(2) != 'S') {
                ...
                case 5:
                    long j12 = this.A02;
                    if (j12 == 4 || j12 == 8) {
                        this.A03.A5j(this.A00, A00(interfaceC0512Bt, (int) j12));
                        this.A01 = 0;
                        return true;
                    }
                    throw new C04629v(A03(21, 20, 43) + this.A02);
                default:
                    throw new C04629v(A03(0, 21, 11) + iA6s);
            }
        }
    }
