...
public final class C5V implements AudienceNetworkActivityApi, Repairable {
    ...
    public C5V(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        C1073Yn c1073YnA02 = C03525c.A02(audienceNetworkActivity);
        this.A0N = c1073YnA02;
        c1073YnA02.A0L(this);
    }
    ...
    private void A08() {
        String str = this.A0E;
        if (str != null) {
            C0853Px c0853PxA01 = AbstractC0852Pw.A01(this.A0N, str);
            this.A0B = c0853PxA01;
            if (c0853PxA01 != null) {
    ...
    private void A0A() {
        boolean z10 = !this.A0J || C0662Ih.A1a(this.A0N);
    ...
    private void A0C(Intent intent) {
        if (C0662Ih.A11(this.A0L)) {
            ...
            if (kb2 != kb3 && Build.VERSION.SDK_INT >= 18) {
                ...
                AbstractC0740Lo.A0M(textView, Color.argb(160, 0, 0, 0));
    ...
    private void A0D(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            Bundle bundleA02 = C0711Kj.A02(bundle, DynamicLoaderImpl.class.getClassLoader());
        ...
        this.A02 = intent.getIntExtra(A06(502, 16, 117), 0) * AdError.NETWORK_ERROR_CODE;
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0H(String str, C02481a c02481a) {
        if (this.A08 == null) {
            return;
        }
        if (this.A09 == null) {
            C1073Yn c1073Yn = this.A0N;
            this.A09 = AbstractC0767Mp.A02(c1073Yn, c1073Yn.A09(), str, c02481a, this.A08, new ZW(this, null));
            this.A09.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        }
        AbstractC0740Lo.A0J(this.A09);
        AbstractC0740Lo.A0T(this.A06);
    ...
    public final void A0P(String str, C04338q c04338q) {
        Intent intent = new Intent(str + A06(0, 1, 84) + this.A0C);
        if (c04338q != null) {
            intent.putExtra(A06(402, 5, 105), c04338q);
        }
        C02882o.A00(this.A0L).A07(intent);
    }
    ...
    public final void finish(int i10) {
        ...
        if (C0662Ih.A1U(this.A0N) && !this.A0H && !this.A0G) {
            this.A0N.A0E().AAX();
            A0L();
        }
        if (A0I() && !this.A0F) {
    ...
    public final void onActivityResult(int i10, int i11, Intent intent) {
        MD md = this.A08;
        if (md != null && md.onActivityResult(i10, i11, intent)) {
            return;
        }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            if (i10 == 1) {
                ...
                map.put(strA06, A06(407, 9, 51));
            }
            J9 j92 = J9.A0K;
            MD md = this.A08;
            JA.A02(j92, map, md == null ? A06(0, 0, 50) : md.getCurrentClientToken(), this.A0N.A09());
    ...
    public final void onCreate(Bundle bundle) {
        ...
        Intent intent = C0711Kj.A01(this.A0L.getIntent(), DynamicLoaderImpl.class.getClassLoader());
        this.A05 = intent;
        C1073Yn c1073YnA03 = C0711Kj.A03(intent);
        if (c1073YnA03 != null) {
            C1073Yn startAdContext = this.A0N;
            startAdContext.A0J(c1073YnA03.A0E());
            C1073Yn startAdContext2 = this.A0N;
            startAdContext2.A0C(c1073YnA03.A0B());
            C1073Yn startAdContext3 = this.A0N;
            startAdContext3.A0M(c1073YnA03.A0G());
        }
        A0D(this.A05, bundle);
        ...
        if (C0662Ih.A2N(this.A0N) && this.A07 == KB.A03 && z10) {
        ...
        AbstractC0740Lo.A0M(relativeLayout, 0);
        ...
        if (C0662Ih.A1x(this.A0L) && this.A0L.getWindow() != null) {
    ...
    */
    public final void onDestroy() {
        ...
        L66:
            ...
            boolean r0 = com.meta.analytics.dsp.uinode.C0662Ih.A11(r0)
            if (r0 == 0) goto L73
