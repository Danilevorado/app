...
public final class MK extends View {
    ...
    public MK(C1073Yn c1073Yn) {
        this(c1073Yn, 60, true);
    }

    public MK(C1073Yn c1073Yn, int i10, boolean z10) {
        super(c1073Yn);
        this.A00 = i10;
        this.A04 = z10;
        if (z10) {
    ...
    public RelativeLayout.LayoutParams getDefaultLayoutParams() {
        ...
        int i10 = this.A00;
        float density = i10;
        int i11 = (int) (density * f5);
        float density2 = i10;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(i11, (int) (density2 * f5));
    ...
    public final void onDraw(Canvas canvas) {
        if (this.A04) {
            ...
            float f5 = edgeLength3;
            int edgeLength4 = centerX * 2;
            canvas.drawLine(centerY, centerX, f5, edgeLength4, this.A03);
