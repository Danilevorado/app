...
public final class C0628Gy {
    ...
    public C0628Gy(Uri uri, long j10, long j11, long j12, String str, int i10) {
        this(uri, null, j10, j11, j12, str, i10);
    }

    public C0628Gy(Uri uri, long j10, long j11, String str) {
        this(uri, j10, j10, j11, str, 0);
    }

    public C0628Gy(Uri uri, long j10, long j11, String str, int i10) {
        this(uri, j10, j10, j11, str, i10);
    }

    public C0628Gy(Uri uri, byte[] bArr, long j10, long j11, long j12, String str, int i10) {
        boolean z10 = true;
        AbstractC0629Ha.A03(j10 >= 0);
        AbstractC0629Ha.A03(j11 >= 0);
        if (j12 <= 0 && j12 != -1) {
            z10 = false;
        }
