...
public final class KP extends RelativeLayout implements QN {
    ...
    public AbstractC04358s A03;
    public AbstractC04358s A04;
    public AbstractC04358s A05;
    public AbstractC04358s A06;
    public SA A07;
    ...
    public KP(C1073Yn c1073Yn) {
        this(c1073Yn, A09, -12549889, 0);
    }

    public KP(C1073Yn c1073Yn, int i10, int i11, int i12) {
        super(c1073Yn);
        this.A00 = -1;
        ...
        this.A04 = new AbstractC0817On() { // from class: com.facebook.ads.redexgen.X.7A
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.meta.analytics.dsp.uinode.AbstractC04358s
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A03 = new AbstractC0850Pu() { // from class: com.facebook.ads.redexgen.X.78
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.meta.analytics.dsp.uinode.AbstractC04358s
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A02 = new ProgressBar(c1073Yn, null, R.attr.progressBarStyleHorizontal);
        A06(i11, i12);
    ...
    public final void A07(boolean z10) {
        ...
        if (z10) {
            ObjectAnimator objectAnimatorOfInt = ObjectAnimator.ofInt(this.A02, A01(0, 8, 53), i11, i10);
            this.A01 = objectAnimatorOfInt;
