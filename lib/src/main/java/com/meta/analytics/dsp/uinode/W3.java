...
public final class W3 implements InterfaceC0624Gu {
    ...
    public final long ADl(C0628Gy c0628Gy) throws IOException {
        ...
        if (A00(102, 4, 80).equals(scheme)) {
            ...
            throw new C04629v(scheme3);
        }
        String scheme4 = A00(82, 20, 87) + scheme;
        throw new C04629v(scheme4);
    }
