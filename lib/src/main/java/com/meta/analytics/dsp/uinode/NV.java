...
public class NV extends WebViewClient {
    ...
    public final WeakReference<C1073Yn> A02;
    ...
    public NV(WeakReference<C1073Yn> weakReference, WeakReference<NS> weakReference2, WeakReference<NO> weakReference3) {
        this.A02 = weakReference;
        this.A03 = weakReference2;
        this.A04 = weakReference3;
    }

    private void A02(String str, C1073Yn c1073Yn) {
        c1073Yn.A07().A9a(A00(11, 11, 101), C8A.A09, new C8B(A00(111, 5, 6) + str));
    }
    ...
    private boolean A03(WebView webView, String str) throws URISyntaxException {
        ...
        try {
            Uri uri = AbstractC0724Ky.A00(str);
            String scheme = uri.getScheme();
            try {
                zA0w = C0662Ih.A0w(c1073Yn);
                strA00 = A00(48, 33, 71);
                strA002 = A00(22, 26, 113);
                strA003 = A00(105, 6, 103);
            } catch (Exception e5) {
                c1073Yn.A07().A9b(strA004, C8A.A2b, new C8B(e5));
                c1073Yn.A0E().A8k(e5.toString());
            }
            if (zA0w) {
                    ...
                    try {
                        ...
                        if (strA003.equals(scheme)) {
                            ...
                            if (!TextUtils.isEmpty(stringExtra)) {
                                if (!C0711Kj.A0C(c1073Yn, new Intent(strA002, AbstractC0724Ky.A00(stringExtra)))) {
                                    A02(str, c1073Yn);
                                }
                                return true;
                            }
                        ...
                        c8b.A05(1);
                        c1073Yn.A07().A9b(A00(11, 11, 101), C8A.A06, c8b);
                        return true;
                    }
                }
                return false;
            ...
            if (U1.A0A && strA003.equalsIgnoreCase(scheme)) {
                ...
                if (c1073Yn.getPackageManager().resolveActivity(uri2, 65536) != null && C0711Kj.A0C(c1073Yn, uri2)) {
                    webView.goBack();
                    return true;
                }
            } else if ((U1.A0A && LH.A04(str)) || !U1.A0D.contains(scheme)) {
                return C0711Kj.A0C(c1073Yn, new Intent(strA002, uri));
            }
            return false;
        } catch (SecurityException e10) {
            c1073Yn.A07().A9b(strA004, C8A.A2b, new C8B(e10));
            return true;
        }
    }
    ...
    public final void onReceivedError(WebView webView, int i10, String str, String str2) throws JSONException {
        ...
        if (c1073Yn != null) {
            ...
            String errorMessage = LH.A01(i10, sb2.append(strA00).append(str).toString(), strA00 + str2);
            c1073Yn.A0E().A8h(errorMessage);
        }
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) throws JSONException {
        ...
        if (c1073Yn != null) {
            ...
            StringBuilder sb2 = new StringBuilder();
            String strA00 = A00(0, 0, 27);
            String errorMessage = LH.A01(errorCode, sb2.append(strA00).append((Object) webResourceError.getDescription()).toString(), strA00 + webResourceRequest.getUrl());
            c1073Yn.A0E().A8h(errorMessage);
        }
    }
