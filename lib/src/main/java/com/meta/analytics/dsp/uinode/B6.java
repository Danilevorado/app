...
public final class B6 {
    ...
    public B6(int i10, int i11, float f5, float f10, int i12) {
        this.A0H = i10;
        this.A0G = i11;
        this.A0F = f5;
        this.A0D = f10;
    ...
    private int A02(short[] sArr, int i10, float f5, int i11) {
        int i12;
        if (f5 < 0.5f) {
            i12 = (int) ((i11 * f5) / (1.0f - f5));
        } else {
            i12 = i11;
            int newFrameCount = (int) ((i11 * ((2.0f * f5) - 1.0f)) / (1.0f - f5));
        ...
        System.arraycopy(sArr, i10 * i13, sArrA0G, newFrameCount3 * i13, i13 * i11);
    ...
    private int A03(short[] sArr, int i10, float f5, int i11) {
        int newFrameCount;
        if (f5 >= 2.0f) {
            newFrameCount = (int) (i11 / (f5 - 1.0f));
        } else {
            this.A09 = (int) ((i11 * (2.0f - f5)) / (f5 - 1.0f));
            newFrameCount = i11;
        }
        ...
        this.A0B = sArrA0G;
        A0C(newFrameCount, this.A0G, sArrA0G, this.A05, sArr, i10, sArr, i10 + i11);
        int newFrameCount3 = this.A05;
    ...
    private void A07(float f5) {
        ...
        do {
            ...
            if (frameCount2 > 0) {
                ...
                if (f5 > 1.0d) {
                    int frameCount4 = A03(this.A0A, i11, f5, iA01);
                    i11 += frameCount4 + iA01;
                } else {
                    int frameCount5 = A02(this.A0A, i11, f5, iA01);
                    i11 += frameCount5;
                }
            }
            frameCount = this.A0J;
    ...
    */
    ...
    private void A09(int i10) {
        ...
        short[] sArrA0G = A0G(sArr, frameCount, i11);
        this.A0C = sArrA0G;
        short[] sArr2 = this.A0B;
        int i12 = this.A0G;
        int frameCount2 = this.A06;
        System.arraycopy(sArr2, i10 * i12, sArrA0G, frameCount2 * i12, i12 * i11);
        this.A05 = i10;
    ...
    private void A0D(short[] sArr, int i10, int i11) {
        short[] sArrA0G = A0G(this.A0B, this.A05, i11);
        this.A0B = sArrA0G;
        int i12 = this.A0G;
        System.arraycopy(sArr, i10 * i12, sArrA0G, this.A05 * i12, i12 * i11);
        this.A05 += i11;
    }
    ...
    public final void A0J() {
        ...
        int i13 = i12 + ((int) ((((s10 / r10) + remainingFrameCount) / f11) + 0.5f));
        short[] sArr = this.A0A;
        int i14 = this.A00;
    ...
    public final void A0K(ShortBuffer shortBuffer) {
        ...
        int i10 = this.A05 - iMin;
        this.A05 = i10;
        short[] sArr = this.A0B;
        int framesToRead = this.A0G;
        System.arraycopy(sArr, iMin * framesToRead, sArr, 0, i10 * framesToRead);
    }
    ...
    public final void A0L(ShortBuffer shortBuffer) {
        ...
        short[] sArrA0G = A0G(this.A0A, this.A00, i10);
        this.A0A = sArrA0G;
        int bytesToWrite = this.A00;
        shortBuffer.get(sArrA0G, bytesToWrite * this.A0G, ((framesToWrite * i10) * 2) / 2);
        this.A00 += i10;
        A06();
    }
}
