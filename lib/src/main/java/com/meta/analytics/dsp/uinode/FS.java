...
public final class FS extends AbstractC1176b5 implements Serializable {
    ...
    public static FS A02(JSONObject jSONObject, C1073Yn c1073Yn) {
        FS fs = new FS(AbstractC1176b5.A08(jSONObject, c1073Yn, new C1171b0()));
        fs.A16(jSONObject);
        fs.A0b(A03(0, 14, 8));
        return fs;
    }
