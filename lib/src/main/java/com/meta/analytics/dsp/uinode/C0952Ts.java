...
public final class C0952Ts extends NY {
    ...
    public final WeakReference<InterfaceC0779Nb> A0A;
    ...
    static {
        A06();
        A0H = C0952Ts.class.getSimpleName();
    }

    public C0952Ts(C1073Yn c1073Yn, WeakReference<InterfaceC0779Nb> weakReference, int i10, String str) {
        this(c1073Yn, weakReference, i10, false);
        if (C0662Ih.A1W(c1073Yn)) {
            c1073Yn.A01().A0A().AGw(this, str == null ? A04(0, 0, 74) : str, false, true);
            this.A06 = true;
        }
    }

    public C0952Ts(C1073Yn c1073Yn, WeakReference<InterfaceC0779Nb> weakReference, int i10, boolean z10) {
        super(c1073Yn);
        ...
        this.A01 = new C0732Lg();
        this.A05 = true;
        this.A06 = false;
        this.A09 = c1073Yn;
        this.A04 = z10;
        this.A0A = weakReference;
        this.A02 = new C0956Tw(this);
        this.A03 = new RE(this, i10, new WeakReference(this.A02), c1073Yn);
        setWebChromeClient(A0D());
        setWebViewClient(A0E());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        if (Build.VERSION.SDK_INT > 16) {
            addJavascriptInterface(new C0778Na(this, weakReference.get(), this.A03, atomicBoolean, atomicBoolean2, c1073Yn), A04(0, 9, 97));
        }
    }
    ...
    public final WebViewClient A0E() {
        return new C0781Nd(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }

    public final void A0F() {
        this.A09.A0E().AGy();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C0954Tu(this.A03));
    }
