...
public final class V2 implements Ad, NativeAdBaseApi, Repairable, JX {
    ...
    private void A0f(View view, View view2, List<View> list, boolean z10) {
        ...
        if (c1191bKA0C == null) {
            ...
            Log.e(A0n, strA0W3);
            C0679Jb c0679Jb = new C0679Jb(AdErrorType.NATIVE_AD_IS_NOT_LOADED, strA0W3);
            A11().A0E().A2m(C0731Lf.A01(this.A00), c0679Jb.A03().getErrorCode(), c0679Jb.A04());
            if (!C0662Ih.A2F(this.A0c) || (v12 = this.A0G) == null) {
                return;
            }
            v12.ABR(c0679Jb);
            return;
        ...
        ZX zx = this.A0U.get();
        if (zx != null && c1191bKA0C.A08() == 1) {
            zx.A03(EnumC0748Lw.AN_INFO_ICON);
        }
        if (view2 == null) {
            if (this.A0J == EnumC0683Jg.A05) {
                AdErrorType adErrorType = AdErrorType.NO_MEDIAVIEW_IN_NATIVEAD;
                String strA0W4 = A0W(243, 21, 68);
                C0679Jb c0679Jb2 = new C0679Jb(adErrorType, strA0W4);
                A11().A0E().A2m(C0731Lf.A01(this.A00), c0679Jb2.A03().getErrorCode(), c0679Jb2.A04());
                V1 v13 = this.A0G;
                if (v13 != null) {
                    v13.ABR(c0679Jb2);
                }
            ...
            C0679Jb c0679Jb3 = new C0679Jb(adErrorType2, strA0W5);
            A11().A0E().A2m(C0731Lf.A01(this.A00), c0679Jb3.A03().getErrorCode(), c0679Jb3.A04());
            V1 v14 = this.A0G;
            if (v14 != null) {
                v14.ABR(c0679Jb3);
            }
        ...
        if (!z12 && !z13) {
            if (this.A0G != null) {
                C0679Jb c0679Jb4 = new C0679Jb(AdErrorType.UNSUPPORTED_AD_ASSET_NATIVEAD, A0W(519, 31, 15));
                A11().A0E().A2m(C0731Lf.A01(this.A00), c0679Jb4.A03().getErrorCode(), c0679Jb4.A04());
                this.A0G.ABR(c0679Jb4);
                return;
            }
            return;
        }
        ...
        if (view instanceof ViewGroup) {
            C0760Mi c0760Mi = new C0760Mi(this.A0c, new V8(this));
            this.A0K = c0760Mi;
            ((ViewGroup) view).addView(c0760Mi);
        }
        if (c1191bKA0C.A0S()) {
        ...
        int iA00 = A00();
        this.A0P = new V6(this, view2, z13, c1191bKA0C);
        ...
        C1181bA c1181bA = new C1181bA(this.A0c, new V3(this, null), this.A0R, this.A0a);
        this.A09 = c1181bA;
        c1181bA.A0D(arrayList);
        A0o.put(view, new WeakReference<>(this));
        if (Build.VERSION.SDK_INT < 18 || !C0662Ih.A11(this.A0c)) {
            return;
        }
        C0784Ng c0784Ng = new C0784Ng();
        this.A0L = c0784Ng;
        c0784Ng.A0C(this.A0g);
        this.A0L.A0B(this.A0c.getPackageName());
        this.A0L.A0A(this.A0R);
        C1191bK c1191bK = this.A0a;
        if (c1191bK != null && c1191bK.A0E().A03() > 0) {
    ...
    public V2(Context context, String str, JO jo, boolean z10) {
        this.A0h = UUID.randomUUID().toString();
        this.A0J = EnumC0683Jg.A05;
        this.A0E = JL.A04;
        this.A08 = AnonymousClass12.A03;
        this.A0U = new WeakReference<>(null);
        this.A0i = new ArrayList();
        this.A0f = new C0732Lg();
        this.A0Z = false;
        this.A0Y = false;
        this.A00 = -1L;
        if (context instanceof C1073Yn) {
            this.A0c = (C1073Yn) context;
        } else if (!z10) {
            this.A0c = C03525c.A04(context);
        } else {
            this.A0c = C03525c.A03(context);
        }
        this.A0c.A0L(this);
        this.A0g = str;
        this.A0d = jo;
    ...
    public V2(C1073Yn c1073Yn, C1191bK c1191bK, C8T c8t, JO jo) {
        this((Context) c1073Yn, (String) null, jo, true);
        this.A0a = c1191bK;
        this.A0D = c8t;
        this.A0j = true;
        this.A05 = new View(c1073Yn);
    }

    public V2(C1073Yn c1073Yn, C1191bK c1191bK, C8T c8t, JO jo, C1151ag c1151ag) {
        this(c1073Yn, c1191bK, c8t, jo);
        this.A0B = c1151ag;
    }
    ...
    public static Drawable A05(C1073Yn c1073Yn, Bitmap bitmap, boolean z10, String str) {
        BitmapDrawable bitmapDrawableA00;
        BitmapDrawable bitmapDrawable = new BitmapDrawable(c1073Yn.getResources(), bitmap);
        if (z10 && (bitmapDrawableA00 = AbstractC0852Pw.A00(c1073Yn, str)) != null) {
    ...
    public static NativeAdBase A0A(Context context, String str, String str2) throws C0680Jc {
        EnumC0683Jg enumC0683JgA00 = C0688Jl.A00(str2);
        if (enumC0683JgA00 != null) {
            EnumC0683Jg enumC0683Jg = EnumC0683Jg.A04;
            String[] strArr = A0m;
            if (strArr[7].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            ...
            if (enumC0683JgA00 == enumC0683Jg) {
                return new NativeBannerAd(context, str);
            }
            EnumC0683Jg template = EnumC0683Jg.A05;
            if (enumC0683JgA00 == template) {
                return new NativeAd(context, str);
            }
            throw new C0680Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(42, 34, 84), enumC0683JgA00));
        }
        throw new C0680Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A0W(114, 50, 50), str2));
    }

    private final C1191bK A0C() {
        C1191bK c1191bK = this.A0a;
        if (c1191bK != null && c1191bK.A0R()) {
            return c1191bK;
        }
        return null;
    }
    ...
    private AnonymousClass14 A0G(boolean z10) {
        C1191bK c1191bK = this.A0a;
        if (c1191bK != null && c1191bK.A0R()) {
            if (z10) {
                this.A0a.A0I();
            }
            C1191bK c1191bK2 = this.A0a;
            String[] strArr = A0m;
            if (strArr[0].charAt(5) == strArr[2].charAt(5)) {
                throw new RuntimeException();
            }
    ...
    private void A0a() {
        if (!TextUtils.isEmpty(getAdChoicesLinkUrl())) {
            C0721Kv.A0M(new C0721Kv(), this.A0c, AbstractC0724Ky.A00(getAdChoicesLinkUrl()), A1B());
        }
    }
    ...
    private void A0g(FrameLayout frameLayout, String str) {
        ...
        C0853Px c0853PxA01 = AbstractC0852Pw.A01(C03525c.A03(this.A0c), str);
        this.A0N = c0853PxA01;
        if (c0853PxA01 != null) {
            frameLayout.addView(c0853PxA01, new FrameLayout.LayoutParams(-1, -1));
            frameLayout.bringChildToFront(this.A0N);
        }
    }

    private void A0h(C1191bK c1191bK, boolean z10) {
        if (c1191bK == null) {
            return;
        }
        ...
        if (zEquals) {
            AnonymousClass14 anonymousClass14A0E = c1191bK.A0E();
            String clientToken = c1191bK.A6T();
            if (!TextUtils.isEmpty(clientToken)) {
                this.A0b.A0d(new JA(clientToken, this.A0c.A09()));
            }
            if (anonymousClass14A0E.A0G() != null) {
                C03766a c03766a = new C03766a(anonymousClass14A0E.A0G().getUrl(), anonymousClass14A0E.A0G().getHeight(), anonymousClass14A0E.A0G().getWidth(), c1191bK.A0G(), A0W(596, 6, 89));
                c03766a.A00 = this.A0C;
                this.A0b.A0V();
                this.A0b.A0b(c03766a);
            }
            if (!this.A0J.equals(EnumC0683Jg.A04)) {
                if (anonymousClass14A0E.A0F() != null) {
                    this.A0b.A0b(new C03766a(anonymousClass14A0E.A0F().getUrl(), anonymousClass14A0E.A0F().getHeight(), anonymousClass14A0E.A0F().getWidth(), c1191bK.A0G(), A0W(596, 6, 89)));
                }
                List<V2> listA0H = c1191bK.A0H();
                String[] strArr = A0m;
                if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                    throw new RuntimeException();
                }
                ...
                if (listA0H != null) {
                    for (V2 v22 : c1191bK.A0H()) {
                        if (v22.getAdCoverImage() != null) {
                            this.A0b.A0b(new C03766a(v22.getAdCoverImage().getUrl(), v22.getAdCoverImage().getHeight(), v22.getAdCoverImage().getWidth(), c1191bK.A0G(), A0W(596, 6, 89)));
                        }
                    }
                }
                String strA0d = anonymousClass14A0E.A0d();
                if (!TextUtils.isEmpty(strA0d)) {
                    this.A0b.A0a(new C6Y(strA0d, c1191bK.A0G(), A0W(596, 6, 89), anonymousClass14A0E.A0A()));
                }
            }
            AbstractC1176b5 abstractC1176b5A0D = anonymousClass14A0E.A0D();
            if (abstractC1176b5A0D != null && abstractC1176b5A0D.A0m()) {
                C6Y c6y = new C6Y(abstractC1176b5A0D.A0M(), abstractC1176b5A0D.A0S(), strA0W);
                c6y.A04 = true;
                c6y.A03 = A0W(0, 5, 0);
                this.A0b.A0X(c6y);
            }
        }
        this.A0b.A0W(new V9(this, c1191bK, z10), new C6V(c1191bK.A0G(), strA0W));
    }
    ...
    private void A0i(AnonymousClass15 anonymousClass15) {
        ...
        c1191bK.A0K(anonymousClass15);
    }

    public static void A0j(NativeAdImageApi nativeAdImageApi, ImageView imageView, C1073Yn c1073Yn) {
        if (nativeAdImageApi != null && imageView != null) {
            new AsyncTaskC0950Tq(imageView, c1073Yn).A05(nativeAdImageApi.getHeight(), nativeAdImageApi.getWidth()).A07(nativeAdImageApi.getUrl());
        }
    }
    ...
    public final C1191bK A0y() {
        return this.A0a;
    }

    public final AbstractC1176b5 A0z() {
        return A0F().A0D();
    }

    public final C03786c A10() {
        return this.A0b;
    }

    public final C1073Yn A11() {
        return this.A0c;
    }
    ...
    public final String A1G() {
        C1191bK c1191bK = this.A0a;
        if (c1191bK == null || TextUtils.isEmpty(c1191bK.A0E().A0d())) {
            return null;
        }
    ...
    public final void A1I() {
        ...
        C1073Yn c1073Yn = this.A0c;
        AbstractC0766Mo abstractC0766MoA01 = AbstractC0767Mp.A01(c1073Yn, c1073Yn.A09(), A1B(), this.A07);
        if (abstractC0766MoA01 == null) {
            A0a();
        } else {
            ((ZG) this.A07.getNativeAdLayoutApi()).A03(abstractC0766MoA01);
            abstractC0766MoA01.A0K();
        }
    }
    ...
    public final void A1K(View view) {
        ...
        if (Build.VERSION.SDK_INT >= 18) {
            boolean zA11 = C0662Ih.A11(view.getContext());
            String[] strArr = A0m;
            if (strArr[1].charAt(16) == strArr[3].charAt(16)) {
                throw new RuntimeException();
            }
    ...
    public final void A1R(NativeAdBase nativeAdBase, NativeAdListener nativeAdListener) {
        ...
        A0m(new C0502Bj(nativeAdListener, nativeAdBase));
    }
    ...
    public final void A1T(C1191bK c1191bK) {
        A0h(c1191bK, true);
        if (this.A0G != null) {
            List<V2> listA0H = c1191bK.A0H();
            String[] strArr = A0m;
            ...
            if (listA0H != null) {
                VB vb2 = new VB(this);
                Iterator<V2> it = c1191bK.A0H().iterator();
                while (it.hasNext()) {
                    it.next().A0i(vb2);
                }
            }
    ...
    public final void A1V(JL jl, String str, C6i c6i) {
        ...
        if (this.A0j) {
            AdSettings.IntegrationErrorMode integrationErrorModeA00 = AbstractC02711x.A00(this.A0c);
            ...
            if (!integrationErrorMode.equals(integrationErrorModeA00)) {
                C0679Jb c0679Jb = new C0679Jb(AdErrorType.LOAD_AD_CALLED_MORE_THAN_ONCE, A0W(566, 30, 115));
                A11().A0E().A2m(C0731Lf.A01(this.A00), c0679Jb.A03().getErrorCode(), c0679Jb.A04());
                V1 v12 = this.A0G;
                if (v12 != null) {
                    v12.ABR(c0679Jb);
        ...
        this.A0C = c6i;
        C02681u c02681u = new C02681u(this.A0g, this.A0J, A0R(), null, 1, new C1144aZ());
        c02681u.A05(jl);
        c02681u.A06(this.A0S);
        c02681u.A07(this.A0T);
        FO fo = new FO(this.A0c, c02681u);
        this.A0A = fo;
        fo.A0P(new VC(this));
        this.A0A.A0T(str);
    }
    ...
    public final void A1Y(EnumC0683Jg enumC0683Jg) {
        if (!A0q()) {
            if (EnumC0683Jg.A04.equals(enumC0683Jg)) {
                C1073Yn c1073Yn = this.A0c;
                String[] strArr = A0m;
                if (strArr[7].length() != strArr[5].length()) {
                    throw new RuntimeException();
                ...
                c1073Yn.A0E().A2s(AdPlacementType.NATIVE_BANNER.toString(), this.A0g);
            } else {
                this.A0c.A0E().A2s(AdPlacementType.NATIVE.toString(), this.A0g);
            }
        }
        this.A0J = enumC0683Jg;
    }
    ...
    */
    ...
    public final void destroy() {
        AbstractC0692Jp.A05(A0W(553, 7, 7), A0W(363, 19, 23), A0W(5, 8, 76));
        if (C0662Ih.A1W(this.A0c)) {
    ...
    public final Drawable getPreloadedIconViewDrawable() {
        ...
        if (adapter != null && (jpA0G = A0F().A0G()) != null && (bitmapA0M = this.A0b.A0M(jpA0G.getUrl())) != null) {
            ...
            return A05(c1073YnA11, bitmapA0M, zA1d, A1C());
        }
        return null;
    }
    ...
    public final boolean hasCallToAction() {
        C1191bK c1191bK = this.A0a;
        return c1191bK != null && c1191bK.A0Q();
    }
    ...
    public final boolean isAdLoaded() {
        C1191bK c1191bK = this.A0a;
        return c1191bK != null && c1191bK.A0R();
    }

    @Override // com.facebook.ads.Ad
    public final void loadAd() {
        AbstractC0692Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(13, 8, 89));
    ...
    public final void loadAd(NativeAdBase.NativeLoadAdConfig nativeLoadAdConfig) {
        AbstractC0692Jp.A05(A0W(560, 6, 14), A0W(382, 24, 98), A0W(21, 8, 126));
    ...
    public final void repair(Throwable th) {
        ...
        A11().A0E().A2m(C0731Lf.A01(this.A00), AdError.INTERNAL_ERROR_CODE, str);
        V1 v12 = this.A0G;
        if (v12 != null) {
            v12.ABR(new C0679Jb(AdError.INTERNAL_ERROR_CODE, str));
        }
    }
