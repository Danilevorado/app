...
public abstract class AnonymousClass57 {
    ...
    public static int A00(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC03394o abstractC03394o, boolean z10) {
        if (abstractC03394o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z10) {
            return Math.abs(abstractC03394o.A0p(view) - abstractC03394o.A0p(view2)) + 1;
        }
    ...
    public static int A01(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC03394o abstractC03394o, boolean z10) {
        if (abstractC03394o.A0W() == 0 || anonymousClass53.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        if (!z10) {
        ...
        int iA0p = abstractC03394o.A0p(view);
        int laidOutArea = abstractC03394o.A0p(view2);
        float fAbs = iA0C / (Math.abs(iA0p - laidOutArea) + 1);
        int laidOutArea2 = anonymousClass53.A03();
        return (int) (fAbs * laidOutArea2);
    }

    public static int A02(AnonymousClass53 anonymousClass53, C4Y c4y, View view, View view2, AbstractC03394o abstractC03394o, boolean z10, boolean z11) {
        int laidOutArea;
        if (abstractC03394o.A0W() != 0) {
            ...
            if (iA03 != 0 && view != null && view2 != null) {
                int maxPosition = Math.min(abstractC03394o.A0p(view), abstractC03394o.A0p(view2));
                int iA0p = abstractC03394o.A0p(view);
                int minPosition = abstractC03394o.A0p(view2);
                ...
                int itemsBefore2 = abstractC03394o.A0p(view);
                int minPosition4 = abstractC03394o.A0p(view2);
