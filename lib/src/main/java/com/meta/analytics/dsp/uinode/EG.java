...
public final class EG {
    ...
    public EG(EL el, int i10, int i11, File file, DownloadAction.Deserializer... deserializerArr) {
        AbstractC0629Ha.A05(deserializerArr.length > 0, A05(16, 38, 36));
        this.A0A = el;
        this.A04 = i10;
        this.A05 = i11;
        this.A09 = new C0553Dw(file);
    ...
    public ED A02(DownloadAction downloadAction) {
        int i10 = this.A00;
        this.A00 = i10 + 1;
        ED ed = new ED(i10, this, downloadAction, this.A05, null);
        this.A0C.add(ed);
        A0J(A05(78, 13, 91), ed);
        return ed;
    }
    ...
    public void A0A() {
        ...
        for (int i11 = 0; i11 < this.A0C.size(); i11++) {
            ...
            if (zA0E && ((z10 = (downloadAction = ed.A04).A03) || i10 == 0)) {
                boolean z11 = true;
                int i12 = 0;
                while (true) {
                    if (i12 >= i11) {
