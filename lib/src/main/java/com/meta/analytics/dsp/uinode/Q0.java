...
public final class Q0 extends FrameLayout {
    ...
    public final C02501c A04;
    public final C1073Yn A05;
    public final J2 A06;
    public final InterfaceC0779Nb A07;
    public final C0952Ts A08;
    public final InterfaceC0854Py A09;
    ...
    public Q0(C1073Yn c1073Yn, AbstractC1176b5 abstractC1176b5, C02501c c02501c, J2 j22, InterfaceC0854Py interfaceC0854Py, Map<String, String> playableMetricsData) {
        super(c1073Yn);
        this.A0A = new AtomicBoolean(false);
        this.A0B = new AtomicBoolean(false);
        this.A01 = -1L;
        this.A00 = 0;
        this.A07 = new AbstractC0955Tv() { // from class: com.facebook.ads.redexgen.X.9O
        ...
        this.A04 = c02501c;
        this.A06 = j22;
        this.A09 = interfaceC0854Py;
        this.A02 = playableMetricsData;
        C0952Ts c0952TsA04 = A04();
        this.A08 = c0952TsA04;
        if (C0662Ih.A1W(c1073Yn)) {
            c1073Yn.A0A().AGv(c0952TsA04, abstractC1176b5.A12(), false);
        }
        addView(c0952TsA04, A0F);
    }
    ...
    private C0952Ts A04() {
        C0952Ts c0952Ts = new C0952Ts(this.A05, (WeakReference<InterfaceC0779Nb>) new WeakReference(this.A07), 10, C0662Ih.A1f(this.A05));
        c0952Ts.setCornerRadius(A0E);
        c0952Ts.setLogMultipleImpressions(false);
        c0952Ts.setCheckAssetsByJavascriptBridge(false);
        c0952Ts.setWebViewTimeoutInMillis(this.A04.A08());
        c0952Ts.setRequestId(this.A03.A0S());
        c0952Ts.setOnTouchListener(new ViewOnTouchListenerC0855Pz(this));
        WebSettings settings = c0952Ts.getSettings();
        ...
        if (Build.VERSION.SDK_INT > 16) {
            c0952Ts.addJavascriptInterface(new Q1(this.A05, this, this.A06, this.A02, this.A03.A12()), A06(0, 12, 104));
        }
        return c0952Ts;
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x00b8, code lost:
        ...
        if (r3 <= com.meta.analytics.dsp.uinode.C0662Ih.A0H(r8)) goto L14;
     */
    ...
    public final void A0B() {
        ...
        if (this.A04.A0J()) {
            ...
            try {
                ...
                Log.e(A06(92, 15, 31), A06(12, 13, 65), e5);
            }
            c8b.A07(jSONObject);
            c8b.A05(1);
            ...
            anonymousClass89A07.A9b(strA06, i10, c8b);
            if (C0662Ih.A0m(this.A05) && AbstractC0729Ld.A00(this.A05) == EnumC0728Lc.A07) {
        ...
        try {
            ...
            c0952Ts.loadUrl(strA0E);
        } catch (Exception e10) {
            this.A05.A07().A9a(A06(192, 8, 57), C8A.A2d, new C8B(e10));
        }
    }

    public final void A0C() {
        if (C0662Ih.A1W(this.A05)) {
            C1073Yn c1073Yn = this.A05;
            if (A0D[2].length() == 31) {
                throw new RuntimeException();
            }
            A0D[1] = "2a9geg5CZy9bcTekyOeVTlcxLNQduX9G";
            c1073Yn.A0A().AGk(this.A08);
        }
