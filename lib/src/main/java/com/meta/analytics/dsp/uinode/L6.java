    ...
    */
    public static int A05(org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.lang.NumberFormatException, java.io.IOException {
        ...
        L49:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.L6.A05(org.xmlpull.v1.XmlPullParser):int");
    }
    ...
    public static void A09(Context context) {
        ...
        A04 = L5.A03;
        Executors.newSingleThreadExecutor().execute(new C0970Uk(context));
    }

    public static void A0A(C04017f c04017f, Throwable th) {
        c04017f.A07().A9a(A06(38, 7, 69), C8A.A1c, new C8B(th));
    }
    ...
    public static boolean A0C(C04017f c04017f) {
        ...
        boolean z10 = true;
        try {
            xmlResourceParserOpenXmlResourceParser = c04017f.getAssets().openXmlResourceParser(A06(0, 19, 71));
            loop0: while (true) {
                ...
                if (xmlResourceParserOpenXmlResourceParser.getEventType() == 2 && (xmlResourceParserOpenXmlResourceParser.getName().equals(A06(27, 11, 77)) || xmlResourceParserOpenXmlResourceParser.getName().equals(A06(19, 8, 32)))) {
                    for (int i10 = 0; i10 < xmlResourceParserOpenXmlResourceParser.getAttributeCount(); i10++) {
                        if (xmlResourceParserOpenXmlResourceParser.getAttributeName(i10).equals(A06(58, 18, 89)) && !Boolean.parseBoolean(xmlResourceParserOpenXmlResourceParser.getAttributeValue(i10))) {
                            z10 = false;
                            break loop0;
                        }
                    }
