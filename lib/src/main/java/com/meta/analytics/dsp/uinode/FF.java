...
public final class FF extends AbstractC1145aa {
    ...
    public static final AnonymousClass27 A03 = new C1133aO();
    public C1138aT A00;
    ...
    public final void A09() {
        C1138aT c1138aT = new C1138aT(this.A01, this, A04());
        this.A00 = c1138aT;
        c1138aT.A0G(this.A01.A0B(), this.A01.A07());
    }
    ...
    public final void A0D(InterstitialAd interstitialAd, EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        C1138aT c1138aT = this.A00;
        if (c1138aT != null) {
            c1138aT.A0G(cacheFlags, str);
            return;
        }
        this.A01.A0K(cacheFlags);
        this.A01.A0H(str);
        if (AbstractC0664Ik.A07(this.A02) && AbstractC0664Ik.A08(this.A02)) {
            A05();
        } else {
            A09();
        }
    ...
    public final boolean A0H(InterstitialAd interstitialAd, InterstitialAd.InterstitialShowAdConfig interstitialShowAdConfig) {
        ...
        C1138aT c1138aT2 = new C1138aT(this.A01, this, A04());
        this.A00 = c1138aT2;
        c1138aT2.A0J();
        return false;
    }
