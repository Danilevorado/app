...
public final class C0678Iz {
    ...
    public C0678Iz(C04017f c04017f, String str, double d10, String str2, Map<String, String> map, J4 j42, J5 j52, boolean z10) throws JSONException {
        this.A05 = str;
        this.A00 = d10;
        this.A04 = str2;
        this.A02 = j42;
        ...
        if (z10) {
            map2.put(A00(27, 24, 34), String.valueOf(z10));
        }
        String strA01 = JC.A01(str);
        if (!TextUtils.isEmpty(strA01) && (z10 || j52 == J5.A0C)) {
            map2.put(A00(6, 21, 61), strA01);
        }
        if (A0B()) {
            Map<String, String> extraData = c04017f.A03().A61();
