...
public class C0781Nd extends WebViewClient {
    ...
    public C0781Nd(C1073Yn c1073Yn, WeakReference<InterfaceC0779Nb> weakReference, WeakReference<RE> weakReference2, WeakReference<C0732Lg> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<C0952Ts> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c1073Yn;
    ...
    private void A03(int i10, CharSequence charSequence, long j10) throws JSONException {
        ...
        try {
            ...
            jSONObject.put(A01(223, 22, 64), j10);
    ...
    public void A04(int i10, String str) throws JSONException {
    ...
    private void A07(String str, String str2) throws JSONException {
        ...
        if (c1073Yn != null) {
            c1073Yn.A07().A9a(A01(306, 8, 32), C8A.A2a, new C8B(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 72) + jSONObject.toString()));
        }
    }
    ...
    */
    private boolean A08(android.net.Uri r8) throws org.json.JSONException {
        /*
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C0781Nd.A0C
            r0 = 4
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 8
            if (r1 == r0) goto Lac
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C0781Nd.A0C
        ...
        L4f:
            ...
            java.util.List r5 = com.meta.analytics.dsp.uinode.C03786c.A09(r0)
            ...
            r0.toString()
        L7b:
            java.lang.String r3 = com.meta.analytics.dsp.uinode.C0952Ts.A03()
        ...
        Lac:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0781Nd.A08(android.net.Uri):boolean");
    }
    ...
    public final void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        ...
        this.A02.A0E().AH8();
        this.A00 = new Date();
        new Handler().postDelayed(new C0953Tt(this), this.A08.get());
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) throws JSONException {
        boolean zA0u = C0662Ih.A0u(this.A02);
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        NY.A02(C8A.A2Z);
        InterfaceC0779Nb adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().AB4(str, new C0786Ni().A03(this.A07.get()).A02(this.A06.get()).A05());
            return true;
        }
        return true;
    }
