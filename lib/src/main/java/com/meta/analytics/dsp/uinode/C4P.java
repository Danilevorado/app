...
public final class C4P implements Runnable {
    ...
    public long A00;
    public long A01;
    public ArrayList<C0556Eb> A02 = new ArrayList<>();
    ...
    private AnonymousClass56 A00(C0556Eb c0556Eb, int i10, long j10) {
        if (A08(c0556Eb, i10)) {
            return null;
        }
        C03464w c03464w = c0556Eb.A0r;
        try {
            c0556Eb.A1K();
            AnonymousClass56 anonymousClass56A0I = c03464w.A0I(i10, false, j10);
            if (anonymousClass56A0I != null) {
                if (anonymousClass56A0I.A0Y() && !anonymousClass56A0I.A0Z()) {
                    c03464w.A0T(anonymousClass56A0I.A0H);
                } else {
                    c03464w.A0Z(anonymousClass56A0I, false);
                }
            }
    ...
    */
    private void A02() {
        ...
        L8:
            ...
            com.facebook.ads.redexgen.X.Eb r1 = (com.meta.analytics.dsp.uinode.C0556Eb) r1
        ...
        L26:
            ...
            r3 = 0
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C4P.A06
            r0 = 3
            r1 = r2[r0]
            r0 = 7
            r0 = r2[r0]
        ...
        L51:
            ...
            com.facebook.ads.redexgen.X.Eb r9 = (com.meta.analytics.dsp.uinode.C0556Eb) r9
        ...
        Laa:
            ...
            com.facebook.ads.redexgen.X.4O r0 = (com.meta.analytics.dsp.uinode.C4O) r0
            goto L8c
        Lb3:
            java.util.ArrayList<com.facebook.ads.redexgen.X.4O> r1 = r10.A03
            java.util.Comparator<com.facebook.ads.redexgen.X.4O> r0 = com.meta.analytics.dsp.uinode.C4P.A04
            java.util.Collections.sort(r1, r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C4P.A02():void");
    }
    ...
    */
    private void A04(long r4) {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.4O r1 = (com.meta.analytics.dsp.uinode.C4O) r1
        ...
        L16:
            ...
            goto L1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C4P.A04(long):void");
    }
    ...
    private void A06(C4O c4o, long j10) {
        AnonymousClass56 anonymousClass56A00 = A00(c4o.A03, c4o.A01, c4o.A04 ? Long.MAX_VALUE : j10);
        if (anonymousClass56A00 != null && anonymousClass56A00.A09 != null && anonymousClass56A00.A0Y() && !anonymousClass56A00.A0Z()) {
            A07(anonymousClass56A00.A09.get(), j10);
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A07(com.meta.analytics.dsp.uinode.C0556Eb r7, long r8) {
        /*
            r6 = this;
            if (r7 != 0) goto L3
            return
        L3:
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C4P.A06
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 17
        ...
        L26:
            ...
            com.meta.analytics.dsp.uinode.AbstractC02902q.A01(r0)     // Catch: java.lang.Throwable -> L6e
        ...
        L77:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C4P.A07(com.facebook.ads.redexgen.X.Eb, long):void");
    }

    public static boolean A08(C0556Eb c0556Eb, int i10) {
        int iA06 = c0556Eb.A01.A06();
        for (int i11 = 0; i11 < iA06; i11++) {
            AnonymousClass56 anonymousClass56A0F = C0556Eb.A0F(c0556Eb.A01.A0A(i11));
            int childCount = anonymousClass56A0F.A03;
            if (childCount == i10 && !anonymousClass56A0F.A0Z()) {
                return true;
            }
        }
        return false;
    ...
    public final void A09(C0556Eb c0556Eb) {
        this.A02.add(c0556Eb);
    }

    public final void A0A(C0556Eb c0556Eb) {
        this.A02.remove(c0556Eb);
    }

    public final void A0B(C0556Eb c0556Eb, int i10, int i11) {
        if (c0556Eb.isAttachedToWindow() && this.A01 == 0) {
            this.A01 = c0556Eb.getNanoTime();
            c0556Eb.post(this);
        }
        c0556Eb.A02.A03(i10, i11);
    }

    @Override // java.lang.Runnable
    public final void run() {
        try {
            AbstractC02902q.A01(A01(18, 11, 2));
            if (this.A02.isEmpty()) {
                return;
            }
            ...
            for (int i10 = 0; i10 < size; i10++) {
                C0556Eb c0556Eb = this.A02.get(i10);
                if (c0556Eb.getWindowVisibility() == 0) {
                    jMax = Math.max(c0556Eb.getDrawingTime(), jMax);
                }
            }
            if (jMax == 0) {
                this.A01 = 0L;
