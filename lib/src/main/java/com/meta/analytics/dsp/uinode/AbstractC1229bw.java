...
public abstract class AbstractC1229bw {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C1227bu.A07(collection, A00(0, 10, 112));
        ...
        while (true) {
            ...
            if (i11 >= length) {
                ...
                C1227bu.A06(objArrCopyOf, strA00);
                i10 = i11;
            } else {
                if (!it.hasNext()) {
                    Object[] objArrCopyOf2 = Arrays.copyOf(objArrCopyOf, i11);
                    C1227bu.A06(objArrCopyOf2, strA00);
            ...
            if (size == 0) {
                ...
                if (!zHasNext) {
                    ...
                    if (size <= $i$f$toArrayImpl2) {
                        ...
                        C1227bu.A05(objNewInstance, A00(21, 62, 53));
                        ...
                        if (i10 >= length) {
                            ...
                            if (!it.hasNext()) {
                                if (objArrCopyOf == objArr) {
                                    ...
                                    objArr = Arrays.copyOf(objArrCopyOf, i10);
                                    C1227bu.A06(objArr, strA00);
                                }
                                return objArr;
                            }
                            size$iv = i10;
