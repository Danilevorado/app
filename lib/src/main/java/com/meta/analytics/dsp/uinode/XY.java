...
public final class XY implements CC {
    ...
    public final void A42(int i10, int i11, InterfaceC0512Bt interfaceC0512Bt) throws InterruptedException, IOException {
        this.A00.A0K(i10, i11, interfaceC0512Bt);
    }

    @Override // com.meta.analytics.dsp.uinode.CC
    public final void A5X(int i10) throws C04629v {
        this.A00.A0I(i10);
    }

    @Override // com.meta.analytics.dsp.uinode.CC
    public final void A5j(int i10, double d10) throws C04629v {
    ...
    @Override // com.meta.analytics.dsp.uinode.CC
    public final void A8t(int i10, long j10) throws C04629v {
    ...
    @Override // com.meta.analytics.dsp.uinode.CC
    public final void AGU(int i10, long j10, long j11) throws C04629v {
        this.A00.A0M(i10, j10, j11);
    }

    @Override // com.meta.analytics.dsp.uinode.CC
    public final void AGc(int i10, String str) throws C04629v {
