...
public final class C3C extends C3P implements InterfaceC0842Pm {
    ...
    public C3C(C1073Yn c1073Yn) {
        ...
        this.A00 = 0;
        this.A05 = false;
        this.A06 = new C0499Bg(c1073Yn, new C0839Pj(), new C0838Pi());
        A02();
    }

    public C3C(C1073Yn c1073Yn, AttributeSet attributeSet) {
    ...
    public C3C(C1073Yn c1073Yn, AttributeSet attributeSet, int i10) {
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0842Pm
    ...
    @Override // com.meta.analytics.dsp.uinode.C0556Eb, android.view.View
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.A05) {
            int i12 = (int) LD.A02;
            int verticalPadding = C0662Ih.A0E(getContext());
    ...
    public void setAdapter(AbstractC03274c abstractC03274c) {
        this.A06.A2H(abstractC03274c == null ? -1 : abstractC03274c.hashCode());
        super.setAdapter(abstractC03274c);
    }
    ...
    public void setChildWidth(int i10) {
        ...
        C0499Bg c0499Bg = this.A06;
        int pageWidth3 = this.A01;
        c0499Bg.A2I((i12 - pageWidth3) / 2);
        C0499Bg c0499Bg2 = this.A06;
        int pageWidth4 = this.A01;
        c0499Bg2.A2G(pageWidth4 / measuredWidth);
    }
