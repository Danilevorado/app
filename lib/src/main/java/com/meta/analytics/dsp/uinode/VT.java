...
public final class VT implements J1 {
    ...
    public VT(C1072Ym c1072Ym, J0 j02) {
        this.A07 = j02;
        this.A06 = c1072Ym;
        this.A04 = (ConnectivityManager) c1072Ym.getSystemService(A03(293, 12, 10));
        this.A08 = C0884Rc.A01(c1072Ym);
        this.A03 = Ij.A0K(c1072Ym);
        this.A02 = Ij.A0J(c1072Ym);
    }
    ...
    public final void A0B() throws JSONException {
        try {
            ...
            if (!TextUtils.isEmpty(strA69) && rjADz != null) {
                if (rjADz.A83() != 200) {
                    ...
                    if (A0E[4].length() != 29) {
                        ...
                        if (iA83 == 413 && C0662Ih.A22(this.A06)) {
                            this.A07.ACo();
                            A05();
                            return;
                        } else {
            ...
            if (C0662Ih.A1t(this.A06) && jSONObjectA4a.has(strA03)) {
                this.A07.ABI(jSONObjectA4a.getJSONArray(strA03));
            }
            A06();
        } catch (Exception e5) {
            if (this.A06.A04().A8z()) {
                Log.e(A0F, A03(23, 35, 54), e5);
            }
            A06();
        }
    }

    @Override // com.meta.analytics.dsp.uinode.J1
