...
public abstract class OI {
    ...
    public static int A02(int bottomMargin) {
        int ctaMargin = AbstractC0740Lo.A01(16);
        int ctaTextHeight = AbstractC0799Nv.A0A;
    ...
    public static OH A03(ViewOnClickListenerC0945Tl viewOnClickListenerC0945Tl, String str) {
        return new OH(viewOnClickListenerC0945Tl, str);
    }
