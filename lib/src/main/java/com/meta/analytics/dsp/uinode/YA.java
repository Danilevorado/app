...
public final class YA<T> implements AnonymousClass97<T> {
    ...
    public synchronized boolean A06(YB yb2) {
        if (!this.A02.remove(yb2)) {
            return false;
        }
        if (yb2.A5g() > 0 && yb2.A01().A02.A05(yb2.A01().A01).equals(this.A01)) {
            this.A01 = yb2.A00().A02;
        }
        return true;
    }
    ...
    public YA(AnonymousClass94 anonymousClass94, C9C c9c) throws IOException {
        ...
        C04408y c04408y = new C04408y(new File(anonymousClass94.A05(), A00(509, 6, 70)));
        this.A04 = c04408y;
        this.A00 = c04408y.A03();
    ...
    private void A02(int i10, int i11) throws IOException {
        C04418z c04418z = new C04418z(i10, i11);
        this.A00 = c04418z;
        this.A04.A04(c04418z);
    }
    ...
    public synchronized void A03(YB yb2) throws C9G {
        if (!this.A03) {
            if (A06(yb2)) {
                if (yb2.A5g() == 0) {
                    return;
                }
                if (this.A00.A04(yb2.A00().A02) == 0) {
                    try {
                        Iterator<C9B> it = yb2.A00.iterator();
                        while (it.hasNext()) {
                            if (it.next().A00 == this.A05.A07() && this.A05.A0D()) {
                                A02(this.A05.A06(), 0);
                            } else {
                                A02(this.A05.A06(), yb2.A00().A00);
                                break;
                            }
                        }
                        ...
                        throw new C9G(A00(361, 30, 93), e5);
                    }
                }
    ...
    */
    ...
    public final synchronized AnonymousClass96 A5f(byte[] bArr, int[] iArr) throws C9G {
        ...
        if (!this.A03) {
            ...
            try {
                ...
                while (true) {
                    AnonymousClass92 anonymousClass92A0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i10, iArr, i11);
                    ...
                    if (anonymousClass92A0A.A01().A03() == AnonymousClass90.A04) {
                        ...
                        this.A01 = new C04418z(storageOffset5 + 1, 0);
                    } else {
                        this.A01 = this.A01.A05(i12);
                    }
                }
                yb2 = new YB(this, arrayList, mayHaveMoreData);
                this.A02.add(yb2);
                if (!arrayList.isEmpty()) {
                    C04418z c04418z = yb2.A01().A02;
                    int storageOffset6 = yb2.A01().A01;
                    this.A01 = c04418z.A05(storageOffset6);
                }
            } catch (IOException e5) {
                throw new C9G(A00(306, 29, 79), e5);
            }
        } else {
    ...
    public final synchronized int A7n() throws C9G {
        ...
        if (!this.A03) {
            try {
                ...
                throw new C9G(A00(335, 26, 122), e5);
            }
        } else {
            throw new C9G(A00(427, 39, 68));
        }
    ...
    public final synchronized void AGb(byte[] bArr) throws C9G {
        if (!this.A03) {
            try {
                ...
                throw new C9G(A00(257, 25, 61), e5);
            }
        } else {
            throw new C9G(A00(427, 39, 68));
        }
    ...
    public final synchronized void clear() throws C9G {
        try {
            ...
            throw new C9G(A00(282, 24, 16), e5);
        }
    }
