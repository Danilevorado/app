...
public final class C0525Cj {
    ...
    public int A01;
    public boolean A02;
    public final C0526Ck A03 = new C0526Ck();
    public final C0654Hz A04 = new C0654Hz(new byte[65025], 0);
    public int A00 = -1;
    ...
    private int A00(int i10) {
        ...
        do {
            ...
            C0526Ck c0526Ck = this.A03;
            if (A05[0].length() == 13) {
                A05[5] = "SgZ2PRj4NlkJ3BHKSnaMRED72QUEdulA";
                int size = c0526Ck.A02;
                if (i12 >= size) {
                    break;
                }
    ...
    public final void A04() {
        ...
        C0654Hz c0654Hz2 = this.A04;
        if (A05[2].length() == 26) {
            throw new RuntimeException();
        }
        A05[0] = "HnsfJzdopseCo";
        c0654Hz.A00 = Arrays.copyOf(bArr, Math.max(65025, c0654Hz2.A07()));
    }
  ...
  0x0097: PHI (r3v5 'segmentIndex' int) = (r3v1 'segmentIndex' int), (r3v6 'segmentIndex' int) binds: [B:46:0x0108, B:30:0x0095] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final boolean A05(com.meta.analytics.dsp.uinode.InterfaceC0512Bt r11) throws java.lang.InterruptedException, java.io.IOException {
        /*
            Method dump skipped, instructions count: 280
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0525Cj.A05(com.facebook.ads.redexgen.X.Bt):boolean");
    }
}
