...
public final class AsyncTaskC0693Jq extends AsyncTask<RW, Void, RJ> implements RT {
        ...
        try {
            if (rwArr != null) {
                try {
                    ...
                    this.A02 = e5;
                    if (this.A01.A0K().A04()) {
                        String.format(Locale.US, A01(64, 23, 98), e5.getMessage());
                    }
                    cancel(true);
                    return null;
                }
    ...
    public AsyncTaskC0693Jq(C0684Jh c0684Jh, RL rl, Executor executor) {
        this.A01 = c0684Jh;
        this.A00 = rl;
        this.A03 = executor;
    }
