...
public abstract class AbstractC0694Jr implements RZ {
    ...
    public final InterfaceC0882Ra A00;
    ...
    public AbstractC0694Jr(InterfaceC0882Ra interfaceC0882Ra) {
        this.A00 = interfaceC0882Ra;
    }
    ...
    public final boolean ABU(RX rx) {
        RJ rjA00 = rx.A00();
        if (this.A00.A98()) {
            Log.e(AbstractC0694Jr.class.getSimpleName(), A00(14, 27, 78), rx);
        }
