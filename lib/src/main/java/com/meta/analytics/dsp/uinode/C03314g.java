...
public final class C03314g extends C8 {
    ...
    public C03314g(List<byte[]> list) {
        super(A02(182, 10, 38));
        if (list != null && !list.isEmpty()) {
            this.A04 = true;
            String strA0Q = IF.A0Q(list.get(0));
            String formatLine = A02(47, 8, 49);
            AbstractC0629Ha.A03(strA0Q.startsWith(formatLine));
            A06(strA0Q);
            A04(new C0654Hz(list.get(1)));
            return;
        }
        this.A04 = false;
    }
    ...
    public final WF A0b(byte[] bArr, int i10, boolean z10) {
        ...
        C0644Hp c0644Hp = new C0644Hp();
        C0654Hz c0654Hz = new C0654Hz(bArr, i10);
        if (!this.A04) {
            A04(c0654Hz);
        }
        A05(c0654Hz, arrayList, c0644Hp);
        C0592Fn[] c0592FnArr = new C0592Fn[arrayList.size()];
        arrayList.toArray(c0592FnArr);
        return new WF(c0592FnArr, c0644Hp.A05());
    }

    private void A04(C0654Hz c0654Hz) {
        String strA0P;
        do {
            strA0P = c0654Hz.A0P();
            if (strA0P == null) {
    ...
    private void A05(C0654Hz c0654Hz, List<C0592Fn> list, C0644Hp c0644Hp) {
        while (true) {
            String strA0P = c0654Hz.A0P();
            if (strA0P != null) {
                if (!this.A04 && strA0P.startsWith(A02(47, 8, 49))) {
                    A06(strA0P);
                } else if (strA0P.startsWith(A02(37, 10, 28))) {
                    A07(strA0P, list, c0644Hp);
                }
            } else {
                return;
            }
    ...
    */
    private void A06(java.lang.String r9) {
        ...
        L2a:
            ...
            java.lang.String r6 = com.meta.analytics.dsp.uinode.IF.A0M(r0)
            int r0 = r6.hashCode()
            switch(r0) {
        ...
        L90:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C03314g.A06(java.lang.String):void");
    }

    private void A07(String str, List<C0592Fn> list, C0644Hp c0644Hp) {
        int i10 = this.A01;
        String strA02 = A02(182, 10, 38);
        if (i10 == 0) {
        ...
        list.add(new C0592Fn(endTimeString.replaceAll(strA023, strA024).replaceAll(A02(203, 3, 50), strA024)));
        c0644Hp.A04(startTimeUs);
        if (jA00 != -9223372036854775807L) {
            list.add(null);
            String[] strArr = A06;
