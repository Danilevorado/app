...
public final class PB {
    ...
    public final AbstractC1176b5 A09;
    public final C03786c A0A;
    public final C1073Yn A0B;
    public final J2 A0C;
    public final JA A0D;
    public final C0828Oy A0E;
    public final TE A0F;
    public final PM A0G;
    public final PN A0H;
    public final String A0I;
    public final LinkedList<P8> A0J = new LinkedList<>();
    public C0732Lg A01 = new C0732Lg();
    ...
    public final void A0i(Map<String, String> map) throws JSONException {
        ...
        if (map.containsKey(strA0A) && C0662Ih.A1X(this.A0B)) {
            try {
                ...
                this.A0B.A07().A9a(A0A(274, 14, 27), 3600, new C8B(e5));
            }
        }
        if (map.containsKey(strA0A)) {
            map.remove(strA0A);
        }
        this.A0C.A9Z(this.A09.A12(), new C0786Ni(map).A03(this.A05).A05());
    }
    ...
    public PB(C1073Yn c1073Yn, AbstractC1176b5 abstractC1176b5, J2 j22, int i10) {
        this.A0B = c1073Yn;
        this.A0C = j22;
        this.A09 = abstractC1176b5;
        this.A08 = i10;
        this.A0F = new TE(this, c1073Yn);
        C03786c c03786c = new C03786c(c1073Yn);
        this.A0A = c03786c;
        JA ja2 = new JA(abstractC1176b5.A12(), j22);
        this.A0D = ja2;
        C0828Oy c0828Oy = new C0828Oy(abstractC1176b5.A0S(), abstractC1176b5.A0x().A0D().A08(), i10);
        this.A0E = c0828Oy;
        String string = UUID.randomUUID().toString();
        this.A0I = string;
        this.A0H = PO.A00(c1073Yn, abstractC1176b5.A0V(), c03786c, ja2, c0828Oy, A0H());
        this.A0G = new PM(c1073Yn, this, j22, c0828Oy, string, abstractC1176b5.A12());
    }
    ...
    private boolean A0I() {
        return C0662Ih.A2R(this.A0B, C0878Qw.A03());
    }
    ...
    public final C0732Lg A0L() {
        return this.A01;
    }

    public final C0828Oy A0M() {
        return this.A0E;
    }
    ...
    public final void A0Z(C0732Lg c0732Lg) {
        this.A01 = c0732Lg;
    }
    ...
    public final void A0j(JSONObject jSONObject) {
        String strReplace = Base64.encodeToString(jSONObject.toString().getBytes(), 0).replace(A0A(0, 1, 45), A0A(0, 0, 109));
