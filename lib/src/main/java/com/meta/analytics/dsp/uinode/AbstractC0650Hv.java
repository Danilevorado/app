...
public abstract class AbstractC0650Hv {
    ...
    */
    public static com.meta.analytics.dsp.uinode.C0649Hu A06(byte[] r19, int r20, int r21) {
        /*
            Method dump skipped, instructions count: 521
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0650Hv.A06(byte[], int, int):com.facebook.ads.redexgen.X.Hu");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L19:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0650Hv.A03(byte[], int, int):int");
    }
    ...
    */
    public static int A04(byte[] r8, int r9, int r10, boolean[] r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0650Hv.A04(byte[], int, int, boolean[]):int");
    }

    public static C0648Ht A05(byte[] bArr, int i10, int i11) {
        I0 i02 = new I0(bArr, i10, i11);
        i02.A07(8);
        int iA04 = i02.A04();
        int seqParameterSetId = i02.A04();
        i02.A06();
        return new C0648Ht(iA04, seqParameterSetId, i02.A0A());
    }
    ...
    public static void A09(I0 i02, int i10) {
        ...
        for (int i12 = 0; i12 < i10; i12++) {
            if (deltaScale != 0) {
                ...
                deltaScale = ((lastScale + i11) + 256) % 256;
            }
            if (deltaScale != 0) {
                i11 = deltaScale;
            }
    ...
    */
    public static void A0A(java.nio.ByteBuffer r8) {
        ...
        L6:
            ...
            if (r6 != r0) goto L6a
            r7 = 1
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.AbstractC0650Hv.A02
            r0 = 4
            r1 = r1[r0]
            r0 = 6
            ...
            throw r0
        L28:
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.AbstractC0650Hv.A02
        ...
        L81:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0650Hv.A0A(java.nio.ByteBuffer):void");
    }
    ...
    public static boolean A0C(String str, byte b10) {
        if (A07(46, 9, 117).equals(str) && (b10 & 31) == 6) {
            return true;
        }
        return A07(55, 10, 62).equals(str) && ((b10 & 126) >> 1) == 39;
    }
}
