...
public final class C02832j extends Drawable {
    public static InterfaceC02822i A0G;
    ...
    public final int A0C = AbstractC02782e.A09;
    ...
    public C02832j(Resources resources, ColorStateList colorStateList, float f5, float f10, float f11) {
        A07(colorStateList);
        Paint paint = new Paint(5);
        this.A05 = paint;
        paint.setStyle(Paint.Style.FILL);
        this.A00 = (int) (0.5f + f5);
        this.A0F = new RectF();
    ...
    public static float A00(float f5, float f10, boolean z10) {
        if (z10) {
            double d10 = f5;
            if (A0I[2].length() == 3) {
                throw new RuntimeException();
            ...
            return (float) (d10 + ((1.0d - A0J) * f10));
        }
        return f5;
    }

    public static float A01(float f5, float f10, boolean z10) {
        if (z10) {
            return (float) ((1.5f * f5) + ((1.0d - A0J) * f10));
        }
        return 1.5f * f5;
    }

    private int A02(float f5) {
        int i10 = (int) (0.5f + f5);
        if (i10 % 2 == 1) {
            int i11 = i10 - 1;
            String[] strArr = A0I;
    ...
    private void A04() {
        ...
        int i10 = this.A0E;
        paint.setShader(new RadialGradient(0.0f, 0.0f, f13, new int[]{i10, i10, this.A0D}, new float[]{0.0f, f12, 1.0f}, Shader.TileMode.CLAMP));
        ...
        int i11 = this.A0E;
        paint2.setShader(new LinearGradient(0.0f, f15, 0.0f, f16, new int[]{i11, i11, this.A0D}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
        this.A06.setAntiAlias(false);
    }

    private void A06(float f5, float f10) {
        String strA03 = A03(0, 14, 25);
        if (f5 < 0.0f) {
            throw new IllegalArgumentException(A03(53, 20, 13) + f5 + strA03);
        }
        if (A0I[1].length() == 0) {
            ...
            if (f10 >= 0.0f) {
                ...
                throw new IllegalArgumentException(A03(14, 24, 127) + f10 + strA03);
            }
        }
        throw new RuntimeException();
    }
    ...
    private void A08(Canvas canvas) {
        float f5 = this.A00;
        float f10 = (-f5) - this.A03;
        float edgeShadowTop = this.A0C;
        float f11 = f5 + edgeShadowTop;
        ...
        if (z10) {
            ...
            canvas.drawRect(0.0f, f10, fWidth, -edgeShadowTop7, this.A06);
        }
        ...
        if (z10) {
            ...
            canvas.drawRect(0.0f, f10, fWidth2, f14 + edgeShadowTop11, this.A06);
        }
        ...
        if (A0I[2].length() != 3) {
            ...
            if (z11) {
                ...
                canvas.drawRect(0.0f, f10, fHeight, -edgeShadowTop14, this.A06);
            }
    ...
    private void A09(Rect rect) {
        ...
        rectF.set(f10 + verticalOffset, rect.top + f5, f12, verticalOffset3 - f5);
        A04();
    }
    ...
    public final float A0C() {
        float f5 = this.A01;
        float fMax = Math.max(f5, this.A00 + this.A0C + ((f5 * 1.5f) / 2.0f)) * 2.0f;
        float f10 = this.A01 * 1.5f;
        float content = this.A0C;
        return ((f10 + content) * 2.0f) + fMax;
    }

    public final float A0D() {
        float f5 = this.A01;
        float fMax = Math.max(f5, this.A00 + this.A0C + (f5 / 2.0f)) * 2.0f;
        float f10 = this.A01;
        float content = this.A0C;
        return ((f10 + content) * 2.0f) + fMax;
    }
    ...
    public final void A0G(float f5) {
        if (f5 >= 0.0f) {
            float f10 = (int) (0.5f + f5);
            if (this.A00 == f10) {
                return;
            }
            this.A00 = f10;
        ...
        throw new IllegalArgumentException(A03(38, 15, 4) + f5 + A03(0, 14, 25));
    }

    public final void A0H(float f5) {
        A06(this.A02, f5);
    }

    public final void A0I(float f5) {
        A06(f5, this.A01);
    }
