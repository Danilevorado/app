...
public final class LB {
    ...
    public static LA A00(C04017f c04017f) {
        try {
            boolean isRooted = A07() || A06() || A08(A01(47, 2, 99));
            return isRooted ? LA.A04 : LA.A06;
        } catch (Throwable t10) {
            c04017f.A07().A9a(A01(40, 7, 1), C8A.A1M, new C8B(t10));
            return LA.A05;
        }
    }
    ...
    public static String A02(Context context, String str) throws PackageManager.NameNotFoundException, NoSuchAlgorithmException, CertificateException {
        ...
        for (Signature signature : pm.getPackageInfo(str, 64).signatures) {
            ...
            sb2.append(LG.A04(MessageDigest.getInstance(A01(31, 4, 74)).digest(A04(signature).getEncoded())));
            sb2.append(A01(26, 1, 54));
        }
        return sb2.toString();
    }

    public static String A03(C04017f c04017f, String str) {
        try {
            return A02(c04017f, str);
        } catch (Exception e5) {
            c04017f.A07().A9a(A01(40, 7, 1), C8A.A1M, new C8B(e5));
            return null;
        }
    }
