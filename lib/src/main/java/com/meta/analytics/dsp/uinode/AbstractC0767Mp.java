...
public abstract class AbstractC0767Mp {
    ...
    public static AbstractC0766Mo A01(C1073Yn c1073Yn, J2 j22, String str, NativeAdLayout nativeAdLayout) {
        if (nativeAdLayout == null) {
            return null;
        }
        ...
        int i10 = A01;
        if (h10 >= i10 && w10 >= i10) {
            return new U4(c1073Yn, j22, str);
        }
        if (h10 < A03 || w10 < A02) {
            return null;
        }
        return new U5(c1073Yn, j22, str);
    }

    public static U6 A02(C1073Yn c1073Yn, J2 j22, String str, C02481a c02481a, MD md, MC mc) {
        return new U6(c1073Yn, j22, str, c02481a, md, mc);
    }
