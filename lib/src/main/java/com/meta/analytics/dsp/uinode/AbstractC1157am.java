...
public abstract class AbstractC1157am implements K3 {
    ...
    public static final C02420u A0G = null;
    public static final K4 A0H = null;
    public static final String A0I;
    public InterfaceC02370p A00;
    public InterfaceC02370p A01;
    public C8S A04;
    public K1 A05;
    public AbstractC02380q A06;
    public final C02681u A07;
    public final J2 A08;
    public final C02420u A09;
    public final K4 A0A;
    ...
    public abstract void A0O(InterfaceC02370p interfaceC02370p, C8S c8s, C8Q c8q, C02691v c02691v);

    static {
        A08();
        AbstractC0742Lq.A02();
        A0I = AbstractC1157am.class.getSimpleName();
        A0F = new Handler(Looper.getMainLooper());
    }

    public AbstractC1157am(C1073Yn c1073Yn, C02681u c02681u) {
        this.A0B = c1073Yn;
        this.A07 = c02681u;
        K4 k42 = A0H;
        if (k42 != null) {
        ...
        if (c02420u != null) {
            ...
            this.A09 = new C02420u();
        }
        DynamicLoaderFactory.makeLoader(c1073Yn).getInitApi().onAdLoadInvoked(c1073Yn);
        this.A08 = c1073Yn.A09();
        c1073Yn.A0E().A4r();
    }

    private void A09(C0975Up c0975Up) throws JSONException {
        C8S placement = c0975Up.A00();
        if (placement == null || placement.A05() == null) {
            String strA07 = A07(279, 29, 125);
            C0679Jb error = new C0679Jb(AdErrorType.NO_AD_PLACEMENT, strA07);
            this.A0B.A0E().A4t(error.A03().getErrorCode(), strA07);
            AbstractC02380q abstractC02380q = this.A06;
            if (abstractC02380q != null) {
                abstractC02380q.A0G(error);
                return;
            }
            return;
        }
        ...
        if (jSONObjectA09 == null) {
            ...
            if (this.A00 == null) {
                ...
                ABR(C0679Jb.A00(AdErrorType.INTERNAL_ERROR));
                return;
            }
            C02691v loadConfig = new C02691v(c8qA04.A04(), c8s.A05(), this.A07.A0A, c8s.A05().A0C());
        ...
        try {
            if (arrayList.size() > 1 && this.A00.AGd()) {
                ...
                C02691v loadConfig2 = new C02691v(jSONObject, c8s.A05(), this.A07.A0A, c8s.A05().A0C());
        ...
        if (!loaded) {
            if (arrayList.isEmpty()) {
                C0679Jb c0679JbA01 = C0679Jb.A01(AdErrorType.NO_FILL, A07(0, 0, 73));
                this.A0B.A0E().A4t(c0679JbA01.A03().getErrorCode(), A07(133, 22, 67));
                AbstractC02380q abstractC02380q2 = this.A06;
                if (abstractC02380q2 != null) {
                    abstractC02380q2.A0G(c0679JbA01);
                    return;
                }
                return;
            }
            InterfaceC02370p interfaceC02370p = this.A00;
            String[] strArr = A0E;
            ...
            C02691v loadConfig3 = new C02691v(c8q.A04(), c8s.A05(), this.A07.A0A, c8s.A05().A0C());
    ...
    private final void A0A(String str, AdExperienceType adExperienceType) {
        ...
        if (Build.VERSION.SDK_INT < 17) {
            ABR(new C0679Jb(AdErrorType.API_NOT_SUPPORTED, A07(0, 0, 73)));
            return;
        }
        try {
            C0688Jl bidPayload = new C0688Jl(this.A0B, str, this.A07.A0A, this.A07.A09);
            K1 k1A01 = this.A07.A01(this.A0B, bidPayload, adExperienceType);
            this.A05 = k1A01;
            this.A0A.A0O(k1A01);
        } catch (C0680Jc e5) {
            C0679Jb c0679JbA02 = C0679Jb.A02(e5);
    ...
    private void A0B(JSONObject jSONObject) {
        if (jSONObject != null) {
            ...
            C02440w.A01(this.A0B).A0O(jSONObject);
        }
    }
    ...
    private boolean A0D(C8S c8s, C8Q c8q) {
        ...
        if (c8q == null) {
            C0679Jb c0679JbA01 = C0679Jb.A01(AdErrorType.NO_FILL, strA07);
            this.A0B.A0E().A4t(c0679JbA01.A03().getErrorCode(), A07(133, 22, 67));
            AbstractC02380q abstractC02380q = this.A06;
            if (abstractC02380q != null) {
                abstractC02380q.A0G(c0679JbA01);
            }
            return false;
        }
        String strA02 = c8q.A02();
        InterfaceC02370p interfaceC02370pA00 = this.A09.A00(this.A0B, c8s.A05().A0D());
        if (interfaceC02370pA00 == null) {
            this.A0B.A07().A9a(A07(195, 3, 93), C8A.A0a, new C8B(A07(0, 22, 2), strA02));
            ABR(C0679Jb.A00(AdErrorType.INTERNAL_ERROR));
            return false;
        }
        if (this.A07.A00() != interfaceC02370pA00.A7e()) {
            C0679Jb c0679JbA012 = C0679Jb.A01(AdErrorType.INTERNAL_ERROR, strA07);
            this.A0B.A0E().A4t(c0679JbA012.A03().getErrorCode(), A07(155, 19, 37));
            AbstractC02380q abstractC02380q2 = this.A06;
            if (abstractC02380q2 != null) {
                abstractC02380q2.A0G(c0679JbA012);
            }
            return false;
        }
        this.A00 = interfaceC02370pA00;
        String[] strArr = A0E;
        if (strArr[4].length() == strArr[1].length()) {
            throw new RuntimeException();
        }
        ...
        if (dataObject != null) {
            ...
            if (c1072YmA00 != null) {
                c1072YmA00.A0C(adapterName);
            }
            A0B(dataObject.optJSONObject(A07(262, 17, 72)));
            if (this.A05 == null) {
                String strA072 = A07(242, 20, 23);
                C0679Jb c0679JbA013 = C0679Jb.A01(AdErrorType.UNKNOWN_ERROR, strA072);
                this.A0B.A0E().A4t(c0679JbA013.A03().getErrorCode(), strA072);
                AbstractC02380q abstractC02380q3 = this.A06;
                if (abstractC02380q3 != null) {
                    abstractC02380q3.A0G(c0679JbA013);
                }
                return false;
            }
            return true;
        ...
        C0679Jb c0679JbA014 = C0679Jb.A01(AdErrorType.UNKNOWN_ERROR, strA073);
        this.A0B.A0E().A4t(c0679JbA014.A03().getErrorCode(), strA073);
        AbstractC02380q abstractC02380q4 = this.A06;
        if (abstractC02380q4 != null) {
            abstractC02380q4.A0G(c0679JbA014);
        }
        return false;
    }
    ...
    public C1F A0G() {
        return ((AbstractC1180b9) this.A01).A0H();
    }
    ...
    public final void A0I() {
        String strA6T;
        this.A0B.A0E().A2q(C0731Lf.A01(this.A03));
        InterfaceC02370p interfaceC02370p = this.A01;
        if (interfaceC02370p == null || (strA6T = interfaceC02370p.A6T()) == null) {
            return;
        }
        HashMap map = new HashMap();
        String strA04 = C0731Lf.A04(this.A03);
    ...
    public final void A0J() {
        ...
        if (interfaceC02370p == null) {
            ...
            if (abstractC02380q != null) {
                ...
                abstractC02380q.A0G(C0679Jb.A01(adErrorType, errorMessage));
            }
            this.A0B.A0E().A4w();
            return;
        }
        if (this.A0C) {
            ...
            if (abstractC02380q2 != null) {
                ...
                abstractC02380q2.A0G(C0679Jb.A01(adErrorType2, errorMessage2));
            }
            this.A0B.A0E().A4v();
            return;
        }
    ...
    public final void A0L() {
        if (this.A02 != null) {
            C02440w.A01(this.A0B).A0N(this.A02);
        }
    }

    public final void A0N(InterfaceC02370p interfaceC02370p) {
        if (interfaceC02370p != null) {
            interfaceC02370p.onDestroy();
        }
    }

    public final void A0P(AbstractC02380q abstractC02380q) {
        this.A06 = abstractC02380q;
    }

    public final void A0Q(C02691v c02691v) {
        A0S(c02691v.A03().optString(A07(210, 2, 39)));
    }
    ...
    public final synchronized void ABR(C0679Jb c0679Jb) {
        A0F().post(new C1158an(this, c0679Jb));
    }

    @Override // com.meta.analytics.dsp.uinode.K3
    public final synchronized void ADG(C0975Up c0975Up) {
        try {
            A09(c0975Up);
        } catch (Exception e5) {
            this.A0B.A07().A9a(A07(195, 3, 93), C8A.A0T, new C8B(e5));
        }
    }
}
