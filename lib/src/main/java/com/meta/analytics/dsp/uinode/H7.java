...
public final class H7<T extends H8> extends Handler implements Runnable {
    ...
    public final /* synthetic */ C1001Vq A09;
    ...
    public final void handleMessage(Message message) throws Throwable {
        ...
        long j10 = jElapsedRealtime - this.A04;
        if (this.A07) {
            this.A01.ABz(this.A05, jElapsedRealtime, j10, false);
            return;
        }
        switch (message.what) {
            case 1:
            ...
            case 2:
                try {
                    this.A01.AC1(this.A05, jElapsedRealtime, j10);
                    return;
                } catch (RuntimeException e5) {
                    Log.e(A01(6, 8, 85), A01(77, 44, 8), e5);
                    this.A09.A01 = new HC(e5);
                    return;
                }
            case 3:
                IOException iOException = (IOException) message.obj;
                this.A02 = iOException;
                int iAC2 = this.A01.AC2(this.A05, jElapsedRealtime, j10, iOException);
                if (iAC2 == 3) {
    ...
    public H7(C1001Vq c1001Vq, Looper looper, T loadable, H6<T> h62, int i10, long j10) {
        super(looper);
        this.A09 = c1001Vq;
        this.A05 = loadable;
        this.A01 = h62;
    ...
    public final void A06(long j10) {
        AbstractC0629Ha.A04(this.A09.A00 == null);
        this.A09.A00 = this;
        if (j10 > 0) {
                ...
                try {
                    try {
                        try {
                            ...
                            Log.e(strA01, A01(46, 31, 117), e5);
                            if (!this.A08) {
                                obtainMessage(4, e5).sendToTarget();
                            }
                            throw e5;
                        } catch (InterruptedException unused) {
                            AbstractC0629Ha.A04(this.A07);
                            if (!this.A08) {
                                sendEmptyMessage(2);
                            }
                        }
                    } catch (Exception e10) {
                        Log.e(strA01, A01(121, 35, 10), e10);
                        if (!this.A08) {
                            obtainMessage(3, new HC(e10)).sendToTarget();
                        }
                    }
                } catch (OutOfMemoryError e11) {
                    Log.e(strA01, A01(14, 32, 72), e11);
                    if (!this.A08) {
                        obtainMessage(3, new HC(e11)).sendToTarget();
                    }
                }
