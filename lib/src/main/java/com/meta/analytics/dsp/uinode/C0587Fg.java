...
public final class C0587Fg extends AbstractC1206bZ {
    ...
    private final List<Intent> A06() {
        List<C02350m> listA05 = A05();
        ArrayList arrayList = new ArrayList();
        if (listA05 != null) {
            Iterator<C02350m> it = listA05.iterator();
            while (it.hasNext()) {
    ...
    static {
        A07();
        A06 = C0587Fg.class.getSimpleName();
    }

    public C0587Fg(C1073Yn c1073Yn, J2 j22, String str, Uri uri, Map<String, String> extraData, C02360o c02360o, boolean z10, C1U c1u) {
    ...
    */
    private android.content.Intent A00(com.meta.analytics.dsp.uinode.C02350m r10) {
        /*
            Method dump skipped, instructions count: 286
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0587Fg.A00(com.facebook.ads.redexgen.X.0m):android.content.Intent");
    }

    private Intent A01(C02350m c02350m) {
        Intent intent = new Intent(A04(88, 26, 38));
        intent.addFlags(268435456);
        if (!TextUtils.isEmpty(c02350m.A05()) && !TextUtils.isEmpty(c02350m.A04())) {
            intent.setComponent(new ComponentName(c02350m.A05(), c02350m.A04()));
        }
        if (!TextUtils.isEmpty(c02350m.A03())) {
            intent.setData(AbstractC0724Ky.A00(c02350m.A03()));
        }
        return intent;
    }
    ...
    private final Uri A02() {
        ...
        return AbstractC0724Ky.A00(String.format(locale, storeUrl2, objArr));
    }

    private EnumC02290g A03() throws C0709Kh {
        C0721Kv c0721Kv = new C0721Kv();
        try {
            return C0721Kv.A05(c0721Kv, ((AbstractC02300h) this).A00, A02(), ((AbstractC02300h) this).A02, this.A03);
            ...
            if (queryParameter != null && queryParameter.length() > 0) {
                C0721Kv.A0D(c0721Kv, ((AbstractC02300h) this).A00, AbstractC0724Ky.A00(queryParameter), ((AbstractC02300h) this).A02);
            }
            return EnumC02290g.A08;
        }
    }

    private List<C02350m> A05() {
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null) {
                for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
                    C02350m c02350mA00 = C02350m.A00(jSONArrayOptJSONArray.optJSONObject(i10));
                    if (c02350mA00 != null) {
                        arrayList.add(c02350mA00);
                    }
                }
            }
        } catch (JSONException e5) {
            AnonymousClass89 anonymousClass89A07 = ((AbstractC02300h) this).A00.A07();
            int i11 = C8A.A24;
            C8B c8b = new C8B(e5);
            String appsiteDataString3 = A04(204, 7, 47);
            anonymousClass89A07.A9a(appsiteDataString3, i11, c8b);
            String str = A06;
            String appsiteDataString4 = A04(0, 26, 10);
            Log.w(str, appsiteDataString4, e5);
        }
        return arrayList;
    }
    ...
    private boolean A08() {
        ...
        while (it.hasNext()) {
            if (C0711Kj.A0C(((AbstractC02300h) this).A00, it.next())) {
                return true;
            }
        }
        return false;
    ...
    public static boolean A09(C1073Yn c1073Yn, String str) {
        if (Build.VERSION.SDK_INT >= 30 && str != null) {
            boolean zA1g = C0662Ih.A1g(c1073Yn);
            if (A05[3].length() == 13) {
                throw new RuntimeException();
            }
            String[] strArr = A05;
    ...
    public final EnumC02290g A0D() {
        ...
        if (!AbstractC0740Lo.A0e(((AbstractC02300h) this).A00, enumC02290gA0G, this.A03)) {
            A0E(this.A03, enumC02290gA0G);
            C1U.A06(this.A02, ((AbstractC02300h) this).A00);
        } else {
            EnumC02290g enumC02290g = EnumC02290g.A07;
            ...
            strArr[7] = "cFM2nXNzq";
            strArr[1] = "5qRqyCpR9";
            if (enumC02290gA0G != enumC02290g && (og = this.A00) != null) {
                og.A0B(A04(264, 25, 51), this.A02, ((AbstractC02300h) this).A02);
            }
        }
    ...
    public final EnumC02290g A0G() {
        EnumC02290g enumC02290gA03 = EnumC02290g.A08;
