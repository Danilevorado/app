...
public final class XU implements InterfaceC0511Bs {
    ...
    public static final InterfaceC0514Bv A0G;
    ...
    public long A02;
    public long A03;
    public InterfaceC0513Bu A04;
    public C4 A05;
    public XV A06;
    public Metadata A07;
    public final int A08;
    public final long A09;
    public final C0515Bw A0A;
    public final Bx A0B;
    public final By A0C;
    public final C0654Hz A0D;
    ...
    public XU(int i10, long j10) {
        this.A08 = i10;
        this.A09 = j10;
        this.A0D = new C0654Hz(10);
        this.A0C = new By();
        this.A0A = new C0515Bw();
        this.A02 = -9223372036854775807L;
        this.A0B = new Bx();
    }

    private int A00(InterfaceC0512Bt interfaceC0512Bt) throws InterruptedException, IOException {
        if (this.A00 == 0) {
            interfaceC0512Bt.AFM();
            if (!interfaceC0512Bt.ADw(this.A0D.A00, 0, 4, true)) {
                return -1;
            }
            this.A0D.A0Y(0);
        ...
        int iAFQ = this.A05.AFQ(interfaceC0512Bt, this.A00, true);
        if (iAFQ == -1) {
            return -1;
        }
    ...
    */
    public static int A01(com.meta.analytics.dsp.uinode.C0654Hz r4, int r5) {
        /*
            int r1 = r4.A07()
            int r0 = r5 + 4
            if (r1 < r0) goto L3e
    ...
    private EE A02(InterfaceC0512Bt interfaceC0512Bt) throws InterruptedException, IOException {
        interfaceC0512Bt.ADv(this.A0D.A00, 0, 4);
        this.A0D.A0Y(0);
        By.A04(this.A0D.A08(), this.A0C);
        return new EE(interfaceC0512Bt.A7I(), interfaceC0512Bt.A7i(), this.A0C);
    }

    private XV A03(InterfaceC0512Bt interfaceC0512Bt) throws InterruptedException, IOException {
        C0654Hz c0654Hz = new C0654Hz(this.A0C.A02);
        interfaceC0512Bt.ADv(c0654Hz.A00, 0, this.A0C.A02);
        int i10 = 21;
        if ((this.A0C.A05 & 1) != 0) {
        ...
        int xingBase = A01(c0654Hz, i10);
        if (xingBase == A0J || xingBase == A0H) {
            E4 e4A01 = E4.A01(interfaceC0512Bt.A7I(), interfaceC0512Bt.A7i(), this.A0C, c0654Hz);
            if (e4A01 != null && !this.A0A.A03()) {
                interfaceC0512Bt.AFM();
                interfaceC0512Bt.A3W(i10 + 141);
                C0654Hz frame = this.A0D;
                interfaceC0512Bt.ADv(frame.A00, 0, 3);
                C0654Hz frame2 = this.A0D;
                frame2.A0Y(0);
                C0515Bw c0515Bw = this.A0A;
                C0654Hz frame3 = this.A0D;
                c0515Bw.A04(frame3.A0G());
            }
            interfaceC0512Bt.AGP(this.A0C.A02);
        ...
        if (xingBase == A0I) {
            EC ecA00 = EC.A00(interfaceC0512Bt.A7I(), interfaceC0512Bt.A7i(), this.A0C, c0654Hz);
            interfaceC0512Bt.AGP(this.A0C.A02);
            return ecA00;
        }
        interfaceC0512Bt.AFM();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A07(com.meta.analytics.dsp.uinode.InterfaceC0512Bt r14, boolean r15) throws java.lang.InterruptedException, java.io.IOException {
        /*
    ...
    public final void A8o(InterfaceC0513Bu interfaceC0513Bu) {
        this.A04 = interfaceC0513Bu;
        this.A05 = interfaceC0513Bu.AGi(0, 1);
        this.A04.A5Y();
    }
    ...
    public final int AEH(InterfaceC0512Bt interfaceC0512Bt, C0516Bz c0516Bz) throws InterruptedException, IOException {
        if (this.A01 == 0) {
            try {
                A07(interfaceC0512Bt, false);
            } catch (EOFException unused) {
                return -1;
            }
        }
        if (this.A06 == null) {
            XV xvA03 = A03(interfaceC0512Bt);
            this.A06 = xvA03;
            if (xvA03 == null || (!xvA03.A9I() && (this.A08 & 1) != 0)) {
                this.A06 = A02(interfaceC0512Bt);
            }
    ...
    public final boolean AGR(InterfaceC0512Bt interfaceC0512Bt) throws InterruptedException, IOException {
        return A07(interfaceC0512Bt, true);
    }
}
