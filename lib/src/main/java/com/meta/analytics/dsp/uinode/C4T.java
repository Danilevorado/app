...
public class C4T {
    ...
    private final View A01(View view) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            C03404p c03404p = (C03404p) view3.getLayoutParams();
            if (view3 != view && !c03404p.A02()) {
                int iA00 = c03404p.A00();
                int size2 = this.A01;
                int i12 = iA00 - size2;
                int size3 = this.A03;
                int i13 = i12 * size3;
    ...
    private final void A02(View view) {
        ...
        if (closest == null) {
            ...
            this.A01 = ((C03404p) closest.getLayoutParams()).A00();
        }
    }

    public final View A03(C03464w c03464w) {
        if (this.A08 != null) {
            return A00();
        }
        View viewA0G = c03464w.A0G(this.A01);
        this.A01 += this.A03;
        return viewA0G;
    }
