...
public final class C1233c1 {
    ...
    public /* synthetic */ C1233c1(AbstractC1228bv abstractC1228bv) {
        this();
    }
    ...
    */
    public final int A02(java.util.Collection<?> r7) {
        /*
            ...
            com.meta.analytics.dsp.uinode.C1227bu.A07(r7, r0)
            r3 = 1
            java.util.Iterator r5 = r7.iterator()
        L11:
            boolean r4 = r5.hasNext()
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C1233c1.A01
            r0 = 3
            r1 = r2[r0]
            r0 = 2
            r0 = r2[r0]
        ...
        L67:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1233c1.A02(java.util.Collection):int");
    }
    ...
    public final void A05(int i10, int i11, int i12) {
        ...
        if (i10 >= 0 && i11 <= i12) {
            if (i10 <= i11) {
                ...
                throw new IllegalArgumentException(strA00 + i10 + A00(0, 12, 49) + i11);
            }
        }
        throw new IndexOutOfBoundsException(strA00 + i10 + A00(20, 11, 22) + i11 + A00(12, 8, 29) + i12);
    }

    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C1227bu.A07(collection, A00(31, 1, 116));
        C1227bu.A07(collection2, A00(50, 5, 112));
        ...
        while (it2.hasNext()) {
            if (!C1227bu.A0A(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
