...
public final class C1193bM implements InterfaceC02370p, InterfaceC02551h {
    ...
    private int A00() {
        ...
        EnumC0790Nm enumC0790NmA02 = A02();
        if (enumC0790NmA02 == EnumC0790Nm.A06) {
            return -1;
        }
        if (enumC0790NmA02 == EnumC0790Nm.A04) {
            switch (rotation) {
                case 2:
                case 3:
                    return 8;
    ...
    private void A06(Intent intent) {
        ...
        c02561i.A0I(intent, rewardData, Q7.A03(rewardData, this.A0A, this.A06));
    }

    private final void A07(C1073Yn c1073Yn, AnonymousClass10 anonymousClass10, C02691v c02691v, EnumSet<CacheFlag> enumSet, String str) {
        C02561i c02561i = new C02561i(c1073Yn, c02691v, this, str);
        C1F c1fA0D = c02561i.A0D();
        if (C0662Ih.A0q(c1073Yn)) {
            boolean z10 = c1fA0D instanceof AbstractC1176b5;
            String[] strArr = A0C;
            if (strArr[3].charAt(11) == strArr[7].charAt(11)) {
                A0C[2] = "TkuXboGIr4gI6uBXxoSPLVsF8oObr4N9";
                if (z10 && AbstractC02340l.A06(this.A05, AbstractC02340l.A01(c1073Yn, c02691v.A03(), ((AbstractC1176b5) c1fA0D).A12()), c1073Yn.A09())) {
                    this.A05.A0E().A4K();
        ...
        this.A04 = c02561i;
        A08(c02561i.A0E());
        c02561i.A0J(c1073Yn, enumSet);
    }

    private void A08(KB kb2) {
        if (kb2.equals(KB.A04)) {
            this.A05.A0E().AGG(EnumC02270e.A04);
            return;
        }
        if (kb2.equals(KB.A0A)) {
            this.A05.A0E().AGG(EnumC02270e.A03);
            return;
        }
        if (kb2.equals(KB.A0B)) {
            this.A05.A0E().AGG(EnumC02270e.A0A);
            return;
        }
        if (kb2.equals(KB.A0D)) {
            this.A05.A0E().AGG(EnumC02270e.A0C);
            return;
        }
        if (kb2.equals(KB.A0C)) {
            this.A05.A0E().AGG(EnumC02270e.A0B);
            return;
        }
        boolean zEquals = kb2.equals(KB.A06);
        String[] strArr = A0C;
        ...
        if (this.A04.A0K()) {
            this.A05.A0E().AGG(EnumC02270e.A07);
        } else if ((A09() instanceof AbstractC1176b5) && this.A04.A0L((AbstractC1176b5) A09())) {
            this.A05.A0E().AGG(EnumC02270e.A09);
        } else {
            this.A05.A0E().AGG(EnumC02270e.A08);
        }
    }
    ...
    public final void A0A(C1073Yn c1073Yn, AnonymousClass10 anonymousClass10, C02691v c02691v, EnumSet<CacheFlag> enumSet, String str, String str2, RewardData rewardData) {
        this.A05 = c1073Yn;
        this.A02 = anonymousClass10;
        String strA02 = c02691v.A02();
        this.A08 = strA02;
        this.A06 = strA02 != null ? strA02.split(A03(107, 1, 19))[0] : A03(0, 0, 5);
        this.A00 = c02691v.A00();
        this.A07 = str2;
        this.A01 = rewardData;
        A07(c1073Yn, anonymousClass10, c02691v, enumSet, str);
    }
    ...
    public final boolean A0B() {
        ...
        AdActivityIntent adActivityIntentA04 = C0711Kj.A04(this.A05);
        adActivityIntentA04.putExtra(A03(143, 24, 76), A00());
        adActivityIntentA04.putExtra(A03(178, 8, 15), this.A0A);
        adActivityIntentA04.putExtra(A03(132, 11, 116), this.A08);
        adActivityIntentA04.putExtra(A03(167, 11, 124), this.A00);
        KB kbA01 = A01();
        A08(kbA01);
        adActivityIntentA04.putExtra(A03(186, 8, 96), kbA01);
        String str = this.A07;
        if (str != null) {
        ...
        try {
            ...
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!C0711Kj.A0J(this.A05, adActivityIntentA04)) {
                    this.A05.A0E().AF0();
            ...
            C0711Kj.A0A(this.A05, adActivityIntentA04);
            return true;
        } catch (C0709Kh e5) {
