...
public final class C0675Iw implements AudienceNetworkRemoteServiceApi {
    public Messenger A00;
    public final Service A01;

    public C0675Iw(Service service) {
        this.A01 = service;
    }
    ...
    public final void onCreate() {
        ...
        this.A00 = new Messenger(new HandlerC0676Ix(this.A01.getApplicationContext()));
    }
