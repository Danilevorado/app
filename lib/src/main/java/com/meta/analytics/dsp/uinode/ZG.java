...
public class ZG extends C03505a implements NativeAdLayoutApi {
    public View A02;
    ...
    public final void A03(AbstractC0766Mo abstractC0766Mo) {
        this.A02 = abstractC0766Mo;
        abstractC0766Mo.setLayoutParams(new ViewGroup.LayoutParams(-1, -1));
        AbstractC0740Lo.A0T(this.A03);
