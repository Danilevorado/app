...
public final class JD {
     ...
     */
    public static void A06(C04017f c04017f, RK rk, Map<String, ?> map) throws JSONException {
        ...
        A09(c04017f, map3);
        C04198c c04198cA08 = c04017f.A08();
        JSONObject jSONObjectA05 = C8C.A05(new C8E(c04198cA08.A01(), c04198cA08.A02(), map3));
        ...
        rk.AE0(c04017f.A04().A73(), ry.A08(), new VN(c04017f));
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 2 out of bounds for length 2
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static void A09(C04017f c04017f, Map<String, String> map) {
        map.putAll(c04017f.A03().A4n());
    }
    ...
    public static void A05(C04017f c04017f) {
        if (A0B(c04017f)) {
            return;
        }
        synchronized (JD.class) {
            ...
            atomicInteger.set(1);
            ExecutorC0745Lt.A06.execute(new VO(c04017f));
        }
    }

    public static void A08(C04017f c04017f, String str) {
        int i10;
        int iIntValue;
        if (A0B(c04017f)) {
            return;
        ...
        synchronized (JD.class) {
            if (A04.get() != 2) {
                ...
                SharedPreferences sharedPreferences = c04017f.getApplicationContext().getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(116, 31, 104), c04017f), 0);
    ...
    public static boolean A0B(C04017f c04017f) {
        ...
        return A0A(c04017f.A08().A00(), Ij.A0C(c04017f));
    }
}
