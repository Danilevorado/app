...
public final class RunnableC0639Hk implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public RunnableC0639Hk(Handler handler) {
        this.A04 = handler;
    }
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C0637Hi(IF.A0P(A04(0, 67, 61), Boolean.valueOf(zEglChooseConfig), Integer.valueOf(iArr[0]), eGLConfigArr[0]));
    }
    ...
    public static void A06(int[] iArr) {
        ...
        if (iGlGetError == 0) {
            ...
            throw new C0637Hi(A04(181, 29, 20) + Integer.toHexString(iGlGetError));
        }
    }

    public final SurfaceTexture A07() {
        return (SurfaceTexture) AbstractC0629Ha.A01(this.A00);
    }
    ...
    public final void A09(int i10) {
        ...
        EGLContext eGLContextA01 = A01(this.A02, eGLConfigA00, i10);
        this.A01 = eGLContextA01;
        this.A03 = A03(this.A02, eGLConfigA00, eGLContextA01, i10);
        A06(this.A05);
