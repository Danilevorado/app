...
public abstract class C2A {
    ...
    public static void A02(C1072Ym c1072Ym, Message message) {
        Bundle bundle = message.getData().getBundle(A00(0, 17, 52));
        if (bundle != null) {
            AbstractC04188b.A05(c1072Ym, bundle.getString(A00(35, 23, 34)), bundle.getString(A00(17, 18, 102)));
        }
    }
    ...
    public static boolean A04(C1072Ym c1072Ym, boolean z10, ServiceConnection serviceConnection) {
        boolean validationPassed = (c1072Ym.A04().A8z() && z10) || A03(c1072Ym, AbstractC0664Ik.A04(z10));
        if (!validationPassed) {
            return false;
        }
        boolean validationPassed2 = c1072Ym.bindService(new Intent().setComponent(new ComponentName(AbstractC0664Ik.A04(z10), A00(58, 58, 15))), serviceConnection, 1);
