...
public final class C2C extends Handler {
    ...
    public final void A0A(boolean z10) {
        boolean zA04 = C2A.A04(this.A05, z10, this.A02);
        this.A01 = zA04;
        if (zA04) {
            this.A03.postDelayed(this.A06, AbstractC0664Ik.A01(this.A05));
        } else {
            AbstractC04188b.A04(this.A05);
        }
    }
