...
public final class NJ extends LinearLayout {
    ...
    public static String A06(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            byte b10 = (byte) ((bArrCopyOfRange[i13] ^ i12) ^ 39);
            String[] strArr = A0F;
    ...
    static {
        ...
        A0I = AbstractC0724Ky.A00(A06(90, 23, 31));
        A0J = new ND();
        A0H = Color.argb(34, 0, 0, 0);
    }

    public NJ(C1073Yn c1073Yn, WebView webView) {
        this(c1073Yn, webView, false);
    }

    public NJ(C1073Yn c1073Yn, WebView webView, boolean z10) {
        super(c1073Yn);
        this.A09 = getResources().getDisplayMetrics().density;
        this.A0C = new U3(this);
        this.A0A = webView;
        this.A0B = c1073Yn;
        this.A08 = AbstractC0663Ii.A06(c1073Yn);
        this.A0D = z10;
        A08();
    }
    ...
    private void A08() {
        ...
        this.A01.setImageBitmap(AbstractC0749Lx.A01(EnumC0748Lw.BROWSER_CLOSE));
        ImageView imageView2 = this.A01;
        View.OnTouchListener onTouchListener = A0J;
        imageView2.setOnTouchListener(onTouchListener);
        this.A01.setOnClickListener(new NE(this));
        addView(this.A01, layoutParams);
        if (this.A08 && !C0662Ih.A2N(this.A0B)) {
        ...
        if (C0662Ih.A2N(this.A0B) && !this.A0D) {
            LinearLayout linearLayout = new LinearLayout(this.A0B);
            this.A04 = linearLayout;
            linearLayout.setOrientation(1);
            LinearLayout linearLayout2 = this.A04;
            float f5 = this.A09;
            int buttonSizePx2 = (int) (f5 * 2.0f);
            linearLayout2.setPadding(0, (int) (f5 * 2.0f), 0, buttonSizePx2);
            layoutParams2.setMarginStart(0);
            addView(this.A04, layoutParams2);
            ImageView imageView4 = new ImageView(this.A0B);
            imageView4.setScaleType(ImageView.ScaleType.CENTER);
            imageView4.setImageBitmap(AbstractC0749Lx.A01(EnumC0748Lw.HANDLER));
            float f10 = this.A09;
            int buttonSizePx3 = (int) (f10 * 4.0f);
            imageView4.setPadding(0, (int) (f10 * 4.0f), 0, buttonSizePx3);
        ...
        if (this.A08 && !C0662Ih.A2N(this.A0B)) {
            ...
            this.A02.setImageBitmap(AbstractC0749Lx.A02(EnumC0748Lw.BACK_ARROW));
    ...
    */
    private void A09() {
        /*
            ...
            android.net.Uri r0 = com.meta.analytics.dsp.uinode.NJ.A0I
        ...
        L2e:
            com.facebook.ads.redexgen.X.Yn r0 = r6.A0B
            boolean r0 = com.meta.analytics.dsp.uinode.C0662Ih.A2N(r0)
            if (r0 == 0) goto L41
            android.widget.ImageView r0 = r6.A03
            r0.setVisibility(r4)
            com.facebook.ads.redexgen.X.Lw r0 = com.meta.analytics.dsp.uinode.EnumC0748Lw.BROWSER_LAUNCH_NATIVE
            android.graphics.Bitmap r5 = com.meta.analytics.dsp.uinode.AbstractC0749Lx.A01(r0)
        L41:
            android.widget.ImageView r3 = r6.A03
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.NJ.A0F
            r0 = 6
            r1 = r2[r0]
            r0 = 0
            r0 = r2[r0]
        ...
        L5b:
            ...
            if (r0 == 0) goto L8d
            com.facebook.ads.redexgen.X.Lw r0 = com.meta.analytics.dsp.uinode.EnumC0748Lw.BROWSER_LAUNCH_CHROME
            android.graphics.Bitmap r5 = com.meta.analytics.dsp.uinode.AbstractC0749Lx.A01(r0)
            goto L2e
        L8d:
            com.facebook.ads.redexgen.X.Lw r0 = com.meta.analytics.dsp.uinode.EnumC0748Lw.BROWSER_LAUNCH_NATIVE
        ...
        L94:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.NJ.A09():void");
    }
