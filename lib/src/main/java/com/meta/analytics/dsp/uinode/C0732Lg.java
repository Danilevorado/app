...
public final class C0732Lg {
    ...
    static {
        A02();
        A0K = C0732Lg.class.getSimpleName();
    }
    ...
    */
    public final java.util.Map<java.lang.String, java.lang.String> A04() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0732Lg.A04():java.util.Map");
    }
    ...
    public final void A06(C1073Yn c1073Yn, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c1073Yn.A0E().AGu();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            ...
            case 2:
                float f5 = this.A00;
                float f10 = f5 - (f5 / this.A09);
                this.A00 = f10;
                float pressure = motionEvent.getPressure();
                int i10 = this.A09;
                this.A00 = f10 + (pressure / i10);
                float f11 = this.A02;
                float f12 = f11 - (f11 / i10);
                this.A02 = f12;
    ...
    public final boolean A09(Context context) {
        ...
        if (BuildConfigApi.isDebug()) {
            String str = A01(108, 21, 116) + z10 + A01(2, 18, 43) + iA06 + A01(0, 2, 119) + jA03;
        }
        return z10;
    }
}
