...
public final class Q1 {
    ...
    public Q1(C04017f c04017f, Q0 q02, J2 j22, Map<String, String> metricsData, String str) {
        this.A02 = c04017f;
        this.A05 = q02;
        this.A03 = j22;
        ...
        this.A08 = C0662Ih.A1m(q02.getContext());
    }
    ...
    private void A06(String str, float f5, float f10) {
        HashMap map = new HashMap();
        map.put(A00(12, 11, 21), str);
        map.put(A00(93, 1, 87), String.valueOf(f5));
        map.put(A00(94, 1, 63), String.valueOf(f10));
        HashMap map2 = new HashMap();
    ...
    @JavascriptInterface
    public void logButtonClick(String str, float f5, float f10) {
        if (!this.A08) {
            return;
        }
        A06(str, f5, f10);
