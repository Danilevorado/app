...
public final class X0 implements InterfaceC0537Cy {
    ...
    public final C0654Hz A0C = new C0654Hz();
    ...
    public static Format A00(String str, D4 d42, D4 d43, D4 d44) {
        ...
        if (i02.A0A() && i02.A0A()) {
            ...
            if (picWidthInLumaSamples == 255) {
                int iA05 = i02.A05(16);
                int iA052 = i02.A05(16);
                if (iA05 != 0 && iA052 != 0) {
                    f5 = iA05 / iA052;
                }
            } else {
                float[] fArr = AbstractC0650Hv.A04;
                String[] strArr2 = A0F;
                ...
                if (picWidthInLumaSamples < fArr.length) {
                    f5 = AbstractC0650Hv.A04[picWidthInLumaSamples];
                } else {
        ...
        if (A0F[3].length() != 6) {
            ...
            return Format.A03(str, strA01, null, -1, -1, picHeightInLumaSamples, confWinLeftOffset, -1.0f, listSingletonList, -1, f5, null);
        }
        String[] strArr5 = A0F;
    ...
    private void A03(long j10, int i10, int i11, long j11) {
        ...
        if (this.A07.A04(i11)) {
            ...
            A0F[3] = "Yba7mj";
            this.A0C.A0b(this.A07.A01, AbstractC0650Hv.A02(d42.A01, this.A07.A00));
            this.A0C.A0Z(5);
            this.A0B.A02(j11, this.A0C);
        }
        if (this.A09.A04(i11)) {
            this.A0C.A0b(this.A09.A01, AbstractC0650Hv.A02(this.A09.A01, this.A09.A00));
            this.A0C.A0Z(5);
            this.A0B.A02(j11, this.A0C);
        }
    }
    ...
    public final void A4R(C0654Hz c0654Hz) {
        while (true) {
            ...
            if (iA04 > 0) {
                ...
                long j10 = this.A01;
                int offset = c0654Hz.A04();
                this.A01 = j10 + offset;
                C4 c42 = this.A02;
                int offset2 = c0654Hz.A04();
                c42.AFR(c0654Hz, offset2);
                while (limit < iA07) {
                    int iA042 = AbstractC0650Hv.A04(bArr, limit, iA07, this.A0D);
                    if (iA042 == iA07) {
                        A07(bArr, limit, iA07);
                        return;
                    }
                    int bytesWrittenPastPosition = AbstractC0650Hv.A00(bArr, iA042);
                    int i10 = iA042 - limit;
                    if (i10 > 0) {
    ...
    public final void A4p(InterfaceC0513Bu interfaceC0513Bu, DC dc2) {
        ...
        this.A0B.A03(interfaceC0513Bu, dc2);
    }
