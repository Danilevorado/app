...
public final class C03735x implements RewardedVideoAdApi, Repairable {
    ...
    public C03735x(Context context, String str, Ad ad) {
        this.A00 = ad;
        String string = UUID.randomUUID().toString();
        C1073Yn c1073YnA07 = C03525c.A07(context, string);
        this.A03 = c1073YnA07;
        C0S c0sA0E = c1073YnA07.A0E();
        String adId = AdPlacementType.REWARDED_VIDEO.toString();
        c0sA0E.A2s(adId, str);
        C2F c2f = new C2F(c1073YnA07, str, ad, new C1144aZ());
        this.A01 = c2f;
        c1073YnA07.A0L(this);
    ...
    public final C03745y buildLoadAdConfig() {
        return new C03745y(this);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi, com.facebook.ads.FullScreenAd
    /* renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final C03755z buildShowAdConfig() {
        return new C03755z();
    }

    public final void A04() {
        if (C0662Ih.A1s(this.A03)) {
            return;
        }
        this.A02.A08();
        this.A03.A0E().A2t();
    ...
    public final void destroy() {
        AbstractC0692Jp.A05(A00(136, 7, 66), A00(48, 27, 119), A00(16, 8, 74));
        A04();
    }
    ...
    public final void loadAd() {
        AbstractC0692Jp.A05(A00(143, 6, 60), A00(75, 32, 89), A00(24, 8, 17));
        A07(null, null, true);
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final void loadAd(RewardedVideoAd.RewardedVideoLoadAdConfig rewardedVideoLoadAdConfig) {
        ((C03745y) rewardedVideoLoadAdConfig).A00();
    }
    ...
    public final boolean show() {
        AbstractC0692Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(0, 8, 62));
        return A08(new C03755z().withAppOrientation(-1).build());
    }

    @Override // com.facebook.ads.internal.api.RewardedVideoAdApi
    public final boolean show(RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        AbstractC0692Jp.A05(A00(149, 4, 94), A00(107, 29, 107), A00(8, 8, 108));
