...
public class C0627Gx<E> implements Iterator<E> {
    public static byte[] A02;
    public int A00;
    public final /* synthetic */ AbstractC03916u<E> A01;
    ...
    public C0627Gx(AbstractC03916u abstractC03916u) {
        this.A01 = abstractC03916u;
    }
    ...
    public final E next() {
        if (hasNext()) {
            AbstractC03916u<E> abstractC03916u = this.A01;
            int i10 = this.A00;
            this.A00 = i10 + 1;
            return abstractC03916u.get(i10);
        }
