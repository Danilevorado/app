...
public final class TextureViewSurfaceTextureListenerC0698Jv extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC0875Qt, R9, InterfaceC0877Qv {
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C0662Ih.A1X(this.A0A) && this.A0D != RB.A08) {
            if (!this.A0L) {
                this.A0L = true;
                this.A0A.A0E().AFY();
            }
    ...
    static {
        A07();
        A0Q = TextureViewSurfaceTextureListenerC0698Jv.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC0698Jv(C1073Yn c1073Yn) {
        super(c1073Yn);
        this.A0D = RB.A04;
        this.A0E = RB.A04;
        this.A0M = false;
    ...
    public TextureViewSurfaceTextureListenerC0698Jv(C1073Yn c1073Yn, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC0698Jv(C1073Yn c1073Yn, AttributeSet attributeSet, int i10) {
    ...
    */
    private void A04() {
        /*
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC0698Jv.A0P
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            ...
            throw r0
        L38:
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC0698Jv.A0P
        ...
        L8d:
            ...
            r2.A0F(r1, r0)
        L9a:
            com.facebook.ads.redexgen.X.RB r0 = com.meta.analytics.dsp.uinode.RB.A08
            r5.setVideoState(r0)
        ...
        Lbc:
            ...
            goto L65
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.TextureViewSurfaceTextureListenerC0698Jv.A04():void");
    }

    private void A05() {
        C0878Qw c0878Qw = this.A0C;
        if (c0878Qw == null) {
            return;
        }
        C0876Qu c0876QuA08 = c0878Qw.A08();
        String[] strArr = A0P;
        ...
        if (c0876QuA08 != null) {
            A08(c0876QuA08.A01, c0876QuA08.A00);
        }
    }
    ...
    public final boolean A8b() {
        C0878Qw c0878Qw = this.A0C;
        return c0878Qw != null && c0878Qw.A0K();
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0875Qt
    ...
    @Override // com.meta.analytics.dsp.uinode.InterfaceC0877Qv
    ...
    @Override // com.meta.analytics.dsp.uinode.R9
    public final void AGS(QM qm, int i10) {
    ...
    public final void onAttachedToWindow() {
        ...
        if (C0662Ih.A2D(getContext()) && !isHardwareAccelerated()) {
            setVideoState(RB.A03);
            AGZ(8);
        }
    }
    ...
    public final void onWindowFocusChanged(boolean z10) {
        ...
        if (!z10) {
            if (this.A0D != RB.A05) {
                if ((this.A0A.A0F().A01() || C0662Ih.A1c(this.A0A)) && Build.VERSION.SDK_INT >= 24) {
