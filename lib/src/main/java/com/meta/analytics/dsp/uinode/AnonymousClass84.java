...
public final class AnonymousClass84 {
    ...
    public static int A00(String str, int i10, C04017f c04017f) {
        if ((A01(465, 7, 107).equals(str) && C8A.A20 == i10) || A01(422, 5, 56).equals(str) || A01(445, 6, 63).equals(str)) {
            return 200;
        }
    ...
    public static void A05(C04017f c04017f, int i10, int i11) {
        c04017f.A07().A9a(A01(435, 10, 113), C8A.A2X, new C8B(A01(338, 33, 80) + i10, A01(87, 9, 13) + i11));
    }

    @Deprecated
    public static void A06(C04017f c04017f, String str, int i10, C8B c8b) {
        if (c04017f == null) {
            A0F(new RuntimeException(A01(48, 39, 84)));
            return;
        }
        AbstractC04007e.A01(c04017f.A01());
        if (A02 && c8b.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 70) + str + A01(31, 16, 8) + i10, c8b));
        }
        try {
            if (A0J(c04017f, str, i10, Math.random(), c8b)) {
                A09(c04017f, str, i10, c8b);
            }
        } catch (Throwable t10) {
            A0F(t10);
        }
    ...
    @Deprecated
    public static void A07(C04017f c04017f, String str, int i10, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A0A(false);
            c8b.A06(1);
    ...
    @Deprecated
    public static void A08(C04017f c04017f, String str, int i10, C8B c8b) {
        try {
            c8b.A05(2);
            c8b.A08(false);
            A06(c04017f, str, i10, c8b);
    ...
    public static void A09(C04017f c04017f, String str, int i10, C8B c8b) {
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                int iA01 = Ij.A01(c04017f);
                AtomicInteger atomicInteger = A09;
                int threshold = atomicInteger.getAndIncrement();
                if (threshold < iA01 - 1) {
                    A07.add(new AnonymousClass85(str, i10, c8b));
                } else if (atomicInteger.get() == iA01) {
                    A07.add(new AnonymousClass85(A01(435, 10, 113), C8A.A2U, new C8B(A01(140, 42, 0) + str + A01(47, 1, 19) + i10)));
                }
            } else {
                A0A(c04017f, str, i10, c8b, true);
            }
        }
    }

    public static void A0A(C04017f c04017f, String str, int i10, C8B c8b, boolean z10) throws Throwable {
        AnonymousClass83 anonymousClass83 = A0B.get();
        boolean z11 = anonymousClass83 != null && anonymousClass83.A9G();
        if (A08.get() || z11) {
            int iA01 = c8b.A01();
            String strA01 = A01(289, 17, 46);
            String strA012 = A01(31, 16, 8);
            if (iA01 == 0) {
                Log.e(strA01, A01(182, 37, 40) + str + strA012 + i10, c8b);
            } else {
                Log.i(strA01, A01(306, 32, 116) + str + strA012 + i10 + A01(19, 12, 63) + c8b.getMessage() + A01(0, 19, 80) + c8b.A03());
            }
        }
        C1064Ye c1064Ye = new C1064Ye(c04017f, str, i10, c8b, anonymousClass83);
        if (z10) {
            A01.execute(c1064Ye);
        } else {
            c1064Ye.run();
    ...
    public static void A0C(C1072Ym c1072Ym, AnonymousClass83 anonymousClass83, AnonymousClass82 anonymousClass82, boolean z10) {
        ...
        synchronized (AnonymousClass84.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1065Yf(c1072Ym));
            }
        }
    }
    ...
    public static boolean A0H(C04017f c04017f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        return (shouldSkipFunnelEventsForSession == null || !shouldSkipFunnelEventsForSession.booleanValue()) && Ij.A0A(c04017f) != 0;
    }

    public static boolean A0I(C04017f c04017f) {
        Boolean shouldSkipFunnelEventsForSession = A0C.get();
        if (shouldSkipFunnelEventsForSession != null && shouldSkipFunnelEventsForSession.booleanValue()) {
            return false;
        }
        double funnelEventLogProbability = 1.0d / Ij.A0A(c04017f);
        return c04017f.A08().A00() <= funnelEventLogProbability;
    }
    ...
    */
    public static boolean A0J(com.meta.analytics.dsp.uinode.C04017f r12, java.lang.String r13, int r14, double r15, com.meta.analytics.dsp.uinode.C8B r17) {
        /*
            Method dump skipped, instructions count: 500
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AnonymousClass84.A0J(com.facebook.ads.redexgen.X.7f, java.lang.String, int, double, com.facebook.ads.redexgen.X.8B):boolean");
    }

    public static boolean A0K(C04017f c04017f, String str, int i10, C8B c8b) {
        if (!Ij.A0P(c04017f)) {
            return true;
        }
        int customLimit = A00.get(i10);
        int eventsLimit = Ij.A00(c04017f);
        if (c8b.A02() != -1) {
            eventsLimit = c8b.A02();
        } else {
            int currentCounter = A00(str, i10, c04017f);
