...
public class IL extends HandlerThread implements Handler.Callback {
    ...
    public final DummySurface A04(int i10) {
        ...
        this.A01 = new RunnableC0639Hk(this.A00);
        boolean z10 = false;
        synchronized (this) {
        ...
        if (runtimeException == null) {
            ...
            if (error == null) {
                return (DummySurface) AbstractC0629Ha.A01(this.A02);
            }
            throw error;
        }
    ...
    */
    public final boolean handleMessage(android.os.Message r7) {
        ...
        L84:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.IL.handleMessage(android.os.Message):boolean");
    }
}
