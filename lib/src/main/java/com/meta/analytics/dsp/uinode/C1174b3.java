...
public final class C1174b3 extends C1F implements Serializable {
    ...
    public int A02;
    public int A03;
    public final List<AbstractC1176b5> A0A;
    ...
    public C1174b3(List<AbstractC1176b5> list) {
        this.A0A = list;
    }

    public static C1174b3 A02(JSONObject jSONObject, C1073Yn c1073Yn) throws JSONException {
        return A03(jSONObject, c1073Yn, false);
    }

    public static C1174b3 A03(JSONObject jSONObject, C1073Yn c1073Yn, boolean z10) throws JSONException {
        JSONArray jSONArray = jSONObject.getJSONArray(A04(0, 3, 35));
        ArrayList arrayList = new ArrayList(jSONArray.length());
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            if (z10) {
                arrayList.add(FU.A02(jSONArray.getJSONObject(i10), c1073Yn));
            } else {
                arrayList.add(FS.A02(jSONArray.getJSONObject(i10), c1073Yn));
            }
        }
        C1174b3 c1174b3 = new C1174b3(arrayList);
        JSONObject chainingParams = jSONObject.getJSONObject(A04(3, 12, 43));
        c1174b3.A04 = chainingParams.toString();
        c1174b3.A01 = chainingParams.optInt(A04(15, 17, 120), arrayList.size());
        c1174b3.A03 = chainingParams.optInt(A04(32, 24, 126), 0);
        c1174b3.A02 = chainingParams.optInt(A04(100, 24, 109), 0);
        c1174b3.A00 = chainingParams.optInt(A04(56, 19, 124), 2);
        c1174b3.A0d(chainingParams);
        c1174b3.A07 = chainingParams.optBoolean(A04(174, 16, 45), false);
        c1174b3.A06 = chainingParams.optBoolean(A04(146, 28, 8), false);
        c1174b3.A05 = chainingParams.optBoolean(A04(124, 22, 9), false);
        JSONArray jSONArrayOptJSONArray = chainingParams.optJSONArray(A04(75, 25, 10));
        if (jSONArrayOptJSONArray != null) {
            for (int i11 = 0; i11 < jSONArrayOptJSONArray.length(); i11++) {
                c1174b3.A09.add(Integer.valueOf(jSONArrayOptJSONArray.optInt(i11, 0)));
            }
        }
        return c1174b3;
    }
    ...
    public final AbstractC1176b5 A0u() {
        if (!this.A0A.isEmpty()) {
            AbstractC1176b5 abstractC1176b5 = this.A0A.get(0);
            ...
            return abstractC1176b5;
        }
        return null;
    }

    public final AbstractC1176b5 A0v(int i10) {
    ...
    public final String A0y() {
        AbstractC1176b5 firstAdDataBundle = A0u();
