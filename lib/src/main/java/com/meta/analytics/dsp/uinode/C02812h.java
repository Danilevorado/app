...
public final class C02812h extends Drawable {
    ...
    public C02812h(ColorStateList colorStateList, float f5) {
        this.A01 = f5;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = C02832j.A01(this.A00, this.A01, this.A07);
            float vInset = C02832j.A00(this.A00, this.A01, this.A07);
    ...
    public final void A06(float f5) {
        if (f5 == this.A01) {
            return;
        }
        this.A01 = f5;
    ...
    public final void A07(float f5, boolean z10, boolean z11) {
        if (f5 == this.A00) {
    ...
    public final boolean onStateChange(int[] iArr) {
        ...
        boolean z10 = colorForState != newColor;
        if (z10) {
