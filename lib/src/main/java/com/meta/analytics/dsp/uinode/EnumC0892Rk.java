...
public enum EnumC0892Rk {
    A09(A00(145, 13, 65), EnumC0894Rm.A02, true),
    A08(A00(128, 17, 7), EnumC0894Rm.A03, true),
    A07(A00(114, 14, 69), EnumC0894Rm.A03, false),
    A0A(A00(171, 23, 11), EnumC0894Rm.A03, false),
    A0B(A00(158, 13, 70), EnumC0894Rm.A03, true),
    A06(A00(97, 17, 110), EnumC0894Rm.A03, false);
    ...
    EnumC0892Rk(String str, EnumC0894Rm enumC0894Rm, boolean z10) {
        this.A01 = str;
        this.A00 = enumC0894Rm;
        this.A02 = z10;
    }

    public final EnumC0894Rm A02() {
        return this.A00;
    }
