...
public final class M6 {
    ...
    public static Map<String, String> A01(C1073Yn c1073Yn) {
        Window window;
        ...
        try {
            map.put(A00(40, 3, 111), String.valueOf(A04(c1073Yn)));
            ...
            Log.e(A02, A00(2, 30, 72), e5);
            AnonymousClass89 anonymousClass89A07 = c1073Yn.A07();
            int type3 = C8A.A2T;
            anonymousClass89A07.A9a(A00(43, 5, 114), type3, new C8B(e5));
        }
        return map;
    }

    public static boolean A03(C1073Yn c1073Yn) {
        return !C0741Lp.A04(A01(c1073Yn));
    }

    public static boolean A04(C1073Yn c1073Yn) {
        KeyguardManager keyguardManager = (KeyguardManager) c1073Yn.getSystemService(A00(32, 8, 4));
