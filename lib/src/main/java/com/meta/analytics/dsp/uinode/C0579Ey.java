...
public class C0579Ey extends C1108Zx {
    ...
    @Override // com.meta.analytics.dsp.uinode.C03083i
    public final void A03(ViewParent viewParent, View view) {
        try {
            viewParent.onStopNestedScroll(view);
        } catch (AbstractMethodError e5) {
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(323, 55, 53), e5);
        }
    }
    ...
    public final void A04(ViewParent viewParent, View view, int i10, int i11, int i12, int i13) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(157, 51, 25), e5);
        }
    }
    ...
    public final void A05(ViewParent viewParent, View view, int i10, int i11, int[] iArr) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(103, 54, 31), e5);
        }
    }
    ...
    public final void A06(ViewParent viewParent, View view, View view2, int i10) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(208, 59, 57), e5);
        }
    }

    @Override // com.meta.analytics.dsp.uinode.C03083i
    public final boolean A07(ViewParent viewParent, View view, float f5, float f10) {
        try {
            return viewParent.onNestedPreFling(view, f5, f10);
        } catch (AbstractMethodError e5) {
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(50, 53, 103), e5);
            return false;
        }
    }

    @Override // com.meta.analytics.dsp.uinode.C03083i
    public final boolean A08(ViewParent viewParent, View view, float f5, float f10, boolean z10) {
        try {
            return viewParent.onNestedFling(view, f5, f10, z10);
        } catch (AbstractMethodError e5) {
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(0, 50, 85), e5);
            return false;
        }
    }
    ...
    public final boolean A09(ViewParent viewParent, View view, View view2, int i10) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(267, 56, 75), e5);
            return false;
        }
    }
}
