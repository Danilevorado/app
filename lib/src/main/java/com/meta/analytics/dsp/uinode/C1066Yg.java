...
public final class C1066Yg implements InterfaceC04137w {
    ...
    public C1066Yg(Context context, C7v c7v) {
        this.A00 = context;
        this.A02 = c7v;
    }

    private C04117t A00() {
        return C04117t.A00(KE.A00(this.A00).getString(A01(0, 16, 81), null));
    }

    private void A02() {
        this.A02.AAQ(new C1067Yh(this));
    }

    public final void A04(String[] strArr, Integer num, Integer num2) {
        C04117t c04117t = new C04117t(strArr, num, num2);
        C04117t newSettings = this.A01;
        if (c04117t.equals(newSettings)) {
            return;
        }
        this.A01 = c04117t;
        this.A03.set(true);
        ...
        C04117t newSettings2 = this.A01;
        editorEdit.putString(A01(0, 16, 81), newSettings2.A07()).apply();
    }

    @Override // com.meta.analytics.dsp.uinode.InterfaceC04137w
    public final C04117t A6i() {
        A02();
        return this.A01;
    }
    ...
    public final boolean A9F() {
        ...
        Set<String> setA0W = C0662Ih.A0W(this.A00);
