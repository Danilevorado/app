...
public final class W0 implements InterfaceC0624Gu {
    ...
    public InterfaceC0624Gu A00;
    public InterfaceC0624Gu A01;
    public InterfaceC0624Gu A02;
    public InterfaceC0624Gu A03;
    public InterfaceC0624Gu A04;
    public InterfaceC0624Gu A05;
    public InterfaceC0624Gu A06;
    public final Context A07;
    public final InterfaceC0624Gu A08;
    public final HG<? super InterfaceC0624Gu> A09;
    ...
    public W0(Context context, HG<? super InterfaceC0624Gu> hg, InterfaceC0624Gu interfaceC0624Gu) {
        this.A07 = context.getApplicationContext();
        this.A09 = hg;
        this.A08 = (InterfaceC0624Gu) AbstractC0629Ha.A01(interfaceC0624Gu);
    }

    private InterfaceC0624Gu A00() {
        if (this.A00 == null) {
    ...
    private InterfaceC0624Gu A03() {
        if (this.A04 == null) {
            this.A04 = new C1007Vw(this.A09);
        }
        return this.A04;
    }

    private InterfaceC0624Gu A04() {
        if (this.A05 == null) {
            this.A05 = new C0999Vo(this.A07, this.A09);
        }
        return this.A05;
    }

    private InterfaceC0624Gu A05() throws Exception {
        if (this.A06 == null) {
            try {
                this.A06 = (InterfaceC0624Gu) Class.forName(A06(141, 60, 110)).getConstructor(new Class[0]).newInstance(new Object[0]);
            } catch (ClassNotFoundException unused) {
                Log.w(A06(85, 17, 30), A06(15, 70, 22));
            } catch (Exception e5) {
                throw new RuntimeException(A06(102, 34, 22), e5);
            }
            InterfaceC0624Gu interfaceC0624Gu = this.A06;
            String[] strArr = A0B;
    ...
    public final Uri A8E() {
        InterfaceC0624Gu interfaceC0624Gu = this.A03;
        if (interfaceC0624Gu == null) {
            return null;
        }
        return interfaceC0624Gu.A8E();
    }

    @Override // com.meta.analytics.dsp.uinode.InterfaceC0624Gu
    public final long ADl(C0628Gy c0628Gy) throws IOException {
        AbstractC0629Ha.A04(this.A03 == null);
        String scheme = c0628Gy.A04.getScheme();
        if (IF.A0e(c0628Gy.A04)) {
            String path = c0628Gy.A04.getPath();
            String scheme2 = A06(0, 15, 101);
            if (path.startsWith(scheme2)) {
                InterfaceC0624Gu interfaceC0624GuA00 = A00();
                String[] strArr = A0B;
                String str = strArr[1];
