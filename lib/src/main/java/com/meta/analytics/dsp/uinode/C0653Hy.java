...
public final class C0653Hy {
    ...
    public C0653Hy(byte[] bArr) {
        this(bArr, bArr.length);
    }

    public C0653Hy(byte[] bArr, int i10) {
        this.A00 = bArr;
        this.A02 = i10;
    }
    ...
    private void A00() {
        int i10;
        int i11 = this.A03;
        AbstractC0629Ha.A04(i11 >= 0 && (i11 < (i10 = this.A02) || (i11 == i10 && this.A01 == 0)));
    }
    ...
    public final void A0A(int firstByteInputBits, int i10) {
        ...
        byte b10 = (byte) (bArr[firstByteBitmask] & firstByteReadSize2);
        bArr[firstByteBitmask] = b10;
        int firstByteReadSize3 = b10 | ((firstByteInputBits >>> (i10 - iMin)) << firstByteRightPaddingSize);
        ...
        byte b11 = (byte) (firstByteReadSize5 & ((1 << lastByteRightPaddingSize) - 1));
        bArr2[firstByteBitmask2] = b11;
        int firstByteReadSize6 = b11 | ((firstByteInputBits & ((1 << firstByteRightPaddingSize2) - 1)) << lastByteRightPaddingSize);
