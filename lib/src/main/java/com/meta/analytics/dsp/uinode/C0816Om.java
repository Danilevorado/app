...
public final class C0816Om extends RelativeLayout {
    public final View A00;
    public final O4 A01;

    public C0816Om(C1073Yn c1073Yn, View view) {
        super(c1073Yn);
        this.A00 = view;
        O4 o42 = new O4(c1073Yn);
        this.A01 = o42;
        AbstractC0740Lo.A0K(o42);
    }
    ...
    public final void A01(O9 o92, boolean z10) {
        ...
        if (o92 != null) {
            if (z10) {
                ...
                AbstractC0740Lo.A0S(linearLayout, gradientDrawable);
            } else {
