...
public abstract class MR {
    ...
    public static View A00(C1073Yn c1073Yn, Throwable th) {
        A03(c1073Yn, th);
        return new View(c1073Yn);
    }

    public static void A03(C1073Yn c1073Yn, Throwable th) {
        c1073Yn.A07().A9a(A01(85, 15, 44), C8A.A1w, new C8B(th));
