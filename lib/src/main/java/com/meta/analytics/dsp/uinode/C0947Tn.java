...
public final class C0947Tn implements L8 {
    ...
    public C0947Tn(int i10, int i11, int i12, String str, String str2, MB mb2, ViewOnClickListenerC0945Tl viewOnClickListenerC0945Tl) {
        this.A01 = i10;
        this.A00 = i11;
        this.A02 = i12;
        this.A05 = str;
        this.A04 = str2;
        this.A03 = mb2;
        this.A06 = viewOnClickListenerC0945Tl;
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.L8
    public final synchronized void ACm(float f5) {
        MB mb2;
        if (!this.A09 && (mb2 = this.A03) != null) {
            if (this.A01 == 1) {
                if (!this.A0A) {
                    this.A07 = Integer.valueOf(mb2.getToolbarActionMode());
                    this.A03.setProgressClickListener(new ViewOnClickListenerC0793Np(this));
                    this.A03.A05();
                    this.A03.setToolbarListener(new C0948To(this));
                    this.A0A = true;
                    Integer num = this.A07;
                ...
                if (f5 <= this.A02) {
                    if (!this.A08) {
                        ...
                        if (num2 == null || num2.intValue() == 4) {
                            ...
                            this.A03.setProgressImage(EnumC0748Lw.CROSS);
                            this.A03.setToolbarActionMode(6);
                        }
                    }
                    this.A03.setToolbarActionMessage(this.A04.replace(A00(0, 6, 52), String.valueOf((int) Math.ceil(f5))));
                } else {
