...
public class C0599Fu {
    ...
    public int A03;
    public int A04;
    public final List<C0598Ft> A06 = new ArrayList();
    ...
    public final C0592Fn A05() {
        ...
        if (A08[2].length() != 4) {
            ...
            if (A08[7].charAt(3) != 'N') {
                ...
                return new C0592Fn(spannableStringBuilder, Layout.Alignment.ALIGN_NORMAL, i12, 1, i11, f5, i10, Float.MIN_VALUE);
            }
        }
        throw new RuntimeException();
    }

    public C0599Fu(int i10, int i11) {
        A09(i10);
        A0A(i11);
    }
    ...
    private final SpannableString A00() {
        ...
        for (int italicStartPosition = 0; italicStartPosition < this.A06.size(); italicStartPosition++) {
            C0598Ft c0598Ft = this.A06.get(italicStartPosition);
            boolean z11 = c0598Ft.A02;
            int i13 = c0598Ft.A01;
            if (i13 != 8) {
                z10 = i13 == 7;
                if (i13 != 7) {
                    colorStartPosition = C5A.A0K[i13];
                }
            }
            int length2 = c0598Ft.A00;
            if (A08[1].length() != 22) {
                throw new RuntimeException();
            }
            String[] strArr = A08;
    ...
    public final void A06() {
        ...
        if (length > 0) {
            ...
            for (int i10 = length3 - 1; i10 >= 0; i10--) {
                C0598Ft c0598Ft = this.A06.get(i10);
                int length4 = c0598Ft.A00;
                if (length4 == length) {
                    int length5 = c0598Ft.A00;
                    c0598Ft.A00 = length5 - 1;
                } else {
                    return;
                }
            }
    ...
    public final void A0E(int i10, boolean z10) {
        this.A06.add(new C0598Ft(i10, z10, this.A05.length()));
    }
