...
public final class C2S {
    ...
    public static Map<String, String> A05(String str) {
        ...
        try {
            ...
            A08(C8A.A27, new C8B(e5));
            return null;
        }
    }

    private final void A07() {
        C1122aD c1122aDA5S = this.A00.A5S();
        c1122aDA5S.A00(A02(518, 22, 120), 0L);
        c1122aDA5S.A02();
    }

    public static void A08(int i10, C8B c8b) {
        C1072Ym sdkContext = AbstractC04007e.A00();
        if (sdkContext != null) {
            sdkContext.A07().A9a(A02(687, 9, 5), i10, c8b);
        }
    }
    ...
    public final void A0N(String str) {
        ...
        if (mapA05 != null) {
            ...
            for (String str2 : strArr) {
                c1122aDA5S.A01(str2, mapA05.get(str2));
            }
            c1122aDA5S.A00(A02(518, 22, 120), System.currentTimeMillis());
            c1122aDA5S.A02();
        }
    }

    public final boolean A0O(Context context, boolean z10) {
        return (z10 || C0662Ih.A29(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
