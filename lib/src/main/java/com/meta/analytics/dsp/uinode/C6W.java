...
public final class C6W extends EM implements Handler.Callback {
    ...
    public C6W(DZ dz, Looper looper, DY dy) {
        super(4);
        this.A08 = (DZ) AbstractC0629Ha.A01(dz);
        this.A04 = looper == null ? null : new Handler(looper, this);
        this.A06 = (DY) AbstractC0629Ha.A01(dy);
        this.A05 = new C04569p();
        this.A07 = new E3();
    ...
    @Override // com.meta.analytics.dsp.uinode.Y5
    public final void AFB(long j10, long j11) throws C04449c {
                ...
                if (this.A07.A04()) {
                    ...
                    if (!zA03) {
                        ...
                        try {
                            ...
                            this.A09[i10] = ((C1051Xr) this.A07).A00;
                            this.A00++;
                        } catch (DX e5) {
