...
public abstract class AbstractC03916u<E> extends H0<E> implements List<E> {
    ...
    public static final C1233c1 A02;
    ...
    public int indexOf(E element) {
        ...
        while (it.hasNext()) {
            if (C1227bu.A0A(it.next(), element)) {
                return i10;
            }
            i10++;
        }
    ...
    public int lastIndexOf(E element) {
        AbstractC03916u<E> abstractC03916u = this;
        ListIterator<E> listIterator = abstractC03916u.listIterator(abstractC03916u.size());
        while (listIterator.hasPrevious()) {
            if (C1227bu.A0A(listIterator.previous(), element)) {
    ...
    public Iterator<E> iterator() {
        return new C0627Gx(this);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator() {
        return new C03926v(this, 0);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new C03926v(this, index);
    }
