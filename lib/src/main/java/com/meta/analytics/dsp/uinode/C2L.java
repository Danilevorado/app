...
public abstract class C2L {
    ...
    public static Bundle A00(C04017f c04017f) {
        Bundle bundle = new Bundle();
        A08(bundle, c04017f);
        String strA06 = A06(123, 19, 18);
        Bundle data = A01(c04017f);
        bundle.putBundle(strA06, data);
        return bundle;
    }

    public static Bundle A01(C04017f c04017f) {
        Bundle bundle = new Bundle();
        ...
        bundle.putBoolean(A06(54, 13, 110), LE.A05(c04017f));
        return bundle;
    }
    ...
    public static AnonymousClass26 A04(C1073Yn c1073Yn, Bundle bundle, String str) {
        ...
        AnonymousClass26 anonymousClass26 = new AnonymousClass26(c1073Yn, null, string, new C1130aL(str, string4, bundle2));
    ...
    public static C2F A05(C1073Yn c1073Yn, Bundle bundle, String str) {
        String string = bundle.getString(A06(437, 17, 103));
        ...
        C2F c2f = new C2F(c1073Yn, string, null, new C1130aL(str, string4, bundle2));
    ...
    public static void A08(Bundle bundle, C04017f c04017f) {
        bundle.putString(A06(330, 22, 8), A06(0, 6, 63));
        bundle.putBoolean(A06(33, 21, 59), AnonymousClass84.A0I(c04017f));
        if (AbstractC0664Ik.A0B(c04017f)) {
            String strA03 = new C6S().A03(c04017f);
