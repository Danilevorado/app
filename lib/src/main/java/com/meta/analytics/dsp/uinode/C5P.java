...
public final class C5P implements AdViewApi {
    ...
    public C5P(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        ...
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            EnumC0681Je enumC0681JeA04 = L3.A04(adSize);
            this.A0B = enumC0681JeA04;
            this.A0C = str;
            this.A09 = adViewParentApi;
            this.A08 = adView;
            EQ eqA08 = C03525c.A08(context);
            this.A0A = eqA08;
            eqA08.A0E().A2s(AdPlacementType.BANNER.toString(), str);
            C02681u c02681u = new C02681u(str, L3.A05(enumC0681JeA04), AdPlacementType.BANNER, L3.A04(adSize), 1, new C1144aZ());
            c02681u.A06(this.A05);
            c02681u.A07(this.A06);
            FR fr = new FR(eqA08, c02681u);
            this.A03 = fr;
            fr.A0P(new ZQ(this));
            return;
        }
    ...
    public C5P(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws C0680Jc {
        this(context, str, A00(str2), adViewParentApi, adView);
        this.A0A.A0E().A3n();
    }

    public static AdSize A00(String str) throws C0680Jc {
        EnumC0683Jg template = C0688Jl.A00(str);
        if (template != null) {
            C0688Jl.A03(template);
            return L3.A01(template);
        }
        throw new C0680Jc(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A01(67, 41, 7), str));
    }
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        String str = this.A06;
        if (str != null && (c0853PxA01 = AbstractC0852Pw.A01(this.A0A, str)) != null) {
            ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
            relativeLayout.addView(c0853PxA01, new RelativeLayout.LayoutParams(layoutParams.width, layoutParams.height));
        }
    }
    ...
    public final void A0D(C0784Ng c0784Ng) {
        this.A04 = c0784Ng;
    }
    ...
    public final void destroy() {
        AbstractC0692Jp.A05(A01(114, 7, 72), A01(24, 19, 109), A01(0, 8, 65));
        this.A0A.A0E().A2t();
        FR fr = this.A03;
        if (fr != null) {
            fr.A0V(true);
        ...
        if (Build.VERSION.SDK_INT >= 18 && this.A04 != null && C0662Ih.A11(this.A08.getContext())) {
            C0784Ng c0784Ng = this.A04;
            String[] strArr = A0E;
            if (strArr[3].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
    ...
    public final void loadAd() {
        AbstractC0692Jp.A05(A01(121, 6, 44), A01(43, 24, 112), A01(16, 8, 127));
        A03(null);
    }

    @Override // com.facebook.ads.internal.api.AdViewApi
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        AbstractC0692Jp.A05(A01(121, 6, 44), A01(43, 24, 112), A01(8, 8, 5));
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        View view = this.A01;
        if (view != null) {
            AbstractC0685Ji.A01(this.A07, view, this.A0B);
        }
    }
    ...
    public final void setExtraHints(ExtraHints extraHints) {
        ...
        if (C0662Ih.A0g(this.A0A) && (fr = this.A03) != null) {
            fr.A07.A06(this.A05);
