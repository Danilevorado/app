...
public class AnonymousClass53 {
    ...
    public final void A04(int i10) {
        if ((this.A04 & i10) != 0) {
            ...
            throw new IllegalStateException(A01(192, 30, 67) + Integer.toBinaryString(i10) + A01(0, 11, 52) + Integer.toBinaryString(this.A04));
        }
    }

    public final void A05(AbstractC03274c abstractC03274c) {
        this.A04 = 1;
        this.A03 = abstractC03274c.A0E();
        this.A09 = false;
        this.A0E = false;
        this.A0A = false;
    }
