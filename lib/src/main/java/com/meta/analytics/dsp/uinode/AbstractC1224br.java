...
public abstract class AbstractC1224br {
    ...
    public static final <T> void A02(Appendable appendable, T t10, GV<? super T, ? extends CharSequence> gv) throws IOException {
        C1227bu.A07(appendable, A00(0, 6, 6));
        if (gv != null) {
            appendable.append(gv.A8v(t10));
            return;
        }
