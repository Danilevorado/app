...
public final class ZH extends C03505a implements MediaViewApi, Repairable, InterfaceC03977b {
    ...
    private void A06() {
        if (!this.A0D) {
            ...
            if (view != null) {
                AbstractC0740Lo.A0J(this.A08);
            }
            float f5 = LD.A02;
            float density = 4.0f * f5;
            int hPadding = Math.round(density);
            float density2 = 12.0f * f5;
    ...
    private void A0A(View view, V2 v22) {
        ...
        if (c0853Px != null) {
            ...
            mediaView.removeView(c0853Px);
        }
        if (!v22.A1d()) {
            return;
        }
        String strA1C = v22.A1C();
        ...
        C0853Px c0853PxA01 = AbstractC0852Pw.A01(this.A07, strA1C);
    ...
    private void A0B(ImageView imageView) {
        if (!this.A0D) {
            ...
            if (imageView2 != null) {
                AbstractC0740Lo.A0J(imageView2);
            }
            imageView.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(imageView, layoutParams);
            imageView.setId(AbstractC0740Lo.A00());
            this.A02 = imageView;
            return;
        }
    ...
    private final void A0C(C1073Yn c1073Yn, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1073Yn, attributeSet, i10, i11));
        A0H(new C0783Nf(c1073Yn, attributeSet, i10, i11));
        this.A08 = new C3C(c1073Yn, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1073Yn, attributeSet, i10, i11));
        A07();
    }

    private final void A0D(C1073Yn c1073Yn, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1073Yn, attributeSet, i10));
        A0H(new C0783Nf(c1073Yn, attributeSet, i10));
        this.A08 = new C3C(c1073Yn, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1073Yn, attributeSet, i10));
        A07();
    }

    private final void A0E(C1073Yn c1073Yn, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1073Yn, attributeSet));
        A0H(new C0783Nf(c1073Yn, attributeSet));
        this.A08 = new C3C(c1073Yn, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1073Yn, attributeSet));
        A07();
    }

    private final void A0F(C1073Yn c1073Yn, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c1073Yn));
        A0H(new C0783Nf(c1073Yn));
        this.A08 = new C3C(c1073Yn);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1073Yn));
        A07();
    }

    private void A0G(V2 v22, boolean z10, JP jp) {
        AsyncTaskC0950Tq asyncTaskC0950TqA04 = new AsyncTaskC0950Tq(this.A02, this.A07).A04();
        if (z10) {
            asyncTaskC0950TqA04.A06(new ZO(this, v22));
        }
        asyncTaskC0950TqA04.A07(jp.getUrl());
    }

    private void A0H(C0783Nf c0783Nf) {
        if (!this.A0D) {
            C0783Nf c0783Nf2 = this.A09;
            if (c0783Nf2 != null) {
                this.A03.removeView(c0783Nf2);
            }
            c0783Nf.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c0783Nf, layoutParams);
            this.A09 = c0783Nf;
            return;
        }
    ...
    private boolean A0I(NativeAd nativeAd) {
        List<NativeAd> carousel = ((C03585i) nativeAd.getNativeAdApi()).A03();
        if (carousel == null) {
            return false;
        }
    ...
    public boolean A0J(NativeAd nativeAd) {
        return Build.VERSION.SDK_INT >= 14 && !TextUtils.isEmpty(((C03585i) nativeAd.getNativeAdApi()).A02());
    }
  ...
  0x03b6: PHI (r1v12 android.view.View) = (r1v11 android.view.View), (r1v17 android.view.View) binds: [B:69:0x03b3, B:65:0x035e] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.ZH.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C1073Yn c1073YnA11 = ((V2) nativeAdBaseApi).A11();
        C1073Yn adObjectContext = this.A07;
        adObjectContext.A0K(c1073YnA11);
        c1073YnA11.A0L(this);
        this.A0D = true;
        ...
        ((C03575h) this.A05.getMediaViewVideoRendererApi()).A03();
        View view = this.A01;
        if (view != null) {
        ...
        if (adIcon != null) {
            ...
            if (bitmapA0M != null) {
                ...
                A0G(v2A0L, z10, adIcon);
            }
        } else {
            V1 v1A15 = v2A0L.A15();
            AdErrorType adErrorType = AdErrorType.NATIVE_AD_IS_NOT_LOADED;
            c1073YnA11.A0E().A2m(v2A0L.A0x(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (v1A15 != null) {
                v1A15.ABR(C0679Jb.A00(adErrorType));
            }
            Log.e(A04(46, 17, 115), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                C1073Yn adObjectContext2 = this.A07;
    ...
    public final void bringChildToFront(View view) {
        if (view == this.A01 || view == this.A05 || view == this.A09 || view == this.A02) {
            ...
            C0853Px c0853Px = this.A0B;
            if (c0853Px != null) {
                this.A06.bringChildToFront(c0853Px);
            }
        }
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.C03505a, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C03575h) this.A05.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C03575h) this.A05.getMediaViewVideoRendererApi()).A07(new ZI(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            ((C03575h) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A07.A09());
            ...
            mediaViewVideoRenderer.setId(AbstractC0740Lo.A00());
            return;
        }
