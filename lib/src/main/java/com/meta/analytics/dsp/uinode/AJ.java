...
public final class AJ {
    ...
    private AK A00(AK ak, AH ah) {
        ...
        Object uid = ah2.A0A(i10, this.A04, true).A03;
    ...
    public final void A0B(int i10, C0569Eo c0569Eo) {
        this.A05.add(new AK(i10, c0569Eo));
        if (this.A05.size() == 1 && !this.A00.A0E()) {
            A02();
        }
    }

    public final void A0C(int i10, C0569Eo c0569Eo) {
        AK mediaPeriod;
        AK ak = new AK(i10, c0569Eo);
        this.A05.remove(ak);
    ...
    public final void A0D(int i10, C0569Eo c0569Eo) {
        this.A02 = new AK(i10, c0569Eo);
    }
    ...
    */
    public final void A0E(com.meta.analytics.dsp.uinode.AH r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.AK r0 = (com.meta.analytics.dsp.uinode.AK) r0
        ...
        L25:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AJ.A0E(com.facebook.ads.redexgen.X.AH):void");
    }
