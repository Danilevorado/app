...
public final class MI extends AdNativeComponentView {
    ...
    public MI(C1073Yn c1073Yn, JR jr) {
        super(c1073Yn);
        this.A06 = jr;
        this.A05 = new TextView(c1073Yn);
        this.A04 = new TextView(c1073Yn);
        this.A03 = new TextView(c1073Yn);
        this.A02 = new RelativeLayout(c1073Yn);
        this.A00 = new LinearLayout(c1073Yn);
        this.A01 = new RelativeLayout(c1073Yn);
        this.A07 = new UB(c1073Yn);
        A09();
        A0D();
        A05();
        A0A();
    ...
    private void A0B() {
        ...
        AbstractC0740Lo.A0K(this.A07);
    }

    private void A0C() {
        AbstractC0740Lo.A0K(this.A02);
    ...
    */
    public final void onMeasure(int r5, int r6) {
        /*
            r4 = this;
            float r0 = com.meta.analytics.dsp.uinode.LD.A02
            int r1 = (int) r0
            android.content.Context r0 = r4.getContext()
            int r0 = com.meta.analytics.dsp.uinode.C0662Ih.A0E(r0)
            int r1 = r1 * r0
            int r0 = android.view.View.MeasureSpec.getSize(r6)
            if (r0 >= r1) goto L38
            int r3 = android.view.View.MeasureSpec.getMode(r6)
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.MI.A08
            r0 = 3
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L4c:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.MI.onMeasure(int, int):void");
    }
