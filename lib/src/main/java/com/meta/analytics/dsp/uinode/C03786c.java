...
public final class C03786c {
    ...
    public static final Map<String, C03806e> A0G;
    public long A00;
    public JA A01;
    public final C03796d A03;
    public final C04017f A04;
        ...
        while (true) {
            ...
            if (!zHasNext) {
                ...
                try {
                    ...
                    Log.e(A0E, A08(86, 42, 61), e5);
                    atomicBoolean.set(false);
                }
                return atomicBoolean;
            }
            arrayList2.add(ExecutorC0745Lt.A02().submit(it.next()));
        }
    }
    ...
    static {
        A0F();
        A0E = C03786c.class.getSimpleName();
        A0F = Collections.synchronizedMap(new HashMap());
        A0G = Collections.synchronizedMap(new HashMap());
    }

    public C03786c(C04017f c04017f) {
        this.A04 = c04017f;
        this.A03 = C03796d.A06(c04017f.A01());
        this.A08 = C0662Ih.A2I(c04017f);
        this.A09 = C0662Ih.A2Q(c04017f, C0878Qw.A03());
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [com.facebook.ads.redexgen.X.07] */
    public static synchronized AnonymousClass00 A03(C1072Ym c1072Ym) {
        if (A0A == null) {
            A0A = AnonymousClass01.A00(c1072Ym, new Object() { // from class: com.facebook.ads.redexgen.X.07
                public int A00;
                public int A01;
                public boolean A02;
                public boolean A03;
            ...
            }.A00(C0662Ih.A05(c1072Ym)).A02(c1072Ym.A04().A8z()).A01(-1).A03(C0662Ih.A0k(c1072Ym)).A04(C0662Ih.A2P(c1072Ym)).A05(), A05(c1072Ym));
        }
        return A0A;
    }

    public static AnonymousClass06 A04(C04017f c04017f, String str) {
        AnonymousClass06 anonymousClass06 = A0F.get(str);
        if (C03816f.A06(c04017f) && anonymousClass06 != null) {
    ...
    public static C1077Yr A05(C1072Ym c1072Ym) {
        return new C1077Yr(c1072Ym);
    }

    public static synchronized List<String> A09(C04017f c04017f) {
        if (A0B == null) {
            ArrayList arrayList = new ArrayList();
            A0B = arrayList;
            A0J(arrayList, c04017f);
        }
        return A0B;
    }

    public static void A0H(C04017f c04017f, String str) {
        C03806e c03806e;
        if (C03816f.A06(c04017f) && !TextUtils.isEmpty(str) && (c03806e = A0G.get(str)) != null) {
            c03806e.A00 = A08(186, 4, 35);
            C1072Ym c1072YmA01 = c04017f.A01();
            R0 r0A05 = R0.A05(c1072YmA01);
            String strA08 = R0.A08(c1072YmA01, AbstractC0724Ky.A00(str));
            if (strA08 == null) {
                strA08 = str;
            }
            C03816f.A04(c04017f, c03806e, r0A05.A0H(strA08));
        }
    }
    ...
    public void A0I(J9 j92) {
        ...
        map.put(A08(174, 12, 111), C0731Lf.A04(this.A00));
        this.A01.A04(j92, map);
    }

    public static void A0J(List<String> cacheDirs, C04017f c04017f) {
        A0K(cacheDirs, C1220bn.A01(c04017f));
        A0K(cacheDirs, C03796d.A07(c04017f));
    }
    ...
    public final void A0T() {
        AbstractC0692Jp.A05(A08(128, 19, 68), A08(38, 16, 66), A08(16, 8, 19));
    }

    public final void A0U() {
        AbstractC0692Jp.A05(A08(147, 16, 11), A08(54, 14, 50), A08(0, 8, 64));
    }
    ...
    public final void A0W(C6U c6u, C6V c6v) {
        AbstractC0692Jp.A05(A08(163, 7, 25), A08(68, 18, 23), A08(8, 8, 44));
        this.A00 = System.currentTimeMillis();
        C03816f.A02(this.A04, c6v, C03816f.A07, A08(24, 14, 60), -1L);
        ExecutorC0745Lt.A03().execute(new C1078Ys(this, new ArrayList(this.A05), c6v, c6u, new ArrayList(this.A06)));
        this.A05.clear();
        this.A06.clear();
    }
    ...
    public final void A0b(final C03766a c03766a) {
        Callable<Boolean> callable = new Callable<Boolean>(c03766a) { // from class: com.facebook.ads.redexgen.X.6b
            ...
            private final Boolean A00() throws Throwable {
                ...
                try {
                    ...
                    if (C03816f.A06(this.A01.A04)) {
                        C03786c.A0F.put(this.A00.A07, anonymousClass06);
                    }
                    boolean z10 = this.A01.A08;
                    boolean zA01 = false;
                    if (A03[3].length() != 5) {
                        A03[4] = "CZcPy1KhLDdCOlGcBT5xxsnRB32IUDMD";
                        if (z10) {
                            zA01 = C03786c.A03(this.A01.A04.A01()).AFH(anonymousClass06, false).A01();
            ...
            private void A04(String str, AnonymousClass06 anonymousClass06) {
                Bitmap bitmapA00 = C03786c.A03(this.A01.A04.A01()).AFH(anonymousClass06, true).A00();
                if (bitmapA00 == null) {
                    return;
                }
    ...
    public final void A0c(C03766a c03766a) {
        c03766a.A02 = true;
        A0b(c03766a);
    }
