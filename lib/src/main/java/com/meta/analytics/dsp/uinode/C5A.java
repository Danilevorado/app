...
public final class C5A extends AbstractC0509Bq {
    ...
    public int A02;
    public int A03;
    public List<C0592Fn> A05;
    public List<C0592Fn> A06;
    public boolean A07;
    public final int A08;
    public final int A09;
    public final C0654Hz A0A = new C0654Hz();
    public final ArrayList<C0599Fu> A0B = new ArrayList<>();
    public C0599Fu A04 = new C0599Fu(0, 4);
    ...
    private List<C0592Fn> A05() {
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < this.A0B.size(); i10++) {
            C0592Fn c0592FnA05 = this.A0B.get(i10).A05();
            if (c0592FnA05 != null) {
                arrayList.add(c0592FnA05);
            }
        }
        return arrayList;
    }
    ...
    private void A0A(byte b10, byte b11) {
        ...
        if (i10 != row3) {
            ...
            if (row4 != 1 && !this.A04.A0F()) {
                int i11 = this.A02;
                int row5 = this.A03;
                C0599Fu c0599Fu = new C0599Fu(i11, row5);
                this.A04 = c0599Fu;
                this.A0B.add(c0599Fu);
            }
            this.A04.A0C(i10);
        }
        ...
        int row7 = b11 >> 1;
        int i12 = row7 & 7;
        C0599Fu c0599Fu2 = this.A04;
        int row8 = cursorOrStyle != 0 ? 8 : i12;
        c0599Fu2.A0E(row8, isCursor);
        if (cursorOrStyle != 0) {
            C0599Fu c0599Fu3 = this.A04;
            int row9 = A0F[i12];
            c0599Fu3.A0B(row9);
        }
    }
    ...
    */
    private boolean A0E(byte r6, byte r7) {
        /*
            ...
            r0 = 0
            r5.A07 = r0
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.C5A.A0D
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 21
            if (r1 == r0) goto L30
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C5A.A0D
        ...
        L81:
            ...
            goto L7d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C5A.A0E(byte, byte):boolean");
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0509Bq
    /* renamed from: A0L */
    public final /* bridge */ /* synthetic */ C5 A54() throws C0594Fp {
        return super.A54();
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0509Bq
    /* renamed from: A0M */
    public final /* bridge */ /* synthetic */ AbstractC0510Br A55() throws C0594Fp {
        return super.A55();
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0509Bq
    public final WI A0N() {
        List<C0592Fn> list = this.A05;
        this.A06 = list;
        return new WI(list);
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0509Bq
    /* renamed from: A0O */
    public final /* bridge */ /* synthetic */ void AEG(C5 c52) throws C0594Fp {
        super.AEG(c52);
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0509Bq, com.meta.analytics.dsp.uinode.BB
    public final void AEV() {
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0509Bq, com.meta.analytics.dsp.uinode.WL
