...
public final class C1014Wf implements DW {
    ...
    public final Metadata A51(E3 e32) {
        ...
        C0654Hz c0654Hz = new C0654Hz(bArrArray, iLimit);
        String strA0Q = c0654Hz.A0Q();
        String strA0Q2 = c0654Hz.A0Q();
        long jA0M = c0654Hz.A0M();
        return new Metadata(new EventMessage(strA0Q, strA0Q2, IF.A0F(c0654Hz.A0M(), 1000L, jA0M), c0654Hz.A0M(), Arrays.copyOfRange(bArrArray, c0654Hz.A06(), iLimit), IF.A0F(c0654Hz.A0M(), 1000000L, jA0M)));
    }
}
