...
public abstract class AbstractC1176b5 extends C1F implements Serializable {
    ...
    public AbstractC1176b5(List<C1G> list) {
        this.A0D = list;
    }
    ...
    private HashMap<String, String> A07(JSONObject jSONObject) {
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A05(175, 18, 123));
    ...
    public static List<C1G> A08(JSONObject jSONObject, C1073Yn c1073Yn, C1S c1s) {
        JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(A05(101, 8, 125));
        if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
            return C1O.A01(jSONArrayOptJSONArray, jSONObject, c1073Yn, c1s);
        }
    ...
    private final void A0F(C02481a c02481a) {
        this.A08 = c02481a;
    }

    private void A0G(C02541g c02541g) {
        this.A09 = c02541g;
    }
    ...
    public final C02481a A10() {
        return this.A08;
    }

    public final C02541g A11() {
        return this.A09;
    }
    ...
    */
    public final void A15(com.meta.analytics.dsp.uinode.MC r8) {
        /*
            r7 = this;
        ...
        L10:
            ...
            r8.A43(r0)
        L1d:
            com.facebook.ads.redexgen.X.QP r0 = com.meta.analytics.dsp.uinode.QP.A08
        ...
        L39:
            ...
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.AbstractC1176b5.A0H
            r0 = 2
            r1 = r2[r0]
            r0 = 1
            r2 = r2[r0]
        ...
        L6b:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC1176b5.A15(com.facebook.ads.redexgen.X.MC):void");
    }
    ...
    public final void A16(JSONObject jSONObject) {
        ...
        A0F(c1zA06.A05(strA05).A04(jSONObject.optString(A05(0, 19, 117))).A07(AbstractC02491b.A03(jSONObject)).A08());
        ...
        A0G(AbstractC02491b.A01(jSONObject));
        A0E(AbstractC02491b.A00(jSONObject));
        ...
        String strOptString = jSONObject.optString(A05(173, 2, 14));
        A0H(strOptString);
        A0I.put(strOptString, jSONObject.optString(A05(193, 28, 8)));
        A0d(jSONObject);
    }
