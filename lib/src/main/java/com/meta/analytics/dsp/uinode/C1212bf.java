...
public class C1212bf implements C0S {
    ...
    public final AtomicReference<EnumC02270e> A08;
    ...
    private final void A03(JSONObject jSONObject) throws Throwable {
        ...
        try {
            ...
            EnumC02270e enumC02270e = this.A08.get();
            if (enumC02270e != null) {
                C0Z.A0I.A04(enumC02270e).A02(jSONObject);
            }
    ...
    public C1212bf(C1210bd c1210bd) {
        this(c1210bd, UUID.randomUUID().toString());
    }

    public C1212bf(C1210bd c1210bd, String str) {
    ...
    @Override // com.meta.analytics.dsp.uinode.C0S
    public final void AEl(RemoteException e5) throws Throwable {
        if (KL.A02(this)) {
            return;
        }
        try {
            A04(C0V.A2b, C0Z.A0V.A04(e5.toString()));
        } catch (Throwable th) {
            KL.A00(th, this);
        }
    }
    ...
    @Override // com.meta.analytics.dsp.uinode.C0S
    public final void AGG(EnumC02270e viewType) throws Throwable {
        if (KL.A02(this)) {
            return;
        }
        try {
    ...
    @Override // com.meta.analytics.dsp.uinode.C0S
    public final void AHA(int i10, String error) throws Throwable {
        if (KL.A02(this)) {
            return;
        }
        try {
