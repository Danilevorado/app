...
public final class X3 implements InterfaceC0537Cy {
    ...
    private boolean A02(C0654Hz c0654Hz, int i10) {
        if (c0654Hz.A04() == 0) {
            return false;
        }
        if (c0654Hz.A0E() != i10) {
    ...
    public final void A4R(C0654Hz c0654Hz) {
        if (this.A03) {
            if (this.A00 == 2 && !A02(c0654Hz, 32)) {
                return;
            }
            if (this.A00 == 1 && !A02(c0654Hz, 0)) {
                return;
            }
            ...
            int bytesAvailable = c0654Hz.A04();
            for (C4 c42 : this.A05) {
                c0654Hz.A0Y(iA06);
                c42.AFR(c0654Hz, bytesAvailable);
            }
    ...
    */
    public final void A4p(com.meta.analytics.dsp.uinode.InterfaceC0513Bu r15, com.meta.analytics.dsp.uinode.DC r16) {
        /*
            r14 = this;
            r2 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.D9 r5 = (com.meta.analytics.dsp.uinode.D9) r5
            r16.A05()
            int r1 = r16.A03()
            r0 = 3
        ...
        L41:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.X3.A4p(com.facebook.ads.redexgen.X.Bu, com.facebook.ads.redexgen.X.DC):void");
    }
