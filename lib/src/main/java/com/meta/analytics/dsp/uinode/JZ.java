...
public final class JZ {
    ...
    public JZ(C04017f c04017f, JX jx) {
        int nativeViewabilityHistorySamplingRate = Ij.A0D(c04017f);
        if (nativeViewabilityHistorySamplingRate < 1) {
            this.A0F = false;
        } else {
            this.A0F = c04017f.A08().A00() < 1.0d / ((double) nativeViewabilityHistorySamplingRate);
        }
        this.A0B = jx;
    }
    ...
    public final void A0C(C04017f c04017f, String str) {
        if (!this.A0F) {
            return;
        }
        A03(new JY(A01(), 103, A00(), null));
        ExecutorC0745Lt.A06.execute(new JW(this, str, c04017f));
    }
}
