...
public final class C0960Ua {
    ...
    */
    public static void A00(int[] r42, int r43, int r44, int r45, int r46, int r47, int r48) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0960Ua.A00(int[], int, int, int, int, int, int):void");
    }

    public final Bitmap A02(Bitmap bitmap, float f5) throws InterruptedException {
        int w10 = bitmap.getWidth();
        int h10 = bitmap.getHeight();
        try {
            int[] iArr = new int[w10 * h10];
            bitmap.getPixels(iArr, 0, w10, 0, 0, w10, h10);
            int i10 = AbstractC0751Lz.A00;
            ArrayList arrayList = new ArrayList(i10);
            ArrayList<JavaBlurProcess.BlurTask> vertical = new ArrayList<>(i10);
            for (int i11 = 0; i11 < i10; i11++) {
                int h11 = h10;
                int cores = i11;
                arrayList.add(new CallableC0750Ly(iArr, w10, h11, (int) f5, i10, cores, 1));
                h10 = h11;
                int cores2 = i11;
                vertical.add(new CallableC0750Ly(iArr, w10, h10, (int) f5, i10, cores2, 2));
            }
            try {
                AbstractC0751Lz.A01.invokeAll(arrayList);
                try {
                    AbstractC0751Lz.A01.invokeAll(vertical);
                    try {
