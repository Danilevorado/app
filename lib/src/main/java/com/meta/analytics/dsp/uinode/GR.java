...
public final class GR {
            ...
            switch (cCharAt) {
                ...
                case '<':
                    if (iA01 + 1 < str2.length()) {
                        int i10 = iA01;
                        boolean z10 = str2.charAt(i10 + 1) == '/';
                        iA01 = A01(str2, i10 + 1);
                        boolean z11 = str2.charAt(iA01 + (-2)) == '/';
                        String strSubstring = str2.substring((z10 ? 2 : 1) + i10, z11 ? iA01 - 2 : iA01 - 1);
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 20 out of bounds for length 15
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public final boolean A0G(C0654Hz c0654Hz, GO go, List<GM> list) {
        ...
        if (matcher.matches()) {
            return A0F(null, matcher, c0654Hz, go, this.A00, list);
        }
        String strA0P2 = c0654Hz.A0P();
        if (strA0P2 == null) {
            return false;
        }
        Matcher matcher2 = pattern.matcher(strA0P2);
        if (matcher2.matches()) {
            return A0F(strA0P.trim(), matcher2, c0654Hz, go, this.A00, list);
        }
        return false;
    }
    ...
    */
    public static int A00(java.lang.String r7) {
        ...
        L4a:
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.GR.A02
            r0 = 6
            r1 = r1[r0]
            r0 = 12
            ...
            r0 = 85
            if (r1 == r0) goto Lb9
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.GR.A02
    ...
    */
    ...
    public static boolean A0F(String str, Matcher matcher, C0654Hz c0654Hz, GO go, StringBuilder sb2, List<GM> list) {
        try {
