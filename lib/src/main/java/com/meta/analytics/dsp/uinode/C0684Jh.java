...
public final class C0684Jh implements RK {
    ...
    public boolean A02;
    public RP A03;
    public final RU A04 = new C0695Js();
    public final RZ A05;
    public final InterfaceC0882Ra A06;
        ...
        try {
            try {
                ...
                if ((httpURLConnectionA08 instanceof HttpsURLConnection) && (z11 || z10)) {
                    try {
                        AbstractC0883Rb.A03((HttpsURLConnection) httpURLConnectionA08, setA01, setA02);
                    } catch (CertificateException e5) {
                        this.A00.AA2(strA07, C8A.A1z, new C8B(e5));
                    } catch (Exception e10) {
                        this.A00.AA2(strA07, C8A.A1y, new C8B(e10));
                    }
                }
                if (httpURLConnectionA08.getDoOutput() && rw.A06() != null) {
                    A00(httpURLConnectionA08, rw.A06());
                }
                C0689Jm c0689JmA06 = httpURLConnectionA08.getDoInput() ? A06(httpURLConnectionA08) : new C0689Jm(httpURLConnectionA08, null);
                if (this.A06.A98()) {
                    this.A06.A9z(c0689JmA06);
                }
                ...
                try {
                    try {
                        c0689JmA05 = A05(null);
                        if (c0689JmA05 == null || c0689JmA05.A83() <= 0) {
                            throw new RX(e11, c0689JmA05);
                        }
                        if (this.A06.A98()) {
                            this.A06.A9z(c0689JmA05);
                        }
                        if (0 != 0) {
                    ...
                    Log.e(getClass().getSimpleName(), A07(117, 13, 53), e11);
                    if (c0689JmA05 == null || c0689JmA05.A83() <= 0) {
                        throw new RX(e11, c0689JmA05);
                    }
                    if (this.A06.A98()) {
                        InterfaceC0882Ra interfaceC0882Ra = this.A06;
                        String[] strArr = A08;
                        ...
                        interfaceC0882Ra.A9z(c0689JmA05);
                    }
                    if (0 != 0) {
                        httpURLConnection.disconnect();
                    }
    ...
    */
    public final com.meta.analytics.dsp.uinode.RJ A0J(com.meta.analytics.dsp.uinode.RW r30) throws java.lang.InterruptedException, com.meta.analytics.dsp.uinode.RX {
        /*
            Method dump skipped, instructions count: 426
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0684Jh.A0J(com.facebook.ads.redexgen.X.RW):com.facebook.ads.redexgen.X.RJ");
    }
    ...
    public C0684Jh(RP rp, AnonymousClass89 anonymousClass89, Executor executor) {
        A0B();
        this.A03 = rp;
        final JN jn = new JN(rp.A04());
        this.A06 = jn;
        this.A05 = new AbstractC0694Jr(jn) { // from class: com.facebook.ads.redexgen.X.76
        };
        this.A01 = executor;
    ...
    private final RJ A02(RW rw) {
        ...
        try {
            ...
            this.A05.ABU(new RX(e5, rjA01));
            return rjA01;
        }
    }

    private final RJ A03(String str, RY ry, RS rs) {
        return A02(new C0691Jo(str, ry, rs));
    }

    private final RJ A04(String str, String str2, byte[] bArr, RS rs) {
        return A02(new C0690Jn(str, null, str2, bArr, rs));
    }

    private final C0689Jm A05(HttpURLConnection httpURLConnection) throws Exception {
        ...
        try {
            ...
            C0689Jm c0689Jm = new C0689Jm(httpURLConnection, responseBody);
            if (errorStream != null) {
                try {
                    errorStream.close();
                } catch (Exception unused) {
    ...
    private final C0689Jm A06(HttpURLConnection httpURLConnection) throws Exception {
    ...
    private final HttpURLConnection A08(String str, Proxy proxy) throws IOException {
        try {
            ...
            throw new IllegalArgumentException(str + A07(18, 19, 115), e5);
        }
    }
    ...
    private void A0F(String str, String str2, byte[] bArr, RL rl, RS rs) {
        C0690Jn req = new C0690Jn(str, null, str2, bArr, rs);
        A0D(req, rl);
    }
    ...
    private final boolean A0I(Throwable th, long j10, RW rw) {
        RS rsA02 = rw.A02();
