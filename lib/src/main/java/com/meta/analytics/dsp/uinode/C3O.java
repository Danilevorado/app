...
public final class C3O<E> extends AbstractC03886o implements GV<E, CharSequence> {
    ...
    public final CharSequence A8v(E e5) {
        String strA01 = e5 == this.A00 ? A01(0, 17, 114) : String.valueOf(e5);
        String[] strArr = A02;
