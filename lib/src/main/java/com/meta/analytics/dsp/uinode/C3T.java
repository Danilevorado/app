...
public abstract class C3T {
    ...
    static {
        if (Build.VERSION.SDK_INT >= 26) {
            A00 = new C02260d() { // from class: com.facebook.ads.redexgen.X.0U
            };
            return;
        }
    ...
    public static C03103k A05(View view, C03103k c03103k) {
        return A00.A08(view, c03103k);
    }

    public static C03103k A06(View view, C03103k c03103k) {
        return A00.A09(view, c03103k);
    }
