...
public class C5S {
    ...
    public C5S(C5V c5v, Intent intent, J2 j22, C1073Yn c1073Yn) {
        this.A01 = c5v;
        this.A00 = intent;
        this.A03 = j22;
        this.A02 = c1073Yn;
    ...
    public /* synthetic */ C5S(C5V c5v, Intent intent, J2 j22, C1073Yn c1073Yn, C5R c5r) {
        this(c5v, intent, j22, c1073Yn);
    }
    ...
    public MD A02() {
        ...
        if (C0662Ih.A2N(this.A02)) {
            ...
            return new ViewOnClickListenerC0501Bi(c5v, c1073Yn, j22, zw, stringExtra2, Integer.parseInt(stringExtra));
        }
        C5V c5v2 = this.A01;
    ...
    public UD A0H() {
        ...
        return new UD(this.A02, this.A03, new C0555Ea(this.A01, null), fs, fs.A0T(), new U8());
    }
    ...
    public UA A0I(RelativeLayout relativeLayout) {
        ...
        AbstractC0740Lo.A0M(relativeLayout, -16777216);
        return ua2;
    }
    ...
    public TI A0L() {
        PB pbA02;
        AbstractC1176b5 abstractC1176b5 = (AbstractC1176b5) this.A00.getSerializableExtra(A0S(68, 18, 21));
        C5R c5r = null;
        if (abstractC1176b5 == null || (pbA02 = PC.A02(abstractC1176b5.A0S())) == null) {
            return null;
        }
        return new TI(this.A02, new ZW(this.A01, c5r), pbA02, abstractC1176b5.A12());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public C0922So A0M(KB kb2) {
        InterfaceC0761Mj u82;
        MC c0555Ea;
        C1174b3 c1174b3 = (C1174b3) this.A00.getSerializableExtra(A0S(26, 19, 124));
        C5R c5r = null;
        if (kb2 == KB.A04) {
            u82 = new U9();
            c0555Ea = new ZW(this.A01, c5r);
        } else {
            u82 = new U8();
            c0555Ea = new C0555Ea(this.A01, c5r);
        }
        return new C0922So(this.A02, u82, this.A03, c1174b3, new C03786c(this.A02), c0555Ea);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public C9Y A0N() {
        return new C9Y(this.A02, new U9(), this.A03, A00(), new C03786c(this.A02), new ZW(this.A01, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public C9Q A0O() {
        return new C9Q(this.A02, new U9(), this.A03, A00(), new C03786c(this.A02), new ZW(this.A01, null));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public C9Q A0P() {
        return new C9Q(this.A02, new U8(), this.A03, (FS) this.A00.getSerializableExtra(A0S(86, 25, 43)), new C03786c(this.A02), new C0555Ea(this.A01, null));
    }
    ...
    public C9P A0Q() {
        ...
        return new C9P(this.A02, this.A03, new C03786c(this.A02), new ZW(this.A01, null), fuA00);
    }
    ...
    public C9P A0R() {
        FS fs = (FS) this.A00.getSerializableExtra(A0S(86, 25, 43));
        fs.A0Z(this.A01.A0C);
        return new C9P(this.A02, this.A03, new C03786c(this.A02), new ZW(this.A01, null), fs);
    }
