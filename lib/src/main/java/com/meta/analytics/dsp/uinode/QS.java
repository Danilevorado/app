...
public class QS {
     ...
     */
    public QS(C1073Yn c1073Yn, J2 j22, QE qe, List<C2P> list, String str, boolean z10, Bundle bundle, Map<String, String> map, QK qk) {
        this.A0B = new Object();
        this.A01 = 0;
        this.A00 = 0;
        this.A03 = null;
        ...
        if (bundle != null) {
            this.A05 = new C1124aF(list, bundle.getBundle(A0F(6, 16, 29)), qk);
            this.A01 = bundle.getInt(A0F(57, 18, 2));
            this.A00 = bundle.getInt(A0F(39, 18, 44));
        } else {
            this.A05 = new C1124aF(list, qk);
        }
    ...
    public QS(C1073Yn c1073Yn, J2 j22, QE qe, List<C2P> list, String str, boolean z10, Bundle bundle, QK qk) {
        this(c1073Yn, j22, qe, list, str, z10, bundle, null, qk);
    }

    public QS(C1073Yn c1073Yn, J2 j22, QE qe, List<C2P> list, String str, boolean z10, QK qk) {
        this(c1073Yn, j22, qe, list, str, z10, null, qk);
    }

    private final float A0E() {
        return AbstractC0737Ll.A00(this.A06) * this.A08.getVolume();
    }

    private Map<String, String> A0H(int i10) {
        HashMap<String, String> map = new HashMap<>();
        AbstractC0737Ll.A03(map, this.A08.getVideoStartReason() == QM.A02, !this.A08.A95());
        A0T(map);
        A0S(map);
        A0V(map, i10);
        A0U(map);
    ...
    private Map<String, String> A0J(QG qg, int i10) {
        Map<String, String> mapA0H = A0H(i10);
    ...
    private void A0S(Map<String, String> params) {
        ...
        params.put(A0F(141, 3, 90), String.valueOf(c2qA00.A00()));
        params.put(A0F(144, 3, 81), String.valueOf(c2qA00.A05()));
        params.put(A0F(147, 5, 95), String.valueOf(c2qA00.A02()));
