...
public class UT extends RelativeLayout implements MD {
    ...
    public UT(C5V c5v, C1073Yn c1073Yn, J2 j22, MC mc) {
        U1 u12;
        super(c1073Yn);
        UW uw = new UW(this);
        this.A06 = uw;
        ...
        NS nsA0E = A0E();
        this.A0D = nsA0E;
        if (AbstractC0663Ii.A02(c1073Yn) || c1073Yn.A0D() == null) {
            u12 = new U1(c1073Yn, nsA0E);
        } else {
            u12 = new U1(c1073Yn, c1073Yn.A0D(), nsA0E);
        }
        this.A0E = u12;
        NJ nj = new NJ(c1073Yn, u12);
        this.A0B = nj;
        nj.setId(View.generateViewId());
        nj.setListener(new UV(this));
        u12.setBrowserNavigationListener(nj.getBrowserNavigationListener());
        this.A0C = new NK(c1073Yn, null, R.attr.progressBarStyleHorizontal);
        A0F();
        c5v.A0N(uw);
    }
    ...
    public final void ACW(boolean z10) {
        ...
        if (this.A03) {
            ...
            if (BuildConfigApi.isDebug()) {
                String str = A0C(169, 30, 38) + System.currentTimeMillis() + A0C(149, 20, 20) + nnA07.A01 + A0C(53, 22, 86) + nnA07.A03 + A0C(75, 24, 83) + nnA07.A04 + A0C(0, 30, 42) + nnA07.A00 + A0C(99, 24, 127) + nnA07.A05 + A0C(30, 23, 114) + nnA07.A02 + A0C(123, 26, 72) + nnA07.A06;
            }
        }
    }
