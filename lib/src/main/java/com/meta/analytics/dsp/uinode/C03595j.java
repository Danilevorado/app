...
public final class C03595j implements NativeAdScrollViewApi {
    ...
    public C03595j(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i10, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i11) throws Resources.NotFoundException {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i10 > 0) {
                this.A06 = C03525c.A03(context);
    ...
    public final void setInset(int i10) {
        if (i10 > 0) {
            float f5 = LD.A02;
            float density = i10;
            int insetDp = Math.round(density * f5);
            this.A05.setPadding(insetDp, 0, insetDp, 0);
            float density2 = i10 / 2;
            this.A05.setPageMargin(Math.round(density2 * f5));
