...
public final class HE implements InterfaceC1258cc {
    ...
    public final InterfaceC1260ce A02;
    ...
    private final void A02(List<Rect> list) {
        ...
        list2.add(rect);
        Iterator<InterfaceC0899Rr> it = this.A02.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public HE(View view, InterfaceC1260ce interfaceC1260ce) {
        this.A03 = new WeakReference<>(view);
        this.A02 = interfaceC1260ce;
    }

    @Override // com.meta.analytics.dsp.uinode.InterfaceC1258cc
