...
public final class C1215bi implements C0K {
    ...
    static {
        A04();
        A07 = C1215bi.class.getSimpleName();
    }

    public C1215bi(String str) {
        this(str, C0I.A01(str));
    }

    public C1215bi(String str, int i10) {
        this(str);
        this.A00 = i10;
    }

    public C1215bi(String str, String str2) {
    ...
    private HttpURLConnection A02(int i10, int i11) throws IOException, C1217bk {
        HttpURLConnection httpURLConnection;
        int code;
        int i12 = 0;
        String headerField = this.A03;
        do {
            String str = A01(234, 16, 102) + (i10 > 0 ? A01(19, 13, 86) + i10 : A01(0, 0, 78)) + A01(15, 4, 66) + headerField;
            ...
            if (i12 > 5) {
                ...
                throw new C1217bk(url2);
            }
        } while (code != 0);
        return httpURLConnection;
    }

    private void A03() throws IOException, C1217bk {
        String[] strArr;
        ...
        try {
            try {
                ...
                Log.e(A07, A01(129, 25, 77) + this.A03, e5);
                C0I.A05(inputStream);
    ...
    private final void A05(int i10, int i11) throws C1217bk {
        try {
            HttpURLConnection httpURLConnectionA02 = A02(i10, i11);
            ...
            throw new C1217bk(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i10, e5);
        }
    }
    ...
    public final void close() throws C1217bk {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C1217bk(A01(92, 37, 93), e5);
            }
        }
    }

    @Override // com.meta.analytics.dsp.uinode.C0K
    public final synchronized int length() throws C1217bk {
    ...
    public final int read(byte[] bArr) throws C1217bk {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new GF(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e5);
            } catch (IOException e10) {
                throw new C1217bk(strA01 + this.A03, e10);
            }
        }
        throw new C1217bk(strA01 + this.A03 + A01(51, 23, 21));
    }
