...
public class YB implements AnonymousClass96 {
    ...
    public YB(YA ya2, List<AnonymousClass92> list, boolean z10) throws IOException {
        this.A02 = ya2;
        this.A01 = z10;
        for (AnonymousClass92 fetch : list) {
            AnonymousClass91 anonymousClass91A01 = fetch.A01();
            this.A00.add(new C9B(new C04418z(fetch.A00(), anonymousClass91A01.A01()), anonymousClass91A01.A00() - anonymousClass91A01.A01(), anonymousClass91A01.A00()));
        }
    }
