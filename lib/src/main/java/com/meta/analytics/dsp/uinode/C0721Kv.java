...
public final class C0721Kv {
    ...
    private int A00(C1073Yn c1073Yn) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c1073Yn.getPackageManager();
    ...
    public static Intent A02(C1073Yn c1073Yn, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.addCategory(A06(212, 33, 67));
        intentA01.addFlags(268435456);
        intentA01.putExtra(A06(288, 34, 25), c1073Yn.getPackageName());
        intentA01.putExtra(A06(494, 14, 75), false);
        if (C0662Ih.A1b(c1073Yn)) {
            if (A06(508, 2, 21).equals(uri.getScheme())) {
                intentA01.setPackage(A06(412, 19, 121));
            }
        }
        return intentA01;
    }

    public static Intent A03(C1073Yn c1073Yn, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.setPackage(A06(322, 19, 20));
        intentA01.putExtra(A06(259, 8, 22), c1073Yn.getPackageName());
        intentA01.putExtra(A06(614, 7, 91), true);
        return intentA01;
    }

    private final EnumC02290g A04(C1073Yn c1073Yn, Uri uri, String str, Map<String, String> extraData) throws C0709Kh {
        boolean zA05 = AbstractC0663Ii.A05(c1073Yn);
        boolean isInAppBrowserEnabled = A0E(uri);
        if (isInAppBrowserEnabled && zA05) {
            A0B(c1073Yn, uri, str, extraData);
            return EnumC02290g.A07;
        }
        c1073Yn.A0E().A8f(zA05);
        A09(c1073Yn, uri);
        return EnumC02290g.A06;
    }

    public static EnumC02290g A05(C0721Kv c0721Kv, C1073Yn c1073Yn, Uri uri, String str, Map<String, String> extraData) throws C0709Kh {
        ...
        if (!isGooglePlayWebLink && !z10) {
            return c0721Kv.A04(c1073Yn, uri, str, extraData);
        }
        try {
            c0721Kv.A0A(c1073Yn, uri, str);
            return EnumC02290g.A02;
        } catch (C0719Kt unused) {
            return c0721Kv.A04(c1073Yn, uri, str, extraData);
        }
    }
    ...
    private void A09(C1073Yn c1073Yn, Uri uri) throws C0709Kh {
        C0711Kj.A0C(c1073Yn, A02(c1073Yn, uri));
    }

    private final void A0A(C1073Yn c1073Yn, Uri uri, String str) throws C0719Kt, C0709Kh {
        if (A0G(c1073Yn)) {
            boolean z10 = (c1073Yn.A0F().A01() && C0662Ih.A1F(c1073Yn)) || (C0662Ih.A1c(c1073Yn) && A0H(c1073Yn));
            if (!z10) {
                boolean shouldTryToOpenSplitScreen = C0662Ih.A1y(c1073Yn);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = C0711Kj.A0D(c1073Yn, A03(c1073Yn, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean shouldTryToOpenSplitScreen3 = A0K(c1073Yn, uri, str);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent intentA02 = A02(c1073Yn, uri);
            intentA02.setPackage(A06(322, 19, 20));
            if (Build.VERSION.SDK_INT >= 24 && z10) {
                intentA02.addFlags(268472320);
            }
            C0711Kj.A0C(c1073Yn, intentA02);
            return;
        }
        throw new C0719Kt();
    }

    private void A0B(C1073Yn c1073Yn, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent adActivityIntentA04 = C0711Kj.A04(c1073Yn);
        ...
        try {
            C0711Kj.A0A(c1073Yn, adActivityIntentA04);
        } catch (C0709Kh e5) {
            ...
            c1073Yn.A07().A9a(A06(168, 11, 15), C8A.A0D, new C8B(cause2));
            Log.e(A06(149, 17, 66), A06(50, 90, 123), cause2);
        }
    }

    public static void A0C(C0721Kv c0721Kv, C1073Yn c1073Yn, Uri uri, String str) {
        c0721Kv.A0L(c1073Yn, uri, str);
    }

    public static void A0D(C0721Kv c0721Kv, C1073Yn c1073Yn, Uri uri, String str) throws C0709Kh {
        A05(c0721Kv, c1073Yn, uri, str, null);
    }
    ...
    */
    public static boolean A0E(android.net.Uri r5) {
        /*
            ...
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.C0721Kv.A01
            r0 = 1
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L61:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C0721Kv.A0E(android.net.Uri):boolean");
    }

    private boolean A0F(C1073Yn c1073Yn) {
        if (!C0662Ih.A14(c1073Yn)) {
            return false;
        }
        int iA0D = C0662Ih.A0D(c1073Yn);
        if (A01[7].charAt(2) != 'a') {
            throw new RuntimeException();
        }
        A01[2] = "JMUKVK1n";
        int iA00 = A00(c1073Yn);
        return iA0D != -1 && iA00 != -1 && iA0D <= iA00 && Build.VERSION.SDK_INT >= 28;
    }

    private boolean A0G(C1073Yn c1073Yn) throws SecurityException {
        Intent playStoreIntent = new Intent(A06(186, 26, 50), AbstractC0724Ky.A00(A06(548, 34, 87)));
        Iterator<ResolveInfo> it = c1073Yn.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        while (it.hasNext()) {
    ...
    public static boolean A0H(C1073Yn c1073Yn) throws IllegalAccessException, NoSuchFieldException, Resources.NotFoundException, PackageManager.NameNotFoundException, IllegalArgumentException {
        boolean onAndAboveNOS = Build.VERSION.SDK_INT >= 24;
        boolean zA0I = A0I(c1073Yn);
        boolean z10 = onAndAboveNOS && zA0I;
        boolean supportsSplitScreenMultiWindow = true;
        boolean appResizingSupported = true;
        boolean zA0C = true;
        boolean onAndAboveNOS2 = C0662Ih.A1l(c1073Yn);
        if (onAndAboveNOS2) {
            Resources system = Resources.getSystem();
            String strA06 = A06(431, 26, 90);
            String strA062 = A06(245, 4, 8);
            String strA063 = A06(179, 7, 41);
            ...
            if (strArr[6].length() == strArr[3].length()) {
                ...
                zA0C = L6.A0C(c1073Yn);
                z10 &= supportsSplitScreenMultiWindow && appResizingSupported && zA0C;
                String[] strArr2 = A01;
        ...
        c1073Yn.A0E().AA7(zA0I, z10, supportsSplitScreenMultiWindow, appResizingSupported, zA0C);
        return z10;
    }

    public static boolean A0I(C1073Yn c1073Yn) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        Activity activityA0D;
        PackageManager packageManager;
        ActivityInfo activityInfo;
        try {
            activityA0D = c1073Yn.A0D();
            packageManager = c1073Yn.getPackageManager();
        } catch (PackageManager.NameNotFoundException | IllegalAccessException | NoSuchFieldException e5) {
            c1073Yn.A0E().AA5(e5.getMessage());
        }
    ...
    private boolean A0J(C1073Yn c1073Yn, Uri uri, String str) throws C0709Kh {
        try {
            Activity activityA0D = c1073Yn.A0D();
            String string = uri.toString();
            if (activityA0D != null && !TextUtils.isEmpty(string)) {
                Intent fbIntent = new Intent();
                if (C0662Ih.A15(c1073Yn)) {
                    String strA06 = AbstractC1176b5.A06(str);
                ...
                if (!C0711Kj.A0D(c1073Yn, fbIntent)) {
            ...
            c1073Yn.A0E().A9e(e5.getMessage());
            return false;
        }
    }

    private boolean A0K(C1073Yn c1073Yn, Uri uri, String str) throws C0709Kh {
        return A0F(c1073Yn) && A0J(c1073Yn, uri, str);
    }

    private final boolean A0L(C1073Yn c1073Yn, Uri uri, String str) {
        return C0711Kj.A0H(c1073Yn, uri, str);
    }

    public static boolean A0M(C0721Kv c0721Kv, C1073Yn c1073Yn, Uri uri, String str) {
        try {
            A0D(c0721Kv, c1073Yn, uri, str);
            return true;
        } catch (C0709Kh e5) {
            Throwable cause = e5.getCause();
            Throwable cause2 = e5;
            ...
            c1073Yn.A07().A9a(A06(168, 11, 15), C8A.A05, new C8B(cause2));
            return false;
        }
    }
}
