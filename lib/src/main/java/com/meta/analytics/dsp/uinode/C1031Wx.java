...
public final class C1031Wx implements InterfaceC0537Cy {
    ...
    public C1031Wx(String str) {
        this.A02 = 0;
        C0654Hz c0654Hz = new C0654Hz(4);
        this.A0A = c0654Hz;
        c0654Hz.A00[0] = -1;
        this.A09 = new By();
        this.A0B = str;
    ...
    */
    private void A00(com.meta.analytics.dsp.uinode.C0654Hz r9) {
        /*
            r8 = this;
            byte[] r6 = r9.A00
            int r5 = r9.A06()
        ...
        L42:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.C1031Wx.A00(com.facebook.ads.redexgen.X.Hz):void");
    }

    private void A01(C0654Hz c0654Hz) {
        int iMin = Math.min(c0654Hz.A04(), this.A01 - this.A00);
        this.A05.AFR(c0654Hz, iMin);
    ...
    private void A02(C0654Hz c0654Hz) {
        int iMin = Math.min(c0654Hz.A04(), 4 - this.A00);
        c0654Hz.A0c(this.A0A.A00, this.A00, iMin);
        int i10 = this.A00 + iMin;
        this.A00 = i10;
        if (i10 < 4) {
            return;
        }
    ...
    public final void A4p(InterfaceC0513Bu interfaceC0513Bu, DC dc2) {
        dc2.A05();
        this.A06 = dc2.A04();
        this.A05 = interfaceC0513Bu.AGi(dc2.A03(), 1);
    }
