...
public final class SH extends FrameLayout implements QB {
    ...
    public SH(C1073Yn c1073Yn, NativeAd nativeAd, JR jr, JS js, O3 o32, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1073Yn);
        ArrayList<View> arrayList = new ArrayList<>();
        this.A07 = arrayList;
        this.A05 = nativeAd;
        this.A04 = mediaView;
        QC qc = new QC(c1073Yn, nativeAd, jr, o32, adOptionsView);
        this.A06 = qc;
        int i10 = A0C;
        qc.setPadding(i10, i10, i10, A0E);
    ...
    */
    private int A00() {
        ...
        L11:
            ...
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.SH.A08
            r0 = 1
            r1 = r1[r0]
            r0 = 0
            ...
            if (r1 == r0) goto L97
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.SH.A08
        ...
        L4b:
            ...
            int r0 = com.meta.analytics.dsp.uinode.SH.A0C
            int r3 = r3 + r0
            int r0 = com.meta.analytics.dsp.uinode.SH.A0D
            int r3 = r3 + r0
        L7b:
        ...
        L97:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.SH.A00():int");
    }
    ...
    private void A02(int i10) {
        AbstractC0740Lo.A0N(this.A04, i10 > A0B ? 0 : 8);
        AbstractC0740Lo.A0N(this.A03, i10 > A0A ? 0 : 8);
        AbstractC0740Lo.A0N(this.A00, i10 <= A09 ? 8 : 0);
    }

    public static void A03(int i10, int i11, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            if (textView != null && textView.getVisibility() == 0) {
                int iA04 = AbstractC0740Lo.A04(textView, i11);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (emptySpace2 == 0) {
            ...
            if (emptySpace3 == 0 || ((ZH) this.A04.getMediaViewApi()).A0N()) {
                ...
                float f5 = emptySpace4;
                int emptySpace5 = this.A04.getMediaWidth();
                float aspectRatio = f5 / emptySpace5;
        ...
        mediaView.measure(i10, mediaViewHeight);
        if (emptySpace < requiredHeight) {
            A03(i10, requiredHeight - emptySpace, this.A02, this.A00, this.A03);
        }
    }
