...
public final class A8 {
    ...
    public A8(A6 a62, A7 a72, AH ah, int i10, Handler handler) {
        this.A0A = a62;
        this.A0B = a72;
        this.A0C = ah;
        this.A03 = handler;
    ...
    public final synchronized boolean A0C() throws InterruptedException {
        AbstractC0629Ha.A04(this.A09);
        AbstractC0629Ha.A04(this.A03.getLooper().getThread() != Thread.currentThread());
        while (!this.A08) {
            wait();
        }
        return this.A07;
