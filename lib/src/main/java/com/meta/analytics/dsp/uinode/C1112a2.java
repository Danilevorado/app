...
public class C1112a2 extends AnonymousClass36 {
    ...
    public final View.AccessibilityDelegate A00(final AnonymousClass37 anonymousClass37) {
        return new View.AccessibilityDelegate() { // from class: com.facebook.ads.redexgen.X.34
            ...
            public final AccessibilityNodeProvider getAccessibilityNodeProvider(View view) {
                C03203u provider = anonymousClass37.A01(view);
                if (provider != null) {
            ...
            public final void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
                anonymousClass37.A08(view, C03183s.A01(accessibilityNodeInfo));
            }
    ...
    @Override // com.meta.analytics.dsp.uinode.AnonymousClass36
    public final C03203u A01(View.AccessibilityDelegate accessibilityDelegate, View view) {
        AccessibilityNodeProvider accessibilityNodeProvider = accessibilityDelegate.getAccessibilityNodeProvider(view);
        if (accessibilityNodeProvider != null) {
            return new C03203u(accessibilityNodeProvider);
        }
        return null;
    }
