...
public final class AnonymousClass80 implements Thread.UncaughtExceptionHandler {
    ...
    public AnonymousClass80(Thread.UncaughtExceptionHandler uncaughtExceptionHandler, C1072Ym c1072Ym, InterfaceC04167z interfaceC04167z) {
        this(uncaughtExceptionHandler, c1072Ym, interfaceC04167z, AnonymousClass88.A00());
    }

    public AnonymousClass80(Thread.UncaughtExceptionHandler uncaughtExceptionHandler, C1072Ym c1072Ym, InterfaceC04167z interfaceC04167z, AnonymousClass87 anonymousClass87) {
        this.A02 = uncaughtExceptionHandler;
        if (c1072Ym != null) {
            this.A00 = c1072Ym;
            this.A03 = interfaceC04167z.A7z(c1072Ym);
        ...
        try {
            ...
            if (!TextUtils.isEmpty(strA03)) {
                ...
                if (strA03.contains(stackTraceString)) {
                    Map<String, String> mapA02 = new C04157y(strA03, this.A03).A02();
                    ...
                    if (C0662Ih.A1h(this.A00)) {
                        C0662Ih.A0a(this.A00);
                    }
                }
            }
