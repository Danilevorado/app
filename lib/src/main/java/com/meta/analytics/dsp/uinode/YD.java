...
public final class YD implements C8w {
    ...
    public final AnonymousClass97<C0678Iz> A01;
    public final AnonymousClass97<C0678Iz> A02;
    ...
    */
    ...
    public YD(C1072Ym c1072Ym) throws IOException {
        this.A00 = c1072Ym;
        this.A01 = new YA(AnonymousClass94.A00(A00(11, 28, 31), c1072Ym), new YF(this));
        this.A02 = new YA(AnonymousClass94.A00(A00(322, 37, 102), c1072Ym), new YE(this));
    }
    ...
    public void A04(int i10, String str) {
        C8B c8b = new C8B(str);
        c8b.A05(1);
        this.A00.A07().A9b(A00(425, 15, 107), i10, c8b);
    }

    private void A05(int i10, Throwable th) {
        this.A00.A07().A9a(A00(425, 15, 107), i10, new C8B(th));
    }

    public static byte[] A07(C04017f c04017f, String str, C0678Iz c0678Iz) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put(A00(423, 2, 0), str);
            jSONObject.put(A00(466, 5, 3), c0678Iz.A08());
            jSONObject.put(A00(471, 4, 106), c0678Iz.A06().toString());
            jSONObject.put(A00(462, 4, 86), C0731Lf.A02(c0678Iz.A04()));
            jSONObject.put(A00(450, 12, 27), C0731Lf.A02(c0678Iz.A03()));
            jSONObject.put(A00(440, 10, 116), c0678Iz.A07());
            jSONObject.put(A00(419, 4, 62), new JSONObject(c0678Iz.A09()));
            jSONObject.put(A00(412, 7, 26), 0);
        } catch (JSONException e5) {
            if (c04017f.A04().A8z()) {
                Log.e(A04, A00(294, 28, 12), e5);
            }
        }
    ...
    */
    ...
    @Override // com.meta.analytics.dsp.uinode.C8w
    public final void AHE(final C0678Iz c0678Iz, final AbstractC04368t<String> abstractC04368t) {
        Executor executor = ExecutorC0745Lt.A07;
        final AnonymousClass97<C0678Iz> anonymousClass97 = this.A01;
        final C1072Ym c1072Ym = this.A00;
        AbstractC0742Lq.A00(executor, new AsyncTask<Void, Void, String>(c0678Iz, abstractC04368t, anonymousClass97, c1072Ym) { // from class: com.facebook.ads.redexgen.X.8x
            ...
            public final AbstractC04368t<String> A02;
            public final AnonymousClass97<C0678Iz> A03;
            public final C0678Iz A04;
            ...
            private final String A01(Void... voidArr) throws Throwable {
                ...
                try {
                    try {
                        ...
                        this.A00 = e5;
                        this.A01.A07().A9a(A00(44, 15, 76), C8A.A2N, new C8B(e5));
                    }
