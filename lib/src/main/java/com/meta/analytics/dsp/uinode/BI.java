...
public final class BI extends AbstractC0940Tg {
    ...
    public BI(OP op) {
        ...
        C0938Te c0938Te = new C0938Te(this);
        this.A0A = c0938Te;
        this.A0B = new O1(op, getAdDataBundle(), saA01, kpA02, getAdDetailsView(), mcA09, c0938Te);
        ...
        if (supported.A00) {
            ...
            if (!C0662Ih.A18(getAdContextWrapper())) {
                return;
            }
            AbstractC0789Nl.A00(saA01.getVideoImplView(), C0662Ih.A19(getAdContextWrapper()), new OT(this));
        }
    }
    ...
    private SA A01(OP op) {
        ...
        int i10 = AbstractC0940Tg.A0F;
        int i11 = AbstractC0940Tg.A0F;
        int toolbarHeight = AbstractC0940Tg.A0F;
        imageView.setPadding(i10, i11, toolbarHeight, AbstractC0940Tg.A0F);
        int toolbarHeight2 = AbstractC0940Tg.A0G;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC0940Tg.A0G);
        int toolbarHeight3 = AbstractC0940Tg.A0E;
        layoutParams.setMargins(0, iA13, toolbarHeight3, 0);
        layoutParams.addRule(11);
        layoutParams.addRule(10);
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
        layoutParams2.addRule(13);
        addView(sa2, layoutParams2);
        sa2.addView(imageView, layoutParams);
        return sa2;
    }

    private KP A02(OP op) {
        KP kpA0A = op.A0A();
        kpA0A.A06(-1, AbstractC0940Tg.A0B);
        kpA0A.setPadding(AbstractC0940Tg.A0J, AbstractC0940Tg.A0J, AbstractC0940Tg.A0J, AbstractC0940Tg.A0J);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0940Tg.A0I);
    ...
    private void A05() {
        ...
        this.A06 = new KA(mb2, 400, -mb2.getToolbarHeight(), 0);
    }
    ...
    private void A06() {
        ...
        AbstractC0740Lo.A0H(this.A0C);
        AbstractC0740Lo.A0a(this.A0C, this.A0D, this.A0B, this.A00);
        AbstractC0740Lo.A0L(this.A04);
        Q5 q52 = this.A05;
        ...
        Pair<Q4, View> pairA03 = q52.A03(ctaButton);
        ...
        switch (OU.A00[((Q4) pairA03.first).ordinal()]) {
            case 1:
                ...
                break;
            case 2:
                AbstractC0740Lo.A0a(getAdDetailsView());
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC0940Tg.A0H, AbstractC0940Tg.A0H, AbstractC0940Tg.A0H, AbstractC0940Tg.A0H);
        ...
        if (getAdInfo().A0G().A00() >= 0) {
            ...
            MB mb2 = this.A04;
            if (mb2 != null) {
                mb2.setToolbarActionMode(2);
                this.A04.setProgressImmediate(0.0f);
            }
            L9 l92 = new L9((int) getAdInfo().A0G().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C0937Td(this));
            this.A03 = l92;
            l92.A07();
        }
    }
    ...
    */
    public final boolean A12(boolean r6) {
        /*
            ...
            boolean r3 = r0.get()
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.BI.A0G
            r0 = 7
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L33:
            ...
            boolean r3 = r0.A0O()
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.BI.A0G
            r0 = 5
            r1 = r1[r0]
            r0 = 17
            ...
            com.facebook.ads.redexgen.X.QH r0 = com.meta.analytics.dsp.uinode.QH.A08
            r1.A0a(r0)
            return r4
        L63:
            r0 = 0
        ...
        L65:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.BI.A12(boolean):boolean");
    }

    @Override // com.meta.analytics.dsp.uinode.AbstractC0940Tg
    ...
    @Override // com.meta.analytics.dsp.uinode.AbstractC0940Tg, com.meta.analytics.dsp.uinode.OL, android.view.View
