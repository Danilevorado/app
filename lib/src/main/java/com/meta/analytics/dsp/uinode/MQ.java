...
public final class MQ extends RelativeLayout {
    ...
    public MQ(C1073Yn c1073Yn, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1073Yn);
        TextView textView = new TextView(c1073Yn);
        this.A05 = textView;
        Button button = new Button(c1073Yn);
        this.A02 = button;
        Button button2 = new Button(c1073Yn);
        this.A01 = button2;
        ImageView imageView = new ImageView(c1073Yn);
        this.A03 = imageView;
        this.A04 = new LinearLayout(c1073Yn);
        ...
        if (textView2 != null) {
            ...
            AbstractC0740Lo.A0X(this.A00, false, 18);
        }
        imageView.setImageBitmap(bitmap);
        imageView.setColorFilter(i10);
        button.setText(str3);
        AbstractC0740Lo.A0X(button, true, 18);
        button.setAllCaps(true);
        button.setTextColor(i11);
        int i12 = A06;
        button.setPadding(i12, i12, i12, i12);
        button2.setText(str4);
        AbstractC0740Lo.A0X(button2, true, 18);
        button2.setAllCaps(true);
        button2.setTextColor(i10);
        button2.setPadding(i12, i12, i12, i12);
        int iA01 = AbstractC02892p.A01(i11, 20);
        int i13 = A07;
        AbstractC0740Lo.A0O(button, i10, i13);
        AbstractC0740Lo.A0O(button2, iA01, i13);
        A00();
        setGravity(17);
    }
