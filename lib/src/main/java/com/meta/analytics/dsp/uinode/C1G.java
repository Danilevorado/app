...
public final class C1G implements Serializable {
    ...
    public static C1G A00(JSONObject jSONObject) {
        ...
        C1I c1iA0I = new C1I().A0J(jSONObject.optString(A01(496, 9, 21))).A0H(jSONObject.optLong(A01(472, 24, 61), -1L)).A0D(iOptInt).A0C(jSONObject.optInt(A01(274, 18, 10), Integer.MAX_VALUE)).A0I(C02501c.A01(jSONObject));
        ...
        if (jSONObjectOptJSONObject != null) {
            ...
            if (unskippableSeconds == 16) {
                ...
                c1iA0G.A0F(jSONObjectOptJSONObject.optInt(A01(186, 6, 84)));
            }
            throw new RuntimeException();
        }
        c1g.A04(c1iA0I);
    ...
    public static String A02(JSONObject jSONObject) {
        ...
        if (strOptString.equals(strA012)) {
            JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A01(174, 12, 113));
            if (jSONObjectOptJSONObject != null) {
