...
public final class C0662Ih {
    public static C0662Ih A01;
    ...
    public C0662Ih(Context context) {
    ...
    private final float A01(String str, float f5) throws NumberFormatException {
        String string = this.A00.getString(str, String.valueOf(f5));
        if (string != null) {
            try {
    ...
    public static int A0H(Context context) {
        return A0R(context).A2T(A0S(3408, 32, 86), AdError.SERVER_ERROR_CODE);
    }
    ...
    public static synchronized C0662Ih A0R(Context context) {
        if (A01 == null) {
            A01 = new C0662Ih(context);
        }
        return A01;
    }
    ...
    public static boolean A11(Context context) {
        ...
        C0662Ih c0662IhA0R = A0R(context);
        ...
        return c0662IhA0R.A2Z(strA0S, false);
    }
    ...
    public static boolean A1n(Context context) {
        return A0R(context).A2Z(A0S(AdError.INTERNAL_ERROR_2004, 27, 98), false);
    }
    ...
    public static boolean A2Q(Context context, boolean z10) {
        return A2S(context, z10) && A0R(context).A2Z(A0S(2489, 27, 96), false);
    }

    public static boolean A2R(Context context, boolean z10) {
        return Build.VERSION.SDK_INT >= 21 && A2Q(context, z10) && A0R(context).A2Z(A0S(2516, 35, 69), true);
    }

    public static boolean A2S(Context context, boolean z10) {
        return z10 && Build.VERSION.SDK_INT >= 19 && A0R(context).A2Z(A0S(2551, 24, 14), false);
    }

    public final int A2T(String str, int i10) throws NumberFormatException {
    ...
    public final long A2U(String str, long j10) throws NumberFormatException {
    ...
    public final boolean A2Z(String str, boolean z10) {
        ...
        if (string != null) {
            ...
            return zEquals ? z10 : Boolean.parseBoolean(string);
        }
        return z10;
    }
}
