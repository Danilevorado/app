...
public final class C0795Nr {
    ...
    public AbstractC1176b5 A00;
    public InterfaceC0794Nq A01;
    public OG A02;
    public boolean A03;
    public boolean A04;
    ...
    public C0795Nr(C1073Yn c1073Yn, String str, RE re, C0732Lg c0732Lg, J2 j22, C1U c1u) {
        this(c1073Yn, str, re, c0732Lg, j22, c1u, new C0946Tm());
    }

    public C0795Nr(C1073Yn c1073Yn, String str, RE re, C0732Lg c0732Lg, J2 j22, C1U c1u, MC mc) {
        this.A03 = true;
        this.A06 = c1073Yn;
        this.A0B = str;
        this.A0A = re;
    ...
    private void A02(String str, String str2, Map<String, String> map) {
        ...
        try {
            AbstractC0740Lo.A0Z(map, this.A00);
            AbstractC02300h abstractC02300hA01 = C02310i.A01(this.A06, this.A07, str, AbstractC0724Ky.A00(str2), new C0786Ni(map).A03(this.A0A).A02(this.A08).A05(), this.A03, this.A04, this.A05);
            if (abstractC02300hA01 instanceof C0587Fg) {
                ((C0587Fg) abstractC02300hA01).A0H(this.A02);
            }
            EnumC02290g actionOutcome = EnumC02290g.A08;
            if (abstractC02300hA01 != null) {
                actionOutcome = abstractC02300hA01.A0C();
            }
            if (!(((abstractC02300hA01 instanceof C0585Fe) || (abstractC02300hA01 instanceof C0587Fg)) && AbstractC0740Lo.A0e(this.A06, actionOutcome, map)) && actionOutcome != EnumC02290g.A05) {
                InterfaceC0794Nq interfaceC0794Nq = this.A01;
                if (interfaceC0794Nq != null) {
                    interfaceC0794Nq.ABE();
                }
                this.A09.A43(this.A0B);
            }
        } catch (ActivityNotFoundException e5) {
            Log.e(strA00, A00(44, 20, 100) + str2, e5);
        } catch (Exception e10) {
            Log.e(strA00, A00(22, 22, 95), e10);
        }
    }

    public static boolean A03(C1073Yn c1073Yn) {
        boolean isIABBottomSheetEnabled = C0662Ih.A2N(c1073Yn);
        int iA06 = C0662Ih.A06(c1073Yn);
    ...
    public final void A04(AbstractC1176b5 abstractC1176b5) {
        this.A00 = abstractC1176b5;
    }

    public final void A05(InterfaceC0794Nq interfaceC0794Nq) {
        this.A01 = interfaceC0794Nq;
    }
