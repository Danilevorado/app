...
public final class C9E implements Closeable {
    ...
    private C9D A00() throws IOException {
        ...
        int i10 = iA00 + 1;
        this.A02.add(new C9D(i10, new C9A(new File(this.A01.A05(), A01(i10)))));
    ...
    private void A05(AnonymousClass94 anonymousClass94, C9C c9c) throws NumberFormatException, IOException {
        ...
        if (fileArrListFiles != null) {
            ...
            for (File file : fileArrListFiles) {
                try {
                    int i10 = Integer.parseInt(file.getName());
                    map.put(Integer.valueOf(i10), file);
                    if (i10 > fileNumber) {
                        fileNumber = i10;
                    }
            ...
            if (!map.isEmpty()) {
                ...
                while (fileNumber >= fileNumberToLoad) {
                    ...
                    try {
                        ...
                        c9c.AFG(String.format(Locale.US, A02(104, 62, 43), file2.getCanonicalPath(), Integer.valueOf(fileNumber)), e5);
