...
public abstract class AbstractC0852Pw {
    ...
    public static BitmapDrawable A00(C1073Yn c1073Yn, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1073Yn, overlayBm))) {
                ...
                Resources resources = c1073Yn.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c1073Yn, A02(0, 23, 116));
                    }
                } else {
                    A04(c1073Yn, A02(23, 18, 112));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th) {
            c1073Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(th));
            return null;
        }
    }

    public static C0853Px A01(C1073Yn c1073Yn, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c1073Yn, str)) == null) {
                return null;
            }
            C0853Px overlayView = new C0853Px(c1073Yn);
    ...
    public static void A04(C1073Yn c1073Yn, String str) {
        c1073Yn.A07().A9a(A02(59, 3, 42), C8A.A1u, new C8B(str));
    }
    ...
    */
    public static boolean A05(com.meta.analytics.dsp.uinode.C1073Yn r5, android.graphics.Bitmap r6) {
        /*
            r3 = 0
        L1:
            int r4 = r6.getWidth()
            java.lang.String[] r1 = com.meta.analytics.dsp.uinode.AbstractC0852Pw.A02
            r0 = 2
            r1 = r1[r0]
            r0 = 4
            ...
            if (r1 == r0) goto L4d
            java.lang.String[] r2 = com.meta.analytics.dsp.uinode.AbstractC0852Pw.A02
        ...
        L4d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.AbstractC0852Pw.A05(com.facebook.ads.redexgen.X.Yn, android.graphics.Bitmap):boolean");
    }
}
