...
public final class CI implements WP, WQ {
    ...
    public CI(WP wp, boolean z10, long j10, long j11) {
        this.A05 = wp;
    ...
    private AD A00(long j10, AD ad) {
        long toleranceBeforeUs = IF.A0E(ad.A01, 0L, j10 - this.A01);
        long j11 = ad.A00;
        long j12 = this.A00;
        long jA0E = IF.A0E(j11, 0L, j12 == Long.MIN_VALUE ? Long.MAX_VALUE : j12 - j10);
    ...
    public static boolean A02(long j10, InterfaceC0610Gg[] interfaceC0610GgArr) {
        if (j10 != 0) {
            for (InterfaceC0610Gg interfaceC0610Gg : interfaceC0610GgArr) {
                if (interfaceC0610Gg != null && !AbstractC0647Hs.A09(interfaceC0610Gg.A7u().A0O)) {
                    return true;
                }
            }
        }
    ...
    public final long A5x(long j10, AD ad) {
        ...
        return this.A05.A5x(j10, A00(j10, ad));
    }
    ...
    public final long A7U() {
        ...
        if (jA7U != Long.MIN_VALUE) {
            long j10 = this.A00;
            if (j10 == Long.MIN_VALUE || jA7U < j10) {
                return jA7U;
            }
        }
        return Long.MIN_VALUE;
    ...
    */
    public final long AFl(long r10) {
        ...
        L50:
            r8 = 1
        L51:
            com.meta.analytics.dsp.uinode.AbstractC0629Ha.A04(r8)
            return r6
        */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final long AFm(com.meta.analytics.dsp.uinode.InterfaceC0610Gg[] r16, boolean[] r17, com.meta.analytics.dsp.uinode.FB[] r18, boolean[] r19, long r20) {
        /*
            r15 = this;
            r4 = r18
            int r0 = r4.length
