...
public final class VP implements J0 {
    ...
    public VP(C1072Ym c1072Ym, YH yh) {
        this.A00 = c1072Ym;
        this.A01 = yh;
    }

    public static JSONArray A01(C1072Ym c1072Ym, JSONArray jSONArray, JSONArray jSONArray2) {
        int i10 = 0;
        if (jSONArray != null) {
        ...
        return A02(c1072Ym, jSONArray, jSONArray2, i10);
    }
    ...
    */
    public static org.json.JSONArray A02(com.meta.analytics.dsp.uinode.C1072Ym r19, org.json.JSONArray r20, org.json.JSONArray r21, int r22) throws org.json.JSONException {
        /*
            Method dump skipped, instructions count: 263
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.VP.A02(com.facebook.ads.redexgen.X.Ym, org.json.JSONArray, org.json.JSONArray, int):org.json.JSONArray");
    }
    ...
    private JSONObject A03() throws JSONException {
        ...
        if (Ij.A0P(this.A00) && (jSONArrayA03 = C8C.A03(this.A00)) != null && jSONArrayA03.length() > 0) {
            ...
            jSONArrayA5y = A01(c1072Ym, jSONArrayA03, jSONArrayA5y);
        }
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                if (A00(393, 26, 8).equals(string)) {
                    C0662Ih.A0R(this.A00).A2X(jSONObject.getString(A00(419, 14, 47)));
                    this.A00.A03().AAL();
                } else {
                    ...
                    if (i11 == 1) {
                        ...
                        if (i11 >= 1000 && i11 < 2000) {
                            if (this.A00.A04().A8z()) {
                                Log.e(A04, A00(236, 37, 17) + i11 + strA002 + string + strA00);
                            }
                            A06(string);
                            z10 = false;
                        } else if (i11 >= 2000 && i11 < 3000) {
                            if (this.A00.A04().A8z()) {
                                Log.e(A04, A00(195, 41, 9) + i11 + strA002 + string + strA00);
                            }
                            if (!this.A01.A53(string) && zA0P) {
                                C8C.A0D(string);
                            }
                ...
                if (this.A00.A04().A8z()) {
                    Log.e(A04, A00(331, 44, 82) + i10 + strA00, e5);
                }
                z10 = false;
            }
        }
