...
public class C03083i {
    ...
    public boolean A07(ViewParent viewParent, View view, float f5, float f10) {
        if (0 != 0) {
    ...
    public boolean A08(ViewParent viewParent, View view, float f5, float f10, boolean z10) {
        if (0 != 0) {
