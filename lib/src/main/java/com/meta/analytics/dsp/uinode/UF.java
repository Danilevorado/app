...
public class UF implements L8 {
    ...
    public final void ACm(float f5) {
        ...
        if (this.A00.A0V) {
            if (this.A00.A0B) {
                fA03 = 1.0f - (f5 / this.A00.A0F.A0x().A0D().A02());
                if (this.A00.A0E || fA03 < 1.0f) {
                    ...
                    this.A00.A0W.setToolbarActionMessage(strA02.replace(A00(0, 6, 65), String.valueOf((int) f5)));
                } else {
                    this.A00.A0E = true;
                    this.A00.A0W.setToolbarActionMessage(A00(0, 0, 7));
                }
            } else {
                fA03 = 1.0f - (f5 / this.A00.A0F.A0x().A0D().A03());
            }
            this.A00.A0W.setProgress(100.0f * fA03);
            float fA02 = this.A00.A0F.A0x().A0D().A02() - f5;
            float percentageOfReward = this.A00.A0F.A0x().A0D().A03();
            boolean z10 = fA02 >= percentageOfReward;
            if (!this.A00.A0E && z10) {
                this.A00.A0W.setToolbarActionMode(1);
                return;
            }
        ...
        this.A00.A0W.setProgress(100.0f * (1.0f - (f5 / this.A00.A0G.A07())));
    }
}
