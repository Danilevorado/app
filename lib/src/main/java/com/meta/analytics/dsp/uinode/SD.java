...
public class SD extends KT {
    ...
    public final void A06() {
        ...
        if (rb2 == rb3) {
            ...
            C04348r c04348r = this.A02.A0B;
            int i10 = this.A01;
            c04348r.A02(new C9H(i10, i10));
            this.A02.A0K(this.A01);
            return;
        }
        if (this.A03 == RB.A0A) {
            if (C0662Ih.A1W(this.A02.A0A)) {
        ...
        if (this.A03 == RB.A05) {
            ...
            C04348r c04348r2 = this.A02.A0B;
            final int i11 = this.A00;
            c04348r2.A02(new AbstractC0851Pv(i11) { // from class: com.facebook.ads.redexgen.X.98
            });
            this.A02.A07.removeCallbacksAndMessages(null);
            this.A02.A0K(this.A00);
            return;
