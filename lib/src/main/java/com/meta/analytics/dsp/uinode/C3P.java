...
public abstract class C3P extends C0556Eb implements View.OnTouchListener {
    ...
    public C3P(C1073Yn c1073Yn, AttributeSet attributeSet) {
    ...
    public C3P(C1073Yn c1073Yn, AttributeSet attributeSet, int i10) {
    ...
    public void setLayoutManager(AbstractC03394o abstractC03394o) {
        if (abstractC03394o instanceof C1099Zo) {
            super.setLayoutManager(abstractC03394o);
            this.A01 = (C1099Zo) abstractC03394o;
            return;
        }
        throw new IllegalArgumentException(A09(0, 50, 58));
    }

    public void setSnapDelegate(InterfaceC0842Pm interfaceC0842Pm) {
        this.A02 = interfaceC0842Pm;
    }
}
