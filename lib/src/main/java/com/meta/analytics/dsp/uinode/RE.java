...
public final class RE {
    ...
    */
    public static int A08(java.util.Vector<android.graphics.Rect> r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meta.analytics.dsp.uinode.RE.A08(java.util.Vector):int");
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 9 out of bounds for length 9
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static RF A0E(View view, int i10, C1073Yn c1073Yn) {
        if (view == null) {
            A0N(null, false, A0H(353, 16, 31));
            return new RF(C0Q.A08);
        }
        boolean zA2H = C0662Ih.A2H(c1073Yn);
        ...
        if (A0H[4].charAt(15) == 'A') {
            ...
            try {
                ...
                if (A0H[1].length() == 16) {
                    ...
                    if (i11 >= 17) {
                        ((WindowManager) c1073Yn.getSystemService(A0H(594, 6, 109))).getDefaultDisplay().getRealMetrics(new DisplayMetrics());
                    } else {
                    ...
                    Map<String, String> mapA01 = M6.A01(c1073Yn);
                    if (C0741Lp.A04(mapA01)) {
                        A0N(view, false, A0H(156, 29, 77));
                        return new RF(C0Q.A0A, fA08);
                    }
                    if (C0662Ih.A1d(c1073Yn) && C0741Lp.A03(mapA01)) {
    ...
    public RE(View view, int i10, int i11, boolean z10, WeakReference<RD> weakReference, C1073Yn c1073Yn) {
    ...
    public RE(View view, int i10, WeakReference<RD> weakReference, C1073Yn c1073Yn) {
        this(view, i10, 0, false, weakReference, c1073Yn);
    }

    public RE(View view, int i10, boolean z10, WeakReference<RD> weakReference, C1073Yn c1073Yn) {
        this(view, i10, 0, z10, weakReference, c1073Yn);
    }
    ...
    public static Vector<Rect> A0K(View view) {
        ...
        for (int iIndexOfChild = viewGroup.indexOfChild(view) + 1; iIndexOfChild < viewGroup.getChildCount(); iIndexOfChild++) {
            ...
            boolean z10 = true;
            boolean z11 = !(childAt instanceof C0853Px);
    ...
    public final synchronized Map<String, String> A0S() {
        ...
        map.put(A0H(592, 2, 68), C0731Lf.A05(this.A03));
