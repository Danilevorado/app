...
public final class C1059Xz implements InterfaceC0485As {
    ...
    public final /* synthetic */ C1058Xy A00;
    ...
    public C1059Xz(C1058Xy c1058Xy) {
        this.A00 = c1058Xy;
    }

    public /* synthetic */ C1059Xz(C1058Xy c1058Xy, C0488Av c0488Av) {
        this(c1058Xy);
    }

    @Override // com.meta.analytics.dsp.uinode.InterfaceC0485As
    ...
    public final void ACi(long j10, long j11, long j12, long j13) {
        StringBuilder sbAppend = new StringBuilder().append(A00(53, 52, 29)).append(j10);
        String strA00 = A00(0, 2, 44);
        String string = sbAppend.append(strA00).append(j11).append(strA00).append(j12).append(strA00).append(j13).append(strA00).append(this.A00.A03()).append(strA00).append(this.A00.A04()).toString();
        if (!C1058Xy.A0q) {
            String message = A00(2, 10, 112);
            Log.w(message, string);
            return;
        }
        throw new C0491Ay(string, null);
    }

    @Override // com.meta.analytics.dsp.uinode.InterfaceC0485As
    public final void ADH(long j10, long j11, long j12, long j13) {
        StringBuilder sbAppend = new StringBuilder().append(A00(105, 50, 113)).append(j10);
        String strA00 = A00(0, 2, 44);
        String string = sbAppend.append(strA00).append(j11).append(strA00).append(j12).append(strA00).append(j13).append(strA00).append(this.A00.A03()).append(strA00).append(this.A00.A04()).toString();
        if (C1058Xy.A0q) {
            throw new C0491Ay(string, null);
    ...
    public final void ADQ(int i10, long j10) {
        if (this.A00.A0R != null) {
            this.A00.A0R.ADR(i10, j10, SystemClock.elapsedRealtime() - this.A00.A0E);
        }
    }
}
