...
public final class C8J {
    ...
    public static void A0A(C04017f c04017f) {
        try {
            c04017f = AbstractC0723Kx.A00(c04017f, null, new IntentFilter(A01(24, 37, 122)));
            if (c04017f == 0) {
                return;
            }
            int intExtra = c04017f.getIntExtra(A01(109, 5, 89), -1);
            int scale = c04017f.getIntExtra(A01(123, 5, 3), -1);
            int level = c04017f.getIntExtra(A01(134, 6, 71), -1);
            ...
            if (scale > 0) {
                f5 = (intExtra / scale) * 100.0f;
            }
            A05.put(A01(77, 7, 113), String.valueOf(f5));
            A05.put(A01(84, 8, 75), z10 ? A01(1, 1, 117) : A01(0, 1, 33));
        } catch (IllegalArgumentException e5) {
            c04017f.A07().A9a(A01(102, 7, 57), C8A.A1T, new C8B(e5));
        }
    }

    public static synchronized void A0B(C04017f c04017f) {
        A09(c04017f);
        A0A(c04017f);
        if (A04 == null) {
            SensorManager sensorManager = (SensorManager) c04017f.getSystemService(A01(128, 6, 67));
            A04 = sensorManager;
            if (sensorManager == null) {
                return;
            }
