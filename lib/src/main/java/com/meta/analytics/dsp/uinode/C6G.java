...
public abstract class C6G {
    ...
    public static C6F A00(ContentResolver contentResolver) {
        ...
        Cursor c10 = null;
        try {
            c10 = contentResolver.query(AbstractC0724Ky.A00(A01(12, 60, 38)), new String[]{strA013, strA012, strA01}, null, null, null);
            ...
            C6F c6f = new C6F(string, attributionId, Boolean.valueOf(c10.getString(c10.getColumnIndex(strA01))).booleanValue());
            if (c10 != null) {
                c10.close();
            }
            return c6f;
