...
public final class C03545e implements InterstitialAdApi, Repairable {
    ...
    public C03545e(Context context, String str, InterstitialAd interstitialAd) {
        this.A00 = interstitialAd;
        String string = UUID.randomUUID().toString();
        C1073Yn c1073YnA06 = C03525c.A06(context, string);
        this.A03 = c1073YnA06;
        C0S c0sA0E = c1073YnA06.A0E();
        String adId = AdPlacementType.INTERSTITIAL.toString();
        c0sA0E.A2s(adId, str);
        AnonymousClass26 anonymousClass26 = new AnonymousClass26(c1073YnA06, interstitialAd, str);
    ...
    public final void A05(EnumSet<CacheFlag> enumSet, String str) {
        AbstractC0692Jp.A05(A00(129, 8, 2), A00(65, 30, 1), A00(16, 8, 113));
        if (str == null) {
            this.A03.A0E().A2p();
        } else {
            this.A03.A0E().A2o();
    ...
    public final void destroy() {
        AbstractC0692Jp.A05(A00(122, 7, 20), A00(40, 25, 28), A00(0, 8, 49));
    ...
    public final void loadAd(InterstitialAd.InterstitialLoadAdConfig interstitialLoadAdConfig) {
        ((C03555f) interstitialLoadAdConfig).A00();
    }
    ...
    public final boolean show() {
        AbstractC0692Jp.A05(A00(137, 4, 64), A00(95, 27, 39), A00(8, 8, 7));
        this.A03.A0E().A2y();
        boolean zA0H = this.A02.A0H(this.A00, new C03565g());
