...
public abstract class AbstractC04318o {
    ...
    public static String A01(C04017f c04017f) {
        return WebSettings.getDefaultUserAgent(c04017f);
    }

    public static String A02(final C04017f c04017f) {
        FutureTask futureTask = new FutureTask(new Callable<String>() { // from class: com.facebook.ads.redexgen.X.8n
            ...
            public final String call() {
                String browserUserAgent = (String) AbstractC04318o.A04.get();
                if (browserUserAgent != null) {
                    return browserUserAgent;
                }
                WebView webView = new WebView(c04017f.getApplicationContext());
                ...
                if (userAgentString != null) {
                    AbstractC04318o.A04.set(userAgentString);
                }
                return userAgentString;
            }
        });
        for (int i10 = 0; i10 < 3; i10++) {
            ExecutorC0734Li.A00(futureTask);
            try {
    ...
    public static String A03(C04017f c04017f, C8K c8k) {
        ...
        if (TextUtils.isEmpty(strA07)) {
            ...
            if (!andSet) {
                AnonymousClass89 anonymousClass89A07 = c04017f.A07();
                int i10 = C8A.A1Z;
                String bundle = A00(73, 7, 29);
                C8B c8b = new C8B(bundle);
                String bundle2 = A00(116, 7, 65);
                anonymousClass89A07.A9a(bundle2, i10, c8b);
            }
        }
        return strA07;
    }

    public static String A04(C04017f c04017f, boolean z10) {
        if (c04017f == null) {
            return A00;
        }
        if (z10) {
        ...
        long jA01 = AbstractC0661Ig.A01(c04017f);
        String strA00 = A00(143, 23, 90);
        String strA002 = A00(133, 10, 64);
        String userAgentString = A00(88, 28, 104);
        if (jA01 > 0) {
            SharedPreferences sharedPreferences = c04017f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c04017f), 0);
        ...
        if (jA01 > 0) {
            SharedPreferences sharedPreferences2 = c04017f.getSharedPreferences(ProcessUtils.getProcessSpecificName(userAgentString, c04017f), 0);
    ...
    public static String A05(C8K c8k, C04017f c04017f) {
        if (AbstractC0661Ig.A04(c04017f)) {
            return A00(63, 5, 117) + A03(c04017f, c8k) + A00(39, 6, 127) + c8k.A06() + A00(45, 6, 121) + c8k.A04() + A00(38, 1, 111);
        }
        return A00(0, 0, 40);
    }

    public static String A06(C8K c8k, C04017f c04017f, boolean z10) {
        return A04(c04017f, z10) + A00(0, 38, 127) + c04017f.A04().A8H() + A00(57, 6, 54) + C8K.A04 + A00(38, 1, 111) + A05(c8k, c04017f) + A00(68, 5, 69) + c04017f.A04().A8I() + A00(51, 6, 77) + Locale.getDefault().toString() + A00(87, 1, 79);
    }

    public static void A09(C04017f c04017f, Throwable th) {
        c04017f.A07().A9a(A00(166, 8, 84), C8A.A2g, new C8B(th));
    }
}
