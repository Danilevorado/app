...
public final class Format implements Parcelable {
     ...
     */
    public Format(String str, String str2, String str3, String str4, int i10, int i11, int i12, int i13, float f5, int i14, float f10, byte[] bArr, int i15, ColorInfo colorInfo, int i16, int i17, int i18, int i19, int i20, int i21, String str5, int i22, long j10, List<byte[]> list, DrmInitData drmInitData, Metadata metadata) {
        int i23 = i14;
        float f11 = f10;
    ...
    public static Format A03(String str, String str2, String str3, int i10, int i11, int i12, int i13, float f5, List<byte[]> list, int i14, float f10, DrmInitData drmInitData) {
        return A04(str, str2, str3, i10, i11, i12, i13, f5, list, i14, f10, null, -1, null, drmInitData);
    }

    public static Format A04(String str, String str2, String str3, int i10, int i11, int i12, int i13, float f5, List<byte[]> list, int i14, float f10, byte[] bArr, int i15, ColorInfo colorInfo, DrmInitData drmInitData) {
        return new Format(str, null, str2, str3, i10, i11, i12, i13, f5, i14, f10, bArr, i15, colorInfo, -1, -1, -1, -1, -1, 0, null, -1, Long.MAX_VALUE, list, drmInitData, null);
    }
