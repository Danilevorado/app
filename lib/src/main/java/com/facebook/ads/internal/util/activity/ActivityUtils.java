...
import com.meta.analytics.dsp.uinode.AbstractC0710Ki;
import com.meta.analytics.dsp.uinode.C0662Ih;
import com.meta.analytics.dsp.uinode.C0715Kp;
import com.meta.analytics.dsp.uinode.C1072Ym;
import com.meta.analytics.dsp.uinode.C1073Yn;
import com.meta.analytics.dsp.uinode.C8A;
import com.meta.analytics.dsp.uinode.C8B;
import com.meta.analytics.dsp.uinode.ExecutorC0734Li;
import com.meta.analytics.dsp.uinode.InterfaceC0713Kl;
import com.meta.analytics.dsp.uinode.RunnableC0712Kk;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
    ...
    public static final C0715Kp A05;
    public static final List<InterfaceC0713Kl> A06;
     ...
     */
    public static synchronized void A04(C1072Ym c1072Ym, Class<? extends Activity> cls) {
        A02 = c1072Ym;
        Context applicationContext = c1072Ym.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c1072Ym.A07().A9a(A01(208, 8, 114), C8A.A02, new C8B(A01(72, 80, 103)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c1072Ym);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c1072Ym.A07().A9a(A01(216, 3, 105), C8A.A0d, new C8B(A01(42, 30, 122)));
        }
    }
    ...
    public static synchronized Activity A00() {
        ...
        if (z10) {
            activityA00 = AbstractC0710Ki.A00();
        }
    ...
    public static void A03(C1073Yn c1073Yn) {
        if (!C0662Ih.A1N(c1073Yn) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        RunnableC0712Kk runnableC0712Kk = new RunnableC0712Kk(c1073Yn);
        List<Runnable> list = A07;
        synchronized (list) {
            list.add(runnableC0712Kk);
        }
        ExecutorC0734Li.A01.A01().postDelayed(runnableC0712Kk, 2000L);
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        A08.put(activity, 1);
        Iterator<InterfaceC0713Kl> it = A06.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (activity.getClass() != this.A00) {
            ...
            while (it.hasNext()) {
                ExecutorC0734Li.A01.A01().removeCallbacks((Runnable) it.next());
            }
        }
        A05.A01();
    }
