...
import com.meta.analytics.dsp.uinode.C03515b;
import com.meta.analytics.dsp.uinode.C03525c;
import com.meta.analytics.dsp.uinode.C03545e;
import com.meta.analytics.dsp.uinode.C03575h;
import com.meta.analytics.dsp.uinode.C03585i;
import com.meta.analytics.dsp.uinode.C03595j;
import com.meta.analytics.dsp.uinode.C03625m;
import com.meta.analytics.dsp.uinode.C03695t;
import com.meta.analytics.dsp.uinode.C03735x;
import com.meta.analytics.dsp.uinode.C0674Iv;
import com.meta.analytics.dsp.uinode.C0675Iw;
import com.meta.analytics.dsp.uinode.C0680Jc;
...
import com.meta.analytics.dsp.uinode.EnumC0681Je;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public static final InitApi A06 = new InitApi() { // from class: com.facebook.ads.redexgen.X.5d
        ...
        public final void initialize(Context context, MultithreadedBundleWrapper multithreadedBundleWrapper, AudienceNetworkAds.InitListener initListener, int i10) {
            C8Y.A0G(C03525c.A09(context), multithreadedBundleWrapper, initListener, i10);
        }
    ...
    public AudienceNetworkActivityApi createAudienceNetworkActivity(final AudienceNetworkActivity audienceNetworkActivity, final AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        return new AudienceNetworkActivityApi(audienceNetworkActivity, audienceNetworkActivityApi, c5v) { // from class: com.facebook.ads.redexgen.X.5W
            ...
            private void A02(Throwable th) {
                ...
                this.A02.A0L();
                finish(8);
                C04017f logContext = this.A02.A0K();
                if (logContext != null) {
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) C5M.A00(new C03545e(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C03585i createNativeAdApi(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C03585i(nativeAd, nativeAdBaseApi);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C03585i createNativeAdApi(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        return new C03585i(nativeAdBase, nativeAd, nativeAdBaseApi);
    }
    ...
    public NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i10, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i11) {
        return new C03595j(nativeAdScrollView, context, nativeAdsManager, adViewProvider, i10, type, nativeAdViewAttributes, i11);
    }
    ...
    public NativeAdViewApi createNativeAdViewApi() {
        if (A02 == null) {
            A02 = new NativeAdViewApi() { // from class: com.facebook.ads.redexgen.X.5k
                ...
                public static View A00(C1073Yn c1073Yn, NativeAd nativeAd, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    ...
                    ER er = new ER();
                    NativeAdLayout mediumRectTemplateLayout = new NativeAdLayout(c1073Yn, er);
                    er.A04(mediumRectTemplateLayout, c1073Yn, nativeAd, jr);
                ...
                public static View A01(C1073Yn c1073Yn, NativeAd nativeAd, NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    ...
                    v2A0L.A1W(jr);
                    ER er = new ER();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1073Yn, er);
                    er.A04(nativeAdLayout, c1073Yn, nativeAd, jr);
                ...
                public final View render(Context context, NativeAd nativeAd, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) throws Throwable {
                    try {
                        return A00(C03525c.A03(context), nativeAd, type, nativeAdViewAttributes);
                    } catch (Throwable th) {
                        C1073Yn c1073YnA03 = C03525c.A03(context);
                        if (A00[1].length() == 17) {
    ...
    public NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i10) {
        return (NativeAdsManagerApi) C5M.A00(new C03625m(context, str, i10), NativeAdsManagerApi.class);
    }
    ...
    public NativeBannerAdApi createNativeBannerAdApi(NativeBannerAd nativeBannerAd, NativeAdBaseApi nativeAdBaseApi) {
        return new NativeBannerAdApi(nativeAdBaseApi) { // from class: com.facebook.ads.redexgen.X.5q
...

            {
                ...
                this.A00 = v2A0L;
                v2A0L.A1Y(EnumC0683Jg.A04);
            }

            private void A02(ImageView imageView, NativeAdBaseApi nativeAdBaseApi2) {
                V2 v2A0L = V2.A0L(nativeAdBaseApi2);
                Z9 z92 = new Z9(this, imageView, v2A0L);
                JP jpA14 = v2A0L.getAdIcon();
                if (jpA14 != null) {
                    Bitmap preloadedBitmap = v2A0L.A10().A0M(jpA14.getUrl());
                    C1073Yn c1073YnA03 = C03525c.A03(imageView.getContext());
                    if (preloadedBitmap != null) {
                        Drawable drawableA05 = V2.A05(c1073YnA03, preloadedBitmap, v2A0L.A1d(), v2A0L.A1C());
                        V2.A0e(drawableA05, imageView);
                        imageView.post(new Z8(this, v2A0L, drawableA05));
                        return;
                    } else {
                        Z9 z93 = null;
                        new AsyncTaskC03635n(c1073YnA03, z92, v2A0L.A1d(), z93).execute(new C03655p(jpA14.getUrl(), v2A0L.A1C(), z93));
                        return;
                    }
                }
                V1 v1A15 = v2A0L.A15();
                ...
                if (v1A15 != null) {
                    v1A15.ABR(C0679Jb.A00(adErrorType));
                }
    ...
    public NativeBannerAdViewApi createNativeBannerAdViewApi() {
        if (A03 == null) {
            A03 = new NativeBannerAdViewApi() { // from class: com.facebook.ads.redexgen.X.5r
                public static View A00(C1073Yn c1073Yn, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    if (nativeAdViewAttributes == null) {
                        nativeAdViewAttributes = new NativeAdViewAttributes();
                    }
                    V2.A0L(nativeBannerAd.getInternalNativeAd()).A1X(JS.A00(type.getEnumCode()));
                    EZ bannerTemplateLayoutApi = new EZ();
                    NativeAdLayout nativeAdLayout = new NativeAdLayout(c1073Yn, bannerTemplateLayoutApi);
                    bannerTemplateLayoutApi.A04(c1073Yn, nativeBannerAd, (JR) nativeAdViewAttributes.getInternalAttributes(), nativeAdLayout);
                ...
                public final View render(Context context, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
                    try {
                        return A00(C03525c.A03(context), nativeBannerAd, type, nativeAdViewAttributes);
                    } catch (Throwable th) {
                        return MR.A00(C03525c.A03(context), th);
                    }
                }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) C5M.A00(new C03695t(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) C5M.A00(new C03735x(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }

    public static C03515b getBidderTokenProviderApi() {
        if (A04 == null) {
            A04 = new C03515b();
        }
        C03515b c03515b = A04;
