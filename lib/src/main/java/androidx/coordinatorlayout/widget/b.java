...
public abstract class b {
    ...
    private static final ThreadLocal f2019a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f2020b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f2019a;
        ...
        ThreadLocal threadLocal2 = f2020b;
