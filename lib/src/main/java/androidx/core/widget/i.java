...
public abstract class i {
    ...
    private static class f implements ActionMode.Callback {
        ...
        private final ActionMode.Callback f2558a;

        /* renamed from: b, reason: collision with root package name */
        private final TextView f2559b;

        /* renamed from: c, reason: collision with root package name */
        private Class f2560c;

        /* renamed from: d, reason: collision with root package name */
        private Method f2561d;
        ...
        private void g(Menu menu) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            Context context = this.f2559b.getContext();
            ...
            if (!this.f2563f) {
                ...
                try {
                    ...
                    this.f2560c = cls;
                    this.f2561d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                    this.f2562e = true;
            ...
            try {
                Method declaredMethod = (this.f2562e && this.f2560c.isInstance(menu)) ? this.f2561d : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
                ...
                for (int i10 = 0; i10 < listC.size(); i10++) {
                    ...
                    menu.add(0, 0, i10 + 100, resolveInfo.loadLabel(packageManager)).setIntent(b(resolveInfo, this.f2559b)).setShowAsAction(1);
                }
        ...
        public boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
            return this.f2558a.onActionItemClicked(actionMode, menuItem);
        }

        @Override // android.view.ActionMode.Callback
        public boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
            return this.f2558a.onCreateActionMode(actionMode, menu);
        }

        @Override // android.view.ActionMode.Callback
        public void onDestroyActionMode(ActionMode actionMode) {
            this.f2558a.onDestroyActionMode(actionMode);
        }
        ...
        public boolean onPrepareActionMode(ActionMode actionMode, Menu menu) throws IllegalAccessException, ClassNotFoundException, IllegalArgumentException, InvocationTargetException {
            g(menu);
            return this.f2558a.onPrepareActionMode(actionMode, menu);
        }
    }
    ...
    public static c.a f(TextView textView) {
        ...
        c.a.C0031a c0031a = new c.a.C0031a(new TextPaint(textView.getPaint()));
        c0031a.b(c.a(textView));
        c0031a.c(c.d(textView));
        c0031a.d(e(textView));
        return c0031a.a();
    }
